import { a as V, h as q, r, j as e, t as u } from "./index-C6AelPZl.js";
import { B as v } from "./button-jww9kw-A.js";
import { C as E, b as R, F as Q, r as X } from "./fighter-game-multiplayer-DyF09_Ov.js";
import { g as Z } from "./player-utils-sDKa8flh.js";
import { u as ee, a as se } from "./multiplayer-join-gate-BugXXxQc.js";
import { c as G } from "./createLucideIcon-DBRWNgxE.js";
import { W as te } from "./wifi-BTJatK4N.js";
import { R as re } from "./rotate-ccw-BV-aK1J5.js";
import { R as ae, U as ne } from "./users-BHAU6hJz.js";
import { G as oe } from "./grid-3x3-FStnnztB.js";
...
*/
const le = [["polyline", { points: "14.5 17.5 3 6 3 3 6 3 17.5 14.5", key: "1hfsw2" }], ["line", { x1: "13", x2: "19", y1: "19", y2: "13", key: "1vrmhu" }], ["line", { x1: "16", x2: "20", y1: "16", y2: "20", key: "1bron3" }], ["line", { x1: "19", x2: "21", y1: "21", y2: "19", key: "13pww6" }], ["polyline", { points: "14.5 6.5 18 3 21 3 21 6 17.5 9.5", key: "hbey2j" }], ["line", { x1: "5", x2: "9", y1: "14", y2: "18", key: "1hf58s" }], ["line", { x1: "7", x2: "4", y1: "17", y2: "20", key: "pidxm4" }], ["line", { x1: "3", x2: "5", y1: "19", y2: "21", key: "1pehsh" }]], ie = G("swords", le);
/**
* @license lucide-react v1.8.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/
const de = [["path", { d: "M12 20h.01", key: "zekei9" }], ["path", { d: "M8.5 16.429a5 5 0 0 1 7 0", key: "1bycff" }], ["path", { d: "M5 12.859a10 10 0 0 1 5.17-2.69", key: "1dl1wf" }], ["path", { d: "M19 12.859a10 10 0 0 0-2.007-1.523", key: "4k23kn" }], ["path", { d: "M2 8.82a15 15 0 0 1 4.177-2.643", key: "1grhjp" }], ["path", { d: "M22 8.82a15 15 0 0 0-11.288-3.764", key: "z3jwby" }], ["path", { d: "m2 2 20 20", key: "1ooewy" }]], ce = G("wifi-off", de);
function ke() {
  var _a;
  const I = V(), L = q(), y = ee("fighter"), A = (_a = L.state) == null ? void 0 : _a.roomPassword, [l, D] = r.useState(null), [m, T] = r.useState(false), [O, w] = r.useState(true), [c, U] = r.useState({ id: "", username: "" }), [x, H] = r.useState(null), [f, M] = r.useState("waiting"), [S, Y] = r.useState(0), [xe, W] = r.useState(0), [b, $] = r.useState(false), [h, K] = r.useState(false), [i, a] = r.useState({ a: { pressed: false }, d: { pressed: false }, w: { pressed: false }, s: { pressed: false }, " ": { pressed: false }, ArrowLeft: { pressed: false }, ArrowRight: { pressed: false }, ArrowUp: { pressed: false }, ArrowDown: { pressed: false } }), o = r.useRef(null), F = r.useRef(null), N = r.useRef(null);
  r.useEffect(() => {
    ...
    (async () => {
      try {
        w(true);
        const n = new Q(y, c.id, c.username, A);
        H(n), o.current = n, n.onGameState((p) => {
          ...
          T(p), p ? (se(y, "fighter"), u.success("Connected to fighter game!")) : u.error("Disconnected from fighter game. You can try refreshing the page to reconnect.");
        }), n.onError((p) => {
  ...
  r.useEffect(() => (window.addEventListener("keydown", j), window.addEventListener("keyup", P), () => {
    ...
    if (!s) return;
    const d = () => {
      X(s, l, b), N.current = requestAnimationFrame(d);
    };
    return d(), () => {
  ...
  if (O) return e.jsx("div", { className: "min-h-screen bg-black flex items-center justify-center", style: { fontFamily: "'Press Start 2P', monospace" }, children: e.jsx("div", { className: "bg-gray-900 border-4 border-red-500 rounded-lg p-8", style: { boxShadow: "0 4px 12px rgba(0,0,0,0.8)" }, children: e.jsxs("div", { className: "text-center", children: [e.jsxs("div", { className: "flex items-center justify-center gap-3 mb-6", children: [e.jsx(ie, { className: "h-8 w-8 text-red-500" }), e.jsx("h2", { className: "text-xl font-bold text-red-500", style: { fontSize: "12px", textShadow: "2px 2px 0px #000", fontFamily: "'Press Start 2P', monospace" }, children: "CONNECTING TO FIGHTER GAME..." })] }), e.jsx("div", { className: "animate-spin rounded-full h-12 w-12 border-4 border-red-500 border-t-transparent mx-auto mb-4" }), e.jsxs("p", { className: "text-red-300", style: { fontSize: "8px", fontFamily: "'Press Start 2P', monospace" }, children: ["JOINING ROOM ", y] })] }) }) });
  const B = l == null ? void 0 : l.players.find((t) => t.id === c.id), g = l == null ? void 0 : l.fighters.find((t) => t.id === (B == null ? void 0 : B.fighterId));
  return e.jsxs("div", { className: "flex min-h-screen flex-col bg-black text-white", style: { fontFamily: "'Press Start 2P', monospace" }, children: [e.jsxs("div", { className: "fixed top-4 right-4 z-100 flex gap-2", children: [e.jsx("button", { onClick: () => K(!h), className: "bg-gray-700 border-2 border-red-500 hover:bg-red-500 hover:text-black text-red-400 px-4 py-2 text-xs transition-colors", style: { fontSize: "8px", fontFamily: "'Press Start 2P', monospace", boxShadow: "0 0 0 2px #000, inset 0 0 0 1px #000" }, "aria-pressed": h, "aria-label": h ? "Hide panel" : "Show panel", children: h ? "HIDE PANEL" : "SHOW PANEL" }), e.jsx("button", { onClick: () => I("/multiplayer"), className: "bg-red-600 border-2 border-red-400 hover:bg-red-500 text-white px-4 py-2 text-xs transition-colors", style: { fontSize: "8px", fontFamily: "'Press Start 2P', monospace", boxShadow: "0 0 0 2px #000, inset 0 0 0 1px #000" }, "aria-label": "Back to multiplayer games", children: "BACK TO MULTIPLAYER GAMES" })] }), e.jsxs("div", { className: `flex min-h-0 flex-1 flex-col pt-16 sm:pt-[4.5rem] ${h ? "lg:flex-row lg:items-stretch lg:gap-4 lg:px-4 lg:pb-4" : "items-center justify-center px-3 pb-6 sm:px-4"}`, children: [e.jsx("div", { className: `flex min-h-0 w-full min-w-0 flex-col items-center justify-center ${h ? "lg:flex-1 lg:py-2" : "flex-1"}`, children: e.jsxs("div", { className: "flex w-full max-w-[min(1024px,calc(100vw-1.5rem))] flex-col overflow-hidden rounded-lg border-4 border-red-500 bg-gray-900", style: { boxShadow: "0 4px 12px rgba(0,0,0,0.8)" }, children: [e.jsx("div", { className: "border-b-4 border-red-500 bg-red-500 px-3 py-3 sm:px-4", children: e.jsxs("div", { className: "flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between", children: [e.jsxs("div", { className: "flex flex-col gap-1 sm:flex-row sm:items-center sm:gap-4", children: [e.jsx("h3", { className: "text-black font-bold shrink-0", style: { fontSize: "10px", fontFamily: "'Press Start 2P', monospace", textShadow: "1px 1px 0px #000" }, children: "GAME ARENA" }), e.jsxs("p", { className: "text-black/90 break-all", style: { fontSize: "7px", fontFamily: "'Press Start 2P', monospace" }, children: ["ROOM ", y] })] }), e.jsxs("div", { className: "flex flex-wrap items-center gap-2 lg:gap-3", children: [e.jsxs("div", { className: "flex items-center gap-1.5", children: [m ? e.jsx(te, { className: "h-4 w-4 text-black shrink-0" }) : e.jsx(ce, { className: "h-4 w-4 text-black shrink-0" }), e.jsx("span", { className: "text-black font-bold", style: { fontSize: "8px", fontFamily: "'Press Start 2P', monospace" }, children: m ? "CONNECTED" : "DISCONNECTED" })] }), e.jsx("div", { className: `px-3 py-1.5 border-2 text-black ${f === "playing" ? "bg-green-400 border-black" : f === "waiting" ? "bg-yellow-400 border-black" : f === "finished" ? "bg-red-300 border-black" : "bg-gray-300 border-black"}`, style: { fontSize: "8px", fontFamily: "'Press Start 2P', monospace", boxShadow: "0 0 0 2px #000, inset 0 0 0 1px #000" }, children: f === "playing" ? "PLAYING" : f === "waiting" ? "WAITING" : f === "finished" ? "FINISHED" : "\u2014" }), f === "finished" && e.jsxs(v, { type: "button", variant: "outline", size: "sm", onClick: J, disabled: !m, className: "border-2 border-black bg-yellow-400 px-2 py-1.5 font-bold text-black hover:bg-yellow-300 disabled:opacity-50", style: { fontSize: "8px", fontFamily: "'Press Start 2P', monospace", boxShadow: "0 0 0 2px #000, inset 0 0 0 1px #000" }, "aria-label": "Play again in this room", children: [e.jsx(re, { className: "mr-1.5 inline h-3.5 w-3.5" }), "PLAY AGAIN"] }), e.jsx(v, { type: "button", variant: "outline", size: "sm", onClick: _, className: "bg-gray-800 border-2 border-black text-white hover:bg-gray-700 px-2 py-1.5", style: { fontSize: "8px", fontFamily: "'Press Start 2P', monospace" }, "aria-label": "Refresh view", children: e.jsx(ae, { className: "h-4 w-4" }) }), e.jsxs(v, { variant: b ? "default" : "outline", size: "sm", onClick: () => $(!b), className: `px-3 py-2 border-2 font-bold transition-colors ${b ? "bg-green-400 border-black text-black" : "bg-gray-800 border-black text-white hover:bg-gray-700"}`, style: { fontSize: "8px", fontFamily: "'Press Start 2P', monospace", boxShadow: "0 0 0 2px #000, inset 0 0 0 1px #000" }, children: [e.jsx(oe, { className: "h-4 w-4 mr-2" }), "GRID"] })] })] }) }), e.jsx("div", { className: "w-full bg-black", children: e.jsx("div", { className: "relative w-full", style: { aspectRatio: `${E} / ${R}`, maxHeight: "min(576px, calc(100svh - 12rem), calc(100vh - 12rem))" }, children: e.jsx("canvas", { ref: F, width: E, height: R, className: "absolute inset-0 block h-full w-full max-h-full max-w-full", style: { imageRendering: "pixelated" } }) }) })] }) }), h && e.jsxs("div", { className: "mx-auto w-full max-w-lg shrink-0 space-y-4 px-3 pb-4 lg:mx-0 lg:w-80 lg:max-w-sm lg:overflow-y-auto lg:px-0 lg:pb-0", children: [e.jsxs("div", { className: "bg-gray-900 border-4 border-red-500 rounded-lg overflow-hidden", style: { boxShadow: "0 4px 12px rgba(0,0,0,0.8)" }, children: [e.jsx("div", { className: "bg-red-500 px-4 py-3 border-b-4 border-red-500", children: e.jsxs("h3", { className: "flex items-center gap-2 text-black font-bold", style: { fontSize: "10px", fontFamily: "'Press Start 2P', monospace", textShadow: "1px 1px 0px #000" }, children: [e.jsx(ne, { className: "h-4 w-4" }), "PLAYERS (", (l == null ? void 0 : l.players.length) || 0, "/2)"] }) }), e.jsx("div", { className: "p-4 space-y-3", children: l == null ? void 0 : l.players.map((t) => {
