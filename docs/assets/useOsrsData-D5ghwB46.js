import { j as ut, c as os, g as Bt, r as B, R as A } from "./index-Cug6S6xf.js";
import { s as n1 } from "./skillIconUrl-DBpzbTaR.js";
import { c as mt } from "./clsx-B-dksMZM.js";
import { _ as br, a as yt, b as xs, c as Fn, d as ot } from "./tslib.es6-Xujj8YQZ.js";
const nf = "", Xh = "https://prod-public-mindtricks-data.s3.eu-west-2.amazonaws.com/prod/client/osrs-mmg".replace(/\/$/, "") ?? "", Cp = `${Xh}/manifest.json`, jp = "osrs-mmg.duckdb";
function i1(e7) {
  return `${Xh}/${e7.artifacts.database.url}`;
}
function fi() {
  return nf.length > 0;
}
...
const Rp = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], pl = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
function Jh(e7) {
...
const c1 = new TextDecoder("utf-8"), of = (e7) => c1.decode(e7), u1 = new TextEncoder(), Qh = (e7) => u1.encode(e7), l1 = (e7) => typeof e7 == "number", yb = (e7) => typeof e7 == "boolean", re = (e7) => typeof e7 == "function", Ie = (e7) => e7 != null && Object(e7) === e7, qn = (e7) => Ie(e7) && re(e7.then), Ko = (e7) => Ie(e7) && re(e7[Symbol.iterator]), fa = (e7) => Ie(e7) && re(e7[Symbol.asyncIterator]), sf = (e7) => Ie(e7) && Ie(e7.schema), mb = (e7) => Ie(e7) && "done" in e7 && "value" in e7, vb = (e7) => Ie(e7) && re(e7.stat) && l1(e7.fd), gb = (e7) => Ie(e7) && Zh(e7.body), gu = (e7) => "_getDOMStream" in e7 && "_getNodeStream" in e7, f1 = (e7) => Ie(e7) && re(e7.abort) && re(e7.getWriter) && !gu(e7), Zh = (e7) => Ie(e7) && re(e7.cancel) && re(e7.getReader) && !gu(e7), h1 = (e7) => Ie(e7) && re(e7.end) && re(e7.write) && yb(e7.writable) && !gu(e7), bb = (e7) => Ie(e7) && re(e7.read) && re(e7.pipe) && yb(e7.readable) && !gu(e7), d1 = (e7) => Ie(e7) && re(e7.clear) && re(e7.bytes) && re(e7.position) && re(e7.setPosition) && re(e7.capacity) && re(e7.getBufferIdentifier) && re(e7.createLong), td = typeof SharedArrayBuffer < "u" ? SharedArrayBuffer : ArrayBuffer;
function p1(e7) {
  const t = e7[0] ? [e7[0]] : [];
  let r, n, i, a;
...
function Et(e7, t) {
  ...
  return r instanceof e7 ? e7 === Uint8Array ? new e7(r.buffer, r.byteOffset, r.byteLength) : r : r ? (typeof r == "string" && (r = Qh(r)), r instanceof ArrayBuffer ? new e7(r) : r instanceof td ? new e7(r) : d1(r) ? Et(e7, r.bytes()) : ArrayBuffer.isView(r) ? r.byteLength <= 0 ? new e7(0) : new e7(r.buffer, r.byteOffset, r.byteLength / e7.BYTES_PER_ELEMENT) : e7.from(r)) : new e7(0);
}
const Ia = (e7) => Et(Int32Array, e7), zp = (e7) => Et(BigInt64Array, e7), vt = (e7) => Et(Uint8Array, e7), cf = (e7) => (e7.next(), e7);
function* y1(e7, t) {
  const r = function* (i) {
    yield i;
  }, n = typeof t == "string" || ArrayBuffer.isView(t) || t instanceof ArrayBuffer || t instanceof td ? r(t) : Ko(t) ? t : r(t);
...
function _b(e7, t) {
  return br(this, arguments, function* () {
    ...
    }, a = typeof t == "string" || ArrayBuffer.isView(t) || t instanceof ArrayBuffer || t instanceof td ? n(t) : Ko(t) ? i(t) : fa(t) ? t : n(t);
...
function O1(e7) {
  return br(this, arguments, function* () {
    ...
    try {
      r[0] = yl(e7, "end"), r[1] = yl(e7, "error");
      do {
        if (r[2] = yl(e7, "readable"), [n, a] = yield yt(Promise.race(r.map((d) => d[2]))), n === "error") break;
...
const ml = 2, mr = 4, Br = 4, Pt = 4, an = new Int32Array(2), Wp = new Float32Array(an.buffer), Vp = new Float64Array(an.buffer), cs = new Uint16Array(new Uint8Array([1, 0]).buffer)[0] === 1;
var uf;
(function(e7) {
  ...
  endObject() {
    ...
    t: for (r = 0; r < this.vtables.length; r++) {
      ...
      if (a == this.bb.readInt16(c)) {
        for (let u = ml; u < a; u += ml) if (this.bb.readInt16(s + u) != this.bb.readInt16(c + u)) continue t;
        o = this.vtables[r];
        break;
      }
    }
...
function ao(e7) {
  ...
  if (!e7.signed) return vl(e7);
  let t = new Uint16Array(e7.buffer, e7.byteOffset, e7.byteLength / 2);
  if (new Int16Array([t.at(-1)])[0] >= 0) return vl(e7);
  t = t.slice();
  let n = 1;
...
const D1 = (e7, t, r) => {
...
}, n0 = ({ values: e7, valueOffsets: t }, r, n) => Zb(e7, t, r, n), i0 = ({ values: e7, valueOffsets: t }, r, n) => Zb(e7, t, r, Qh(n)), B1 = (e7, t, r) => {
  ...
  e7.type.unit === Tr.DAY_TIME ? y0(e7, t, r) : m0(e7, t, r);
}, y0 = ({ values: e7 }, t, r) => {
...
Z.prototype.visitFloat32 = nt(rd);
Z.prototype.visitFloat64 = nt(rd);
...
Object.defineProperties(nd.prototype, { [Symbol.toStringTag]: { enumerable: false, configurable: false, value: "Row" }, [rr]: { writable: true, enumerable: false, configurable: false, value: null }, [Ii]: { writable: true, enumerable: false, configurable: false, value: -1 } });
class Z1 {
  isExtensible() {
    return false;
  }
...
const tx = (e7, t) => 864e5 * e7[t], ex = (e7, t) => null, w0 = (e7, t, r) => {
...
}, lx = ({ values: e7, stride: t }, r) => ed.decimal(e7.subarray(t * r, t * (r + 1))), fx = (e7, t) => {
  ...
  return new id(o.slice(i, a - i));
}, dx = (e7, t) => new nd(e7, t), px = (e7, t) => e7.type.mode === ye.Dense ? j0(e7, t) : B0(e7, t), j0 = (e7, t) => {
...
}, mx = (e7, t) => e7.type.unit === Tr.DAY_TIME ? R0(e7, t) : k0(e7, t), R0 = ({ values: e7 }, t) => e7.subarray(2 * t, 2 * (t + 1)), k0 = ({ values: e7 }, t) => {
...
Object.defineProperties(id.prototype, { [Symbol.toStringTag]: { enumerable: false, configurable: false, value: "Row" }, [_i]: { writable: true, enumerable: false, configurable: false, value: null }, [Ei]: { writable: true, enumerable: false, configurable: false, value: null }, [hf]: { writable: true, enumerable: false, configurable: false, value: null } });
let Zp;
...
const ad = (e7, t) => e7 < 0 ? t + e7 : e7, ty = (e7) => e7 !== e7;
function ha(e7) {
...
function nc(e7, t, r) {
  ...
  if (e7 > 0 || r.byteLength < n) {
    ...
    return i.set(e7 % 8 === 0 ? r.subarray(e7 >> 3) : ic(new od(r, e7, t, null, V0)).subarray(0, n)), i;
  }
  return r;
}
function ic(e7) {
...
function df(e7, t, r) {
  ...
  if (r - t < 8) {
    let a = 0;
    for (const o of new od(e7, t, r - t, e7, Tx)) a += o;
    return a;
  }
  const n = r >> 3 << 3, i = t + (t % 8 === 0 ? 0 : 8 - t % 8);
  return df(e7, t, i) + df(e7, n, r) + Ix(e7, i >> 3, n - i >> 3);
}
function Ix(e7, t, r) {
  let n = 0, i = Math.trunc(t);
  const a = new DataView(e7.buffer, e7.byteOffset, e7.byteLength), o = r === void 0 ? e7.byteLength : i + r;
  for (; o - i >= 4; ) n += gl(a.getUint32(i)), i += 4;
  for (; o - i >= 2; ) n += gl(a.getUint16(i)), i += 2;
  for (; o - i >= 1; ) n += gl(a.getUint8(i)), i += 1;
  return n;
}
function gl(e7) {
  let t = Math.trunc(e7);
...
class Tt {
  ...
  get nullCount() {
    ...
    return t <= Ex && (r = this.nullBitmap) && (this._nullCount = t = r.length === 0 ? 0 : this.length - df(r, this.offset, this.offset + this.length)), t;
  }
...
function K0(e7) {
  ...
  return function(n, i) {
    const a = this.data;
    t = i;
    const o = sd(a, this._offsets, n, r);
    return t = void 0, o;
  };
}
function Y0(e7) {
  ...
  return function(n, i) {
    t = n;
    const a = this.data, o = typeof i != "number" ? r(a, 0, 0) : sd(a, this._offsets, i, r);
    return t = void 0, o;
  };
}
class K extends dt {
...
function Nx(e7, t) {
  ...
  let n = 0;
  for (const i of new od(r, e7.offset + (t || 0), e7.length, r, V0)) {
    if (!i) return n;
    ++n;
  }
  return -1;
...
class xt {
  constructor(t) {
    ...
    switch (a.length) {
      ...
      case 1: {
        ...
        this.isValid = (f) => cd(l, f), this.get = (f) => s(l, f), this.set = (f, h) => c(l, f, h), this.indexOf = (f) => u(l, f), this._offsets = [0, l.length];
        break;
      }
      default:
  ...
  at(t) {
    return this.get(ad(t, this.length));
  }
  set(t, r) {
  }
  indexOf(t, r) {
...
xt[J0] = ((e7) => {
  ...
  for (const r of t) {
    ...
    Q0[r] = { get: n, set: i, indexOf: a }, Z0[r] = Object.create(e7, { isValid: { value: ac(cd) }, get: { value: ac(Ee.getVisitFnByTypeId(r)) }, set: { value: K0(Je.getVisitFnByTypeId(r)) }, indexOf: { value: Y0(oc.getVisitFnByTypeId(r)) } });
  }
  return "Vector";
})(xt.prototype);
class sc extends xt {
...
class Ms extends kx {
  ...
  toUint8Array(t = false) {
    return t ? Pr(this._values)[0] : ot(this, void 0, void 0, function* () {
      var r, n, i, a;
      const o = [];
      let s = 0;
      try {
...
class Ri {
  constructor(t) {
    t instanceof Ri ? this.source = t.source : t instanceof Ms ? this.source = new En(Ve.fromAsyncIterable(t)) : bb(t) ? this.source = new En(Ve.fromNodeStream(t)) : Zh(t) ? this.source = new En(Ve.fromDOMStream(t)) : gb(t) ? this.source = new En(Ve.fromDOMStream(t.body)) : Ko(t) ? this.source = new En(Ve.fromIterable(t)) : qn(t) ? this.source = new En(Ve.fromAsyncIterable(t)) : fa(t) && (this.source = new En(Ve.fromAsyncIterable(t)));
  }
  [Symbol.asyncIterator]() {
    return this;
  }
...
const ki = 8, fd = [1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8];
class t_ {
  constructor(t) {
    this.buffer = t;
  }
...
class It extends t_ {
  ...
  static fromString(t, r = new Uint32Array(2)) {
    ...
    for (let a = 0; a < n; ) {
      const o = ki < n - a ? ki : n - a, s = new It(new Uint32Array([Number.parseInt(t.slice(a, a + o), 10), 0])), c = new It(new Uint32Array([fd[o], 0]));
...
class Oe extends t_ {
  ...
  static fromString(t, r = new Uint32Array(2)) {
    ...
    for (let o = n ? 1 : 0; o < i; ) {
      const s = ki < i - o ? ki : i - o, c = new Oe(new Uint32Array([Number.parseInt(t.slice(o, o + s), 10), 0])), u = new Oe(new Uint32Array([fd[s], 0]));
...
class yr {
  ...
  static fromString(t, r = new Uint32Array(4)) {
    ...
    for (let o = n ? 1 : 0; o < i; ) {
      const s = ki < i - o ? ki : i - o, c = new yr(new Uint32Array([Number.parseInt(t.slice(o, o + s), 10), 0, 0, 0])), u = new yr(new Uint32Array([fd[s], 0, 0, 0]));
      a.times(u), a.plus(c), o += s;
    }
    return n ? a.negate() : a;
  }
...
X.prototype.visitDate = hd;
X.prototype.visitDateDay = hd;
X.prototype.visitDateMillisecond = hd;
...
X.prototype.visitUnion = dd;
X.prototype.visitDenseUnion = dd;
X.prototype.visitSparseUnion = dd;
X.prototype.visitDictionary = Gx;
X.prototype.visitInterval = pd;
X.prototype.visitIntervalDayTime = pd;
X.prototype.visitIntervalYearMonth = pd;
...
class me {
    ...
    const o = (c) => {
      if (c) {
        ...
        if (c instanceof Tt) {
          ...
          if (typeof c == "object") {
            const u = Object.keys(c), l = u.map((d) => new xt([c[d]])), f = i ?? new At(u.map((d, y) => new Ft(String(d), l[y].type, l[y].nullable))), [, h] = bl(f, l);
  ...
  at(t) {
    return this.get(ad(t, this.numRows));
  }
  set(t, r) {
  }
  indexOf(t, r) {
  ...
  [Symbol.iterator]() {
    return this.batches.length > 0 ? ud.visit(new xt(this.data)) : new Array(0)[Symbol.iterator]();
  }
  toArray() {
    return [...this];
  }
  ...
  assign(t) {
    ...
    return new me(...bl(a, o));
  }
}
r_ = Symbol.toStringTag;
me[r_] = ((e7) => (e7.schema = null, e7.batches = [], e7._offsets = new Uint32Array([0]), e7._nullCount = -1, e7[Symbol.isConcatSpreadable] = true, e7.isValid = ac(cd), e7.get = ac(Ee.getVisitFn(x.Struct)), e7.set = K0(Je.getVisitFn(x.Struct)), e7.indexOf = Y0(oc.getVisitFn(x.Struct)), "Table"))(me.prototype);
var n_;
let Ae = class Ha {
  constructor(...t) {
    switch (t.length) {
  ...
  [Symbol.iterator]() {
    return ud.visit(new xt([this.data]));
  }
  toArray() {
    return [...this];
  }
...
function Zx(e7) {
  return new Ir(a_(e7.data), e7.id, e7.isDelta);
}
function tA(e7, t) {
...
function s_(e7, t = []) {
  for (let r = -1, n = (e7 || []).length; ++r < n; ) {
    const i = e7[r];
    i.VALIDITY && t.push(new _r(t.length, i.VALIDITY.length)), i.TYPE_ID && t.push(new _r(t.length, i.TYPE_ID.length)), i.OFFSET && t.push(new _r(t.length, i.OFFSET.length)), i.DATA && t.push(new _r(t.length, i.DATA.length)), t = s_(i.children, t);
  }
  return t;
}
function eA(e7) {
...
function mA(e7, t) {
  ...
  return pr.startSchema(e7), pr.addFields(e7, n), pr.addEndianness(e7, SA ? ji.Little : ji.Big), i !== -1 && pr.addCustomMetadata(e7, i), pr.endSchema(e7);
}
function vA(e7, t) {
  let r = -1, n = -1, i = -1;
  const a = t.type;
  let o = t.typeId;
  G.isDictionary(a) ? (o = a.dictionary.typeId, i = _l.visit(a, e7), n = _l.visit(a.dictionary, e7)) : n = _l.visit(a, e7);
...
})(), md = (e7) => `Expected ${_t[e7]} Message in stream, but was null or length 0.`, vd = (e7) => `Header pointer of flatbuffer-encoded ${_t[e7]} Message is null or length 0.`, c_ = (e7, t) => `Expected to read ${e7} metadata bytes, but only read ${t}.`, u_ = (e7, t) => `Expected to read ${e7} bytes for message body, but only read ${t}.`;
class l_ {
  constructor(t) {
  ...
  readMessage(t) {
    ...
    if (t != null && r.value.headerType !== t) throw new Error(md(t));
    return r.value;
  }
  readMessageBody(t) {
...
class xA extends l_ {
  ...
  readSchema() {
    ...
    if (!r || !n) throw new Error(vd(t));
    return n;
  }
}
const wu = 4, vf = "ARROW1", co = new Uint8Array(vf.length);
...
class Ke extends ld {
  ...
  static from(t) {
    return t instanceof Ke ? t : sf(t) ? EA(t) : vb(t) ? DA(t) : qn(t) ? ot(this, void 0, void 0, function* () {
      return yield Ke.from(yield t);
    }) : gb(t) || Zh(t) || bb(t) || fa(t) ? MA(new Ri(t)) : $A(new cc(t));
  }
  static readAll(t) {
    return t instanceof Ke ? t.isSync() ? hy(t) : dy(t) : sf(t) || ArrayBuffer.isView(t) || Ko(t) || mb(t) ? hy(t) : dy(t);
  }
}
class lc extends Ke {
  constructor(t) {
...
class hc extends d_ {
  constructor(t, r) {
    super(r), this._reader = sf(t) ? new xA(this._handle = t) : new l_(this._handle = t);
  }
  isSync() {
    return true;
  }
  ...
  next() {
    ...
    return this.schema && this._recordBatchIndex === 0 ? (this._recordBatchIndex++, { done: false, value: new yd(this.schema) }) : this.return();
  }
...
class dc extends d_ {
  ...
  next() {
    return ot(this, void 0, void 0, function* () {
      ...
      return this.schema && this._recordBatchIndex === 0 ? (this._recordBatchIndex++, { done: false, value: new yd(this.schema) }) : yield this.return();
    });
  }
  _readNextMessageAndValidate(t) {
    return ot(this, void 0, void 0, function* () {
...
function $A(e7) {
  ...
  return t && t.byteLength >= 4 ? gd(t) ? new h_(new p_(e7.read())) : new lc(new hc(e7)) : new lc(new hc(function* () {
  }()));
}
function MA(e7) {
  return ot(this, void 0, void 0, function* () {
    const t = yield e7.peek(Qo + 7 & -8);
    return t && t.byteLength >= 4 ? gd(t) ? new h_(new p_(yield e7.read())) : new fc(new dc(e7)) : new fc(new dc(function() {
      return br(this, arguments, function* () {
      });
    }()));
  });
...
function DA(e7) {
  return ot(this, void 0, void 0, function* () {
    ...
    return t >= AA && gd(yield r.readAt(0, Qo + 7 & -8)) ? new PA(new TA(r)) : new fc(new dc(r));
  });
}
class Wt extends dt {
  static assemble(...t) {
...
class m_ extends ld {
  ...
  writeAll(t) {
    return qn(t) ? t.then((r) => this.writeAll(r)) : fa(t) ? Od(this, t) : Sd(this, t);
  }
  get closed() {
  ...
  write(t) {
    ...
    t instanceof Ae ? t instanceof yd || this._writeRecordBatch(t) : t instanceof me ? this.writeAll(t.batches) : Ko(t) && this.writeAll(t);
  }
  _writeMessage(t, r = 8) {
...
class _d extends m_ {
  static writeAll(t, r) {
    const n = new _d(r);
    return qn(t) ? t.then((i) => n.writeAll(i)) : fa(t) ? Od(n, t) : Sd(n, t);
  }
}
class wd extends m_ {
  static writeAll(t) {
    const r = new wd();
    return qn(t) ? t.then((n) => r.writeAll(n)) : fa(t) ? Od(r, t) : Sd(r, t);
  }
  constructor() {
...
function jA(e7, t = "stream") {
  return (t === "stream" ? _d : wd).writeAll(e7).toUint8Array(true);
}
...
})(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 5, 4, 1, 3, 1, 1, 10, 11, 1, 9, 0, 65, 0, 254, 16, 2, 0, 26, 11])), yP = { version: "1.32.0" }, xd = yP.version.split(".");
xd[0];
xd[1];
xd[2];
var mP = () => typeof navigator > "u", wl = null, Sl = null, Ol = null, xl = null, Al = null;
async function vP() {
  return wl == null && (wl = typeof BigInt64Array < "u"), Sl == null && (Sl = await hP()), Ol == null && (Ol = await pP()), xl == null && (xl = await dP()), Al == null && (Al = await fP()), { bigInt64Array: wl, crossOriginIsolated: mP() || globalThis.crossOriginIsolated || false, wasmExceptions: Sl, wasmSIMD: xl, wasmThreads: Ol, wasmBulkMemory: Al };
}
...
let Pl = null, Tl = null, Bs = Promise.resolve(), _f = null;
async function b_() {
  return Pl || (Pl = (async () => {
...
async function __() {
  return Tl || (Tl = await (await b_()).connect()), Tl;
}
...
async function AP(e7, t) {
  ...
  await r.registerFileBuffer(jp, new Uint8Array(e7)), await xP(n) && await n.query(`DETACH ${js}`), await n.query(`ATTACH '${jp}' AS ${js} (READ_ONLY)`), await n.query(`USE ${js}`), _f = t;
}
async function py(e7, t) {
  const r = t ?? null;
  if (!(r && _f === r)) return Bs = Bs.then(() => AP(e7, r)), Bs;
}
async function ur(e7) {
  return await Bs, (await (await __()).query(e7)).toArray();
}
const Ad = { day: "day", week: "week", month: "month", quarter: "quarter", year: "year" };
function Ou(e7) {
  return e7.replace(/'/g, "''");
}
function pc(e7, t) {
...
async function PP(e7, t, r) {
  const n = Ad[t], i = Ou(e7), a = pc(), o = await ur(`
    SELECT
...
async function TP(e7, t, r) {
  if (!e7.length) return [];
  const n = Ad[t], i = e7.map((s) => `'${Ou(s)}'`).join(", "), a = pc();
  return (await ur(`
...
async function _Y(e7, t, r) {
  const n = Ad[t], i = Ou(e7), a = pc();
  return (await ur(`
    SELECT
...
function OY(e7, t, r = 5) {
  const n = EP(e7, t), a = [...[...n.inputs.map((o) => vy(o, "input")), ...n.outputs.map((o) => vy(o, "output"))]].sort((o, s) => Math.abs(s.gpPerHour) - Math.abs(o.gpPerHour));
...
function xY({ loading: e7, error: t, manifest: r, fromCache: n, onReload: i }) {
  return e7 ? ut.jsx("p", { className: "osrs-mmg__banner osrs-mmg__banner--loading", children: "Loading OSRS data\u2026" }) : t ? ut.jsxs("p", { className: "osrs-mmg__banner osrs-mmg__banner--error", children: [t, " ", ut.jsx("button", { type: "button", onClick: i, children: "Retry" })] }) : !r || !DP(r) ? null : ut.jsxs("p", { className: "osrs-mmg__banner osrs-mmg__banner--stale", children: ["Data from ", r.generated_at, r.latest_snapshot_date ? ` \xB7 snapshot ${r.latest_snapshot_date}` : "", n ? " \xB7 cached" : " \xB7 fresh download", " \xB7 ", ut.jsx("button", { type: "button", onClick: i, children: "Refresh" })] });
}
function AY({ skills: e7, compact: t = false }) {
...
var NP = Array.isArray, $e = NP, CP = typeof os == "object" && os && os.Object === Object && os, w_ = CP, jP = w_, BP = typeof self == "object" && self && self.Object === Object && self, RP = jP || BP || Function("return this")(), $r = RP, kP = $r, LP = kP.Symbol, Zo = LP, gy = Zo, S_ = Object.prototype, FP = S_.hasOwnProperty, UP = S_.toString, Ea = gy ? gy.toStringTag : void 0;
function zP(e7) {
  var t = FP.call(e7, Ea), r = e7[Ea];
  try {
    e7[Ea] = void 0;
    var n = true;
  } catch {
...
var WP = zP, VP = Object.prototype, qP = VP.toString;
function GP(e7) {
  return qP.call(e7);
}
var HP = GP, by = Zo, KP = WP, YP = HP, XP = "[object Null]", JP = "[object Undefined]", _y = by ? by.toStringTag : void 0;
function QP(e7) {
  return e7 == null ? e7 === void 0 ? JP : XP : _y && _y in Object(e7) ? KP(e7) : YP(e7);
}
var Jr = QP;
function ZP(e7) {
  return e7 != null && typeof e7 == "object";
}
var Qr = ZP, tT = Jr, eT = Qr, rT = "[object Symbol]";
function nT(e7) {
  return typeof e7 == "symbol" || eT(e7) && tT(e7) == rT;
}
var da = nT, iT = $e, aT = da, oT = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, sT = /^\w*$/;
function cT(e7, t) {
  if (iT(e7)) return false;
  var r = typeof e7;
  return r == "number" || r == "symbol" || r == "boolean" || e7 == null || aT(e7) ? true : sT.test(e7) || !oT.test(e7) || t != null && e7 in Object(t);
}
var Pd = cT;
function uT(e7) {
  var t = typeof e7;
...
var _n = uT;
const pa = Bt(_n);
var lT = Jr, fT = _n, hT = "[object AsyncFunction]", dT = "[object Function]", pT = "[object GeneratorFunction]", yT = "[object Proxy]";
function mT(e7) {
  if (!fT(e7)) return false;
  var t = lT(e7);
  return t == dT || t == pT || t == hT || t == yT;
}
var Td = mT;
const lt = Bt(Td);
var vT = $r, gT = vT["__core-js_shared__"], bT = gT, Il = bT, wy = function() {
  var e7 = /[^.]+$/.exec(Il && Il.keys && Il.keys.IE_PROTO || "");
  return e7 ? "Symbol(src)_1." + e7 : "";
}();
function _T(e7) {
  return !!wy && wy in e7;
}
var wT = _T, ST = Function.prototype, OT = ST.toString;
function xT(e7) {
  if (e7 != null) {
    try {
      return OT.call(e7);
...
var O_ = xT, AT = Td, PT = wT, TT = _n, IT = O_, ET = /[\\^$.*+?()[\]{}|]/g, $T = /^\[object .+?Constructor\]$/, MT = Function.prototype, DT = Object.prototype, NT = MT.toString, CT = DT.hasOwnProperty, jT = RegExp("^" + NT.call(CT).replace(ET, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
function BT(e7) {
  if (!TT(e7) || PT(e7)) return false;
  var t = AT(e7) ? jT : $T;
  return t.test(IT(e7));
}
var RT = BT;
...
var LT = kT, FT = RT, UT = LT;
function zT(e7, t) {
  var r = UT(e7, t);
  return FT(r) ? r : void 0;
}
var ti = zT, WT = ti, VT = WT(Object, "create"), xu = VT, Sy = xu;
function qT() {
...
var KT = HT, YT = xu, XT = "__lodash_hash_undefined__", JT = Object.prototype, QT = JT.hasOwnProperty;
function ZT(e7) {
  var t = this.__data__;
  if (YT) {
    var r = t[e7];
  ...
  return QT.call(t, e7) ? t[e7] : void 0;
}
var tI = ZT, eI = xu, rI = Object.prototype, nI = rI.hasOwnProperty;
function iI(e7) {
  var t = this.__data__;
  return eI ? t[e7] !== void 0 : nI.call(t, e7);
}
var aI = iI, oI = xu, sI = "__lodash_hash_undefined__";
function cI(e7, t) {
  var r = this.__data__;
  return this.size += this.has(e7) ? 0 : 1, r[e7] = oI && t === void 0 ? sI : t, this;
}
var uI = cI, lI = GT, fI = KT, hI = tI, dI = aI, pI = uI;
function ya(e7) {
...
ya.prototype.clear = lI;
ya.prototype.delete = fI;
ya.prototype.get = hI;
ya.prototype.has = dI;
ya.prototype.set = pI;
var yI = ya;
...
var Id = gI, bI = Id;
function _I(e7, t) {
  for (var r = e7.length; r--; ) if (bI(e7[r][0], t)) return r;
  return -1;
}
var Au = _I, wI = Au, SI = Array.prototype, OI = SI.splice;
function xI(e7) {
  var t = this.__data__, r = wI(t, e7);
  if (r < 0) return false;
  var n = t.length - 1;
  return r == n ? t.pop() : OI.call(t, r, 1), --this.size, true;
}
var AI = xI, PI = Au;
function TI(e7) {
  var t = this.__data__, r = PI(t, e7);
  return r < 0 ? void 0 : t[r][1];
}
var II = TI, EI = Au;
function $I(e7) {
  return EI(this.__data__, e7) > -1;
}
var MI = $I, DI = Au;
function NI(e7, t) {
  var r = this.__data__, n = DI(r, e7);
  return n < 0 ? (++this.size, r.push([e7, t])) : r[n][1] = t, this;
}
var CI = NI, jI = vI, BI = AI, RI = II, kI = MI, LI = CI;
function ma(e7) {
  var t = -1, r = e7 == null ? 0 : e7.length;
  for (this.clear(); ++t < r; ) {
    var n = e7[t];
...
ma.prototype.clear = jI;
ma.prototype.delete = BI;
ma.prototype.get = RI;
ma.prototype.has = kI;
ma.prototype.set = LI;
var Pu = ma, FI = ti, UI = $r, zI = FI(UI, "Map"), Ed = zI, Oy = yI, WI = Pu, VI = Ed;
function qI() {
  this.size = 0, this.__data__ = { hash: new Oy(), map: new (VI || WI)(), string: new Oy() };
}
var GI = qI;
function HI(e7) {
  var t = typeof e7;
...
var Tu = XI, JI = Tu;
function QI(e7) {
  var t = JI(this, e7).delete(e7);
  return this.size -= t ? 1 : 0, t;
}
var ZI = QI, tE = Tu;
function eE(e7) {
  return tE(this, e7).get(e7);
}
var rE = eE, nE = Tu;
function iE(e7) {
  return nE(this, e7).has(e7);
}
var aE = iE, oE = Tu;
function sE(e7, t) {
  var r = oE(this, e7), n = r.size;
  return r.set(e7, t), this.size += r.size == n ? 0 : 1, this;
}
var cE = sE, uE = GI, lE = ZI, fE = rE, hE = aE, dE = cE;
function va(e7) {
  var t = -1, r = e7 == null ? 0 : e7.length;
  for (this.clear(); ++t < r; ) {
    var n = e7[t];
...
va.prototype.clear = uE;
va.prototype.delete = lE;
va.prototype.get = fE;
va.prototype.has = hE;
va.prototype.set = dE;
var $d = va, x_ = $d, pE = "Expected a function";
function Md(e7, t) {
  if (typeof e7 != "function" || t != null && typeof t != "function") throw new TypeError(pE);
  var r = function() {
...
var mE = A_, vE = 500;
function gE(e7) {
  var t = mE(e7, function(n) {
    return r.size === vE && r.clear(), n;
  }), r = t.cache;
  return t;
}
var bE = gE, _E = bE, wE = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, SE = /\\(\\)?/g, OE = _E(function(e7) {
  var t = [];
  return e7.charCodeAt(0) === 46 && t.push(""), e7.replace(wE, function(r, n, i, a) {
...
var Dd = AE, xy = Zo, PE = Dd, TE = $e, IE = da, Ay = xy ? xy.prototype : void 0, Py = Ay ? Ay.toString : void 0;
function P_(e7) {
  if (typeof e7 == "string") return e7;
  if (TE(e7)) return PE(e7, P_) + "";
  if (IE(e7)) return Py ? Py.call(e7) : "";
  var t = e7 + "";
...
var T_ = ME, DE = $e, NE = Pd, CE = xE, jE = T_;
function BE(e7, t) {
  return DE(e7) ? e7 : NE(e7, t) ? [e7] : CE(jE(e7));
}
var I_ = BE, RE = da;
function kE(e7) {
  if (typeof e7 == "string" || RE(e7)) return e7;
  var t = e7 + "";
  return t == "0" && 1 / e7 == -1 / 0 ? "-0" : t;
}
var Iu = kE, LE = I_, FE = Iu;
function UE(e7, t) {
  t = LE(t, e7);
  for (var r = 0, n = t.length; e7 != null && r < n; ) e7 = e7[FE(t[r++])];
  return r && r == n ? e7 : void 0;
}
var Nd = UE, zE = Nd;
function WE(e7, t, r) {
  var n = e7 == null ? void 0 : zE(e7, t);
  return n === void 0 ? r : n;
}
var E_ = WE;
const Ye = Bt(E_);
...
var qE = VE;
const st = Bt(qE);
var GE = Jr, HE = $e, KE = Qr, YE = "[object String]";
function XE(e7) {
  return typeof e7 == "string" || !HE(e7) && KE(e7) && GE(e7) == YE;
}
var JE = XE;
const Hn = Bt(JE);
var $_ = { exports: {} }, $t = {};
...
*/
var Cd = Symbol.for("react.element"), jd = Symbol.for("react.portal"), Eu = Symbol.for("react.fragment"), $u = Symbol.for("react.strict_mode"), Mu = Symbol.for("react.profiler"), Du = Symbol.for("react.provider"), Nu = Symbol.for("react.context"), QE = Symbol.for("react.server_context"), Cu = Symbol.for("react.forward_ref"), ju = Symbol.for("react.suspense"), Bu = Symbol.for("react.suspense_list"), Ru = Symbol.for("react.memo"), ku = Symbol.for("react.lazy"), ZE = Symbol.for("react.offscreen"), M_;
...
$t.ContextConsumer = Nu;
$t.ContextProvider = Du;
$t.Element = Cd;
$t.ForwardRef = Cu;
$t.Fragment = Eu;
$t.Lazy = ku;
...
$t.isValidElementType = function(e7) {
  return typeof e7 == "string" || typeof e7 == "function" || e7 === Eu || e7 === Mu || e7 === $u || e7 === ju || e7 === Bu || e7 === ZE || typeof e7 == "object" && e7 !== null && (e7.$$typeof === ku || e7.$$typeof === Ru || e7.$$typeof === Du || e7.$$typeof === Nu || e7.$$typeof === Cu || e7.$$typeof === M_ || e7.getModuleId !== void 0);
};
$t.typeOf = Ze;
$_.exports = $t;
var t$ = $_.exports, e$ = Jr, r$ = Qr, n$ = "[object Number]";
function i$(e7) {
  return typeof e7 == "number" || r$(e7) && e$(e7) == n$;
}
var D_ = i$;
const a$ = Bt(D_);
var o$ = D_;
...
var p$ = ["viewBox", "children"], y$ = ["aria-activedescendant", "aria-atomic", "aria-autocomplete", "aria-busy", "aria-checked", "aria-colcount", "aria-colindex", "aria-colspan", "aria-controls", "aria-current", "aria-describedby", "aria-details", "aria-disabled", "aria-errormessage", "aria-expanded", "aria-flowto", "aria-haspopup", "aria-hidden", "aria-invalid", "aria-keyshortcuts", "aria-label", "aria-labelledby", "aria-level", "aria-live", "aria-modal", "aria-multiline", "aria-multiselectable", "aria-orientation", "aria-owns", "aria-placeholder", "aria-posinset", "aria-pressed", "aria-readonly", "aria-relevant", "aria-required", "aria-roledescription", "aria-rowcount", "aria-rowindex", "aria-rowspan", "aria-selected", "aria-setsize", "aria-sort", "aria-valuemax", "aria-valuemin", "aria-valuenow", "aria-valuetext", "className", "color", "height", "id", "lang", "max", "media", "method", "min", "name", "style", "target", "width", "role", "tabIndex", "accentHeight", "accumulate", "additive", "alignmentBaseline", "allowReorder", "alphabetic", "amplitude", "arabicForm", "ascent", "attributeName", "attributeType", "autoReverse", "azimuth", "baseFrequency", "baselineShift", "baseProfile", "bbox", "begin", "bias", "by", "calcMode", "capHeight", "clip", "clipPath", "clipPathUnits", "clipRule", "colorInterpolation", "colorInterpolationFilters", "colorProfile", "colorRendering", "contentScriptType", "contentStyleType", "cursor", "cx", "cy", "d", "decelerate", "descent", "diffuseConstant", "direction", "display", "divisor", "dominantBaseline", "dur", "dx", "dy", "edgeMode", "elevation", "enableBackground", "end", "exponent", "externalResourcesRequired", "fill", "fillOpacity", "fillRule", "filter", "filterRes", "filterUnits", "floodColor", "floodOpacity", "focusable", "fontFamily", "fontSize", "fontSizeAdjust", "fontStretch", "fontStyle", "fontVariant", "fontWeight", "format", "from", "fx", "fy", "g1", "g2", "glyphName", "glyphOrientationHorizontal", "glyphOrientationVertical", "glyphRef", "gradientTransform", "gradientUnits", "hanging", "horizAdvX", "horizOriginX", "href", "ideographic", "imageRendering", "in2", "in", "intercept", "k1", "k2", "k3", "k4", "k", "kernelMatrix", "kernelUnitLength", "kerning", "keyPoints", "keySplines", "keyTimes", "lengthAdjust", "letterSpacing", "lightingColor", "limitingConeAngle", "local", "markerEnd", "markerHeight", "markerMid", "markerStart", "markerUnits", "markerWidth", "mask", "maskContentUnits", "maskUnits", "mathematical", "mode", "numOctaves", "offset", "opacity", "operator", "order", "orient", "orientation", "origin", "overflow", "overlinePosition", "overlineThickness", "paintOrder", "panose1", "pathLength", "patternContentUnits", "patternTransform", "patternUnits", "pointerEvents", "pointsAtX", "pointsAtY", "pointsAtZ", "preserveAlpha", "preserveAspectRatio", "primitiveUnits", "r", "radius", "refX", "refY", "renderingIntent", "repeatCount", "repeatDur", "requiredExtensions", "requiredFeatures", "restart", "result", "rotate", "rx", "ry", "seed", "shapeRendering", "slope", "spacing", "specularConstant", "specularExponent", "speed", "spreadMethod", "startOffset", "stdDeviation", "stemh", "stemv", "stitchTiles", "stopColor", "stopOpacity", "strikethroughPosition", "strikethroughThickness", "string", "stroke", "strokeDasharray", "strokeDashoffset", "strokeLinecap", "strokeLinejoin", "strokeMiterlimit", "strokeOpacity", "strokeWidth", "surfaceScale", "systemLanguage", "tableValues", "targetX", "targetY", "textAnchor", "textDecoration", "textLength", "textRendering", "to", "transform", "u1", "u2", "underlinePosition", "underlineThickness", "unicode", "unicodeBidi", "unicodeRange", "unitsPerEm", "vAlphabetic", "values", "vectorEffect", "version", "vertAdvY", "vertOriginX", "vertOriginY", "vHanging", "vIdeographic", "viewTarget", "visibility", "vMathematical", "widths", "wordSpacing", "writingMode", "x1", "x2", "x", "xChannelSelector", "xHeight", "xlinkActuate", "xlinkArcrole", "xlinkHref", "xlinkRole", "xlinkShow", "xlinkTitle", "xlinkType", "xmlBase", "xmlLang", "xmlns", "xmlnsXlink", "xmlSpace", "y1", "y2", "y", "yChannelSelector", "z", "zoomAndPan", "ref", "key", "angle"], Ty = ["points", "pathLength"], El = { svg: p$, polygon: Ty, polyline: Ty }, Bd = ["dangerouslySetInnerHTML", "onCopy", "onCopyCapture", "onCut", "onCutCapture", "onPaste", "onPasteCapture", "onCompositionEnd", "onCompositionEndCapture", "onCompositionStart", "onCompositionStartCapture", "onCompositionUpdate", "onCompositionUpdateCapture", "onFocus", "onFocusCapture", "onBlur", "onBlurCapture", "onChange", "onChangeCapture", "onBeforeInput", "onBeforeInputCapture", "onInput", "onInputCapture", "onReset", "onResetCapture", "onSubmit", "onSubmitCapture", "onInvalid", "onInvalidCapture", "onLoad", "onLoadCapture", "onError", "onErrorCapture", "onKeyDown", "onKeyDownCapture", "onKeyPress", "onKeyPressCapture", "onKeyUp", "onKeyUpCapture", "onAbort", "onAbortCapture", "onCanPlay", "onCanPlayCapture", "onCanPlayThrough", "onCanPlayThroughCapture", "onDurationChange", "onDurationChangeCapture", "onEmptied", "onEmptiedCapture", "onEncrypted", "onEncryptedCapture", "onEnded", "onEndedCapture", "onLoadedData", "onLoadedDataCapture", "onLoadedMetadata", "onLoadedMetadataCapture", "onLoadStart", "onLoadStartCapture", "onPause", "onPauseCapture", "onPlay", "onPlayCapture", "onPlaying", "onPlayingCapture", "onProgress", "onProgressCapture", "onRateChange", "onRateChangeCapture", "onSeeked", "onSeekedCapture", "onSeeking", "onSeekingCapture", "onStalled", "onStalledCapture", "onSuspend", "onSuspendCapture", "onTimeUpdate", "onTimeUpdateCapture", "onVolumeChange", "onVolumeChangeCapture", "onWaiting", "onWaitingCapture", "onAuxClick", "onAuxClickCapture", "onClick", "onClickCapture", "onContextMenu", "onContextMenuCapture", "onDoubleClick", "onDoubleClickCapture", "onDrag", "onDragCapture", "onDragEnd", "onDragEndCapture", "onDragEnter", "onDragEnterCapture", "onDragExit", "onDragExitCapture", "onDragLeave", "onDragLeaveCapture", "onDragOver", "onDragOverCapture", "onDragStart", "onDragStartCapture", "onDrop", "onDropCapture", "onMouseDown", "onMouseDownCapture", "onMouseEnter", "onMouseLeave", "onMouseMove", "onMouseMoveCapture", "onMouseOut", "onMouseOutCapture", "onMouseOver", "onMouseOverCapture", "onMouseUp", "onMouseUpCapture", "onSelect", "onSelectCapture", "onTouchCancel", "onTouchCancelCapture", "onTouchEnd", "onTouchEndCapture", "onTouchMove", "onTouchMoveCapture", "onTouchStart", "onTouchStartCapture", "onPointerDown", "onPointerDownCapture", "onPointerMove", "onPointerMoveCapture", "onPointerUp", "onPointerUpCapture", "onPointerCancel", "onPointerCancelCapture", "onPointerEnter", "onPointerEnterCapture", "onPointerLeave", "onPointerLeaveCapture", "onPointerOver", "onPointerOverCapture", "onPointerOut", "onPointerOutCapture", "onGotPointerCapture", "onGotPointerCaptureCapture", "onLostPointerCapture", "onLostPointerCaptureCapture", "onScroll", "onScrollCapture", "onWheel", "onWheelCapture", "onAnimationStart", "onAnimationStartCapture", "onAnimationEnd", "onAnimationEndCapture", "onAnimationIteration", "onAnimationIterationCapture", "onTransitionEnd", "onTransitionEndCapture"], mc = function(t, r) {
  ...
  if (!pa(t) || wf(t) !== "object") return null;
  var i = null;
  return Object.keys(t).forEach(function(a) {
    var o = t[a];
    Bd.includes(a) && typeof o == "function" && (i || (i = {}), i[a] = m$(o, r, n));
  }), i;
}, v$ = ["children"], g$ = ["children"];
function Iy(e7, t) {
  if (e7 == null) return {};
  var r = b$(e7, t), n, i;
...
}, $y = null, $l = null, Rd = function e(t) {
  if (t === $y && Array.isArray($l)) return $l;
  var r = [];
  return B.Children.forEach(t, function(n) {
    st(n) || (t$.isFragment(n) ? r = r.concat(e(n.props.children)) : r.push(n));
  }), $l = r, $y = t, r;
};
function Te(e7, t) {
  var r = [], n = [];
...
var My = function(t) {
...
}, _$ = ["a", "altGlyph", "altGlyphDef", "altGlyphItem", "animate", "animateColor", "animateMotion", "animateTransform", "circle", "clipPath", "color-profile", "cursor", "defs", "desc", "ellipse", "feBlend", "feColormatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting", "feDisplacementMap", "feDistantLight", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feImage", "feMerge", "feMergeNode", "feMorphology", "feOffset", "fePointLight", "feSpecularLighting", "feSpotLight", "feTile", "feTurbulence", "filter", "font", "font-face", "font-face-format", "font-face-name", "font-face-url", "foreignObject", "g", "glyph", "glyphRef", "hkern", "image", "line", "lineGradient", "marker", "mask", "metadata", "missing-glyph", "mpath", "path", "pattern", "polygon", "polyline", "radialGradient", "rect", "script", "set", "stop", "style", "svg", "switch", "symbol", "text", "textPath", "title", "tref", "tspan", "use", "view", "vkern"], w$ = function(t) {
  return t && t.type && Hn(t.type) && _$.indexOf(t.type) >= 0;
}, N_ = function(t) {
  return t && Sf(t) === "object" && "clipDot" in t;
}, S$ = function(t, r, n, i) {
  var a, o = (a = El == null ? void 0 : El[i]) !== null && a !== void 0 ? a : [];
  return r.startsWith("data-") || !lt(t) && (i && o.includes(r) || y$.includes(r)) || n && Bd.includes(r);
}, ct = function(t, r, n) {
  if (!t || typeof t == "function" || typeof t == "boolean") return null;
  var i = t;
  ...
  if (!st(t) && !st(r)) {
    var n = t.props || {}, i = n.children, a = Iy(n, v$), o = r.props || {}, s = o.children, c = Iy(o, g$);
    return i && s ? $i(a, c) && Of(i, s) : !i && !s ? $i(a, c) : false;
  }
  return false;
}, Ny = function(t, r) {
  var n = [], i = {};
...
function xf() {
  return xf = Object.assign ? Object.assign.bind() : function(e7) {
...
function Af(e7) {
  var t = e7.children, r = e7.width, n = e7.height, i = e7.viewBox, a = e7.className, o = e7.style, s = e7.title, c = e7.desc, u = P$(e7, A$), l = i || { width: r, height: n, x: 0, y: 0 }, f = mt("recharts-surface", a);
  return A.createElement("svg", xf({}, ct(u, true, "svg"), { className: f, width: r, height: n, style: o, viewBox: "".concat(l.x, " ").concat(l.y, " ").concat(l.width, " ").concat(l.height) }), A.createElement("title", null, s), A.createElement("desc", null, c), t);
}
...
var St = A.forwardRef(function(e7, t) {
  var r = e7.children, n = e7.className, i = E$(e7, I$), a = mt("recharts-layer", n);
  return A.createElement("g", Pf({ className: a }, ct(i, true), { ref: t }), r);
}), zr = function(t, r) {
...
function C$(e7, t, r) {
  var n = e7.length;
  return r = r === void 0 ? n : r, !t && r >= n ? e7 : N$(e7, t, r);
}
var j$ = C$, B$ = "\\ud800-\\udfff", R$ = "\\u0300-\\u036f", k$ = "\\ufe20-\\ufe2f", L$ = "\\u20d0-\\u20ff", F$ = R$ + k$ + L$, U$ = "\\ufe0e\\ufe0f", z$ = "\\u200d", W$ = RegExp("[" + z$ + B$ + F$ + U$ + "]");
function V$(e7) {
  return W$.test(e7);
}
var C_ = V$;
...
var G$ = q$, j_ = "\\ud800-\\udfff", H$ = "\\u0300-\\u036f", K$ = "\\ufe20-\\ufe2f", Y$ = "\\u20d0-\\u20ff", X$ = H$ + K$ + Y$, J$ = "\\ufe0e\\ufe0f", Q$ = "[" + j_ + "]", Tf = "[" + X$ + "]", If = "\\ud83c[\\udffb-\\udfff]", Z$ = "(?:" + Tf + "|" + If + ")", B_ = "[^" + j_ + "]", R_ = "(?:\\ud83c[\\udde6-\\uddff]){2}", k_ = "[\\ud800-\\udbff][\\udc00-\\udfff]", tM = "\\u200d", L_ = Z$ + "?", F_ = "[" + J$ + "]?", eM = "(?:" + tM + "(?:" + [B_, R_, k_].join("|") + ")" + F_ + L_ + ")*", rM = F_ + L_ + eM, nM = "(?:" + [B_ + Tf + "?", Tf, R_, k_, Q$].join("|") + ")", iM = RegExp(If + "(?=" + If + ")|" + nM + rM, "g");
function aM(e7) {
  return e7.match(iM) || [];
}
var oM = aM, sM = G$, cM = C_, uM = oM;
function lM(e7) {
  return cM(e7) ? uM(e7) : sM(e7);
}
var fM = lM, hM = j$, dM = C_, pM = fM, yM = T_;
function mM(e7) {
  return function(t) {
    t = yM(t);
    var r = dM(t) ? pM(t) : void 0, n = r ? r[0] : t.charAt(0), i = r ? hM(r, 1).join("") : t.slice(1);
    return n[e7]() + i;
  };
}
var vM = mM, gM = vM, bM = gM("toUpperCase"), _M = bM;
const Lu = Bt(_M);
function jt(e7) {
  return function() {
    return e7;
...
const U_ = Math.cos, vc = Math.sin, hr = Math.sqrt, gc = Math.PI, Fu = 2 * gc, Ef = Math.PI, $f = 2 * Ef, Mn = 1e-6, wM = $f - Mn;
function z_(e7) {
  this._ += e7[0];
...
class OM {
  constructor(t) {
    this._x0 = this._y0 = this._x1 = this._y1 = null, this._ = "", this._append = t == null ? z_ : SM(t);
  }
  moveTo(t, r) {
  ...
  arcTo(t, r, n, i, a) {
    ...
    if (this._x1 === null) this._append`M${this._x1 = t},${this._y1 = r}`;
      ...
      let d = n - o, y = i - s, m = c * c + u * u, p = d * d + y * y, b = Math.sqrt(m), _ = Math.sqrt(h), S = a * Math.tan((Ef - Math.acos((m + h - p) / (2 * b * _))) / 2), w = S / _, v = S / b;
  ...
  arc(t, r, n, i, a, o) {
    ...
    this._x1 === null ? this._append`M${u},${l}` : (Math.abs(this._x1 - u) > Mn || Math.abs(this._y1 - l) > Mn) && this._append`L${u},${l}`, n && (h < 0 && (h = h % $f + $f), h > wM ? this._append`A${n},${n},0,1,${f},${t - s},${r - c}A${n},${n},0,1,${f},${this._x1 = u},${this._y1 = l}` : h > Mn && this._append`A${n},${n},0,${+(h >= Ef)},${f},${this._x1 = t + n * Math.cos(a)},${this._y1 = r + n * Math.sin(a)}`);
  }
  rect(t, r, n, i) {
...
function G_(e7, t) {
  var r = jt(true), n = null, i = Uu, a = null, o = kd(s);
...
const Fd = { draw(e7, t) {
  const r = hr(t / gc);
  e7.moveTo(r, 0), e7.arc(0, 0, r, 0, Fu);
} }, PM = { draw(e7, t) {
  const r = hr(t / 5) / 2;
...
} }, K_ = hr(1 / 3), TM = K_ * 2, IM = { draw(e7, t) {
  const r = hr(t / TM), n = r * K_;
  e7.moveTo(0, -r), e7.lineTo(n, 0), e7.lineTo(0, r), e7.lineTo(-n, 0), e7.closePath();
} }, EM = { draw(e7, t) {
  const r = hr(t), n = -r / 2;
  e7.rect(n, n, r, r);
} }, $M = 0.8908130915292852, Y_ = vc(gc / 10) / vc(7 * gc / 10), MM = vc(Fu / 10) * Y_, DM = -U_(Fu / 10) * Y_, NM = { draw(e7, t) {
  const r = hr(t * $M), n = MM * r, i = DM * r;
  e7.moveTo(0, -r), e7.lineTo(n, i);
  for (let a = 1; a < 5; ++a) {
    const o = Fu * a / 5, s = U_(o), c = vc(o);
    e7.lineTo(c * r, -s * r), e7.lineTo(s * n - c * i, c * n + s * i);
  }
  e7.closePath();
} }, Ml = hr(3), CM = { draw(e7, t) {
  const r = -hr(t / (Ml * 3));
  e7.moveTo(0, r * 2), e7.lineTo(-Ml * r, -r), e7.lineTo(Ml * r, -r), e7.closePath();
} }, Le = -0.5, Fe = hr(3) / 2, Mf = 1 / hr(12), jM = (Mf / 2 + 1) * 3, BM = { draw(e7, t) {
  const r = hr(t / jM), n = r / 2, i = r * Mf, a = n, o = r * Mf + r, s = -a, c = o;
...
wc.prototype = { areaStart: function() {
  ...
  switch (this._point) {
    case 2:
      ...
      break;
    case 3:
      Dl(this, this._t0, By(this, this._t0));
      break;
  }
  (this._line || this._line !== 0 && this._point === 1) && this._context.closePath(), this._line = 1 - this._line;
}, point: function(e7, t) {
  ...
  if (e7 = +e7, t = +t, !(e7 === this._x1 && t === this._y1)) {
    switch (this._point) {
      ...
      case 1:
        ...
        break;
      case 2:
        this._point = 3, Dl(this, By(this, r = jy(this, e7, t)), r);
        break;
      default:
        Dl(this, this._t0, r = jy(this, e7, t));
        break;
    }
...
zu.prototype = { areaStart: function() {
  this._line = 0;
}, areaEnd: function() {
  this._line = NaN;
}, lineStart: function() {
...
function XM() {
  var e7 = jt([]), t = Df, r = Li, n = KM;
  function i(a) {
    var o = Array.from(e7.apply(this, arguments), YM), s, c = o.length, u = -1, l;
  ...
  return i.keys = function(a) {
    ...
    return arguments.length ? (t = a == null ? Df : typeof a == "function" ? a : jt(Array.from(a)), i) : t;
  }, i.offset = function(a) {
...
function eD(e7, t, r) {
  return t = rD(t), t in e7 ? Object.defineProperty(e7, t, { value: r, enumerable: true, configurable: true, writable: true }) : e7[t] = r, e7;
}
function rD(e7) {
  var t = nD(e7, "string");
...
var nw = { symbolCircle: Fd, symbolCross: PM, symbolDiamond: IM, symbolSquare: EM, symbolStar: NM, symbolTriangle: CM, symbolWye: BM }, oD = Math.PI / 180, sD = function(t) {
  var r = "symbol".concat(Lu(t));
  return nw[r] || Fd;
}, cD = function(t, r, n) {
  if (r === "area") return t;
  switch (n) {
  ...
  nw["symbol".concat(Lu(t))] = r;
}, Wu = function(t) {
  var r = t.type, n = r === void 0 ? "circle" : r, i = t.size, a = i === void 0 ? 64 : i, o = t.sizeType, s = o === void 0 ? "area" : o, c = iD(t, tD), u = Ly(Ly({}, c), {}, { type: n, size: a, sizeType: s }), l = function() {
    var p = sD(n), b = RM().type(p).size(cD(a, s, n));
    return b();
  }, f = u.className, h = u.cx, d = u.cy, y = ct(u, true);
  return h === +h && d === +d && a === +a ? A.createElement("path", Nf({}, y, { className: mt("recharts-symbols", f), transform: "translate(".concat(h, ", ").concat(d, ")"), d: l() })) : null;
};
Wu.registerSymbol = uD;
function Fi(e7) {
  "@babel/helpers - typeof";
...
function Cf() {
  return Cf = Object.assign ? Object.assign.bind() : function(e7) {
    for (var t = 1; t < arguments.length; t++) {
      var r = arguments[t];
      for (var n in r) Object.prototype.hasOwnProperty.call(r, n) && (e7[n] = r[n]);
    }
...
function dD(e7, t, r) {
  return t && hD(e7.prototype, t), Object.defineProperty(e7, "prototype", { writable: false }), e7;
}
function pD(e7, t, r) {
  return t = Sc(t), yD(e7, iw() ? Reflect.construct(t, r || [], Sc(e7).constructor) : t.apply(e7, r));
}
function yD(e7, t) {
...
function vD(e7, t) {
  ...
  e7.prototype = Object.create(t && t.prototype, { constructor: { value: e7, writable: true, configurable: true } }), Object.defineProperty(e7, "prototype", { writable: false }), t && jf(e7, t);
}
function jf(e7, t) {
...
var Ue = 32, Ud = function(e7) {
  function t() {
    return fD(this, t), pD(this, t, arguments);
  }
  return vD(t, e7), dD(t, [{ key: "renderIcon", value: function(n) {
    ...
    return A.createElement(Wu, { fill: c, cx: a, cy: a, size: Ue, sizeType: "diameter", type: n.type });
    ...
    return a.map(function(d, y) {
      ...
      return A.createElement("li", Cf({ className: p, style: f, key: "legend-item-".concat(y) }, uo(n.props, d, y)), A.createElement(Af, { width: o, height: o, viewBox: l, style: h }, n.renderIcon(d)), A.createElement("span", { className: "recharts-legend-item-text", style: { color: _ } }, m ? m(b, d, y) : b));
    });
...
var TD = PD, ID = Pu, ED = Ed, $D = $d, MD = 200;
function DD(e7, t) {
  var r = this.__data__;
  if (r instanceof ID) {
    var n = r.__data__;
    if (!ED || n.length < MD - 1) return n.push([e7, t]), this.size = ++r.size, this;
    r = this.__data__ = new $D(n);
  }
  return r.set(e7, t), this.size = r.size, this;
}
var ND = DD, CD = Pu, jD = wD, BD = OD, RD = AD, kD = TD, LD = ND;
function ba(e7) {
  var t = this.__data__ = new CD(e7);
  this.size = t.size;
}
ba.prototype.clear = jD;
ba.prototype.delete = BD;
ba.prototype.get = RD;
ba.prototype.has = kD;
ba.prototype.set = LD;
var ow = ba, FD = "__lodash_hash_undefined__";
function UD(e7) {
  return this.__data__.set(e7, FD), this;
}
var zD = UD;
function WD(e7) {
  return this.__data__.has(e7);
}
var VD = WD, qD = $d, GD = zD, HD = VD;
function Oc(e7) {
  var t = -1, r = e7 == null ? 0 : e7.length;
  for (this.__data__ = new qD(); ++t < r; ) this.add(e7[t]);
}
Oc.prototype.add = Oc.prototype.push = GD;
Oc.prototype.has = HD;
var sw = Oc;
function KD(e7, t) {
...
var uw = YD, XD = sw, JD = cw, QD = uw, ZD = 1, tN = 2;
function eN(e7, t, r, n, i, a) {
  var o = r & ZD, s = e7.length, c = t.length;
  if (s != c && !(o && c > s)) return false;
  var u = a.get(e7), l = a.get(t);
  if (u && l) return u == t && l == e7;
  var f = -1, h = true, d = r & tN ? new XD() : void 0;
  for (a.set(e7, t), a.set(t, e7); ++f < s; ) {
    ...
    if (d) {
      if (!JD(t, function(b, _) {
        if (!QD(d, _) && (y === b || i(y, b, r, n, a))) return d.push(_);
      })) {
        h = false;
        break;
      }
...
var lw = eN, rN = $r, nN = rN.Uint8Array, iN = nN;
function aN(e7) {
...
var zd = sN, Uy = Zo, zy = iN, cN = Id, uN = lw, lN = oN, fN = zd, hN = 1, dN = 2, pN = "[object Boolean]", yN = "[object Date]", mN = "[object Error]", vN = "[object Map]", gN = "[object Number]", bN = "[object RegExp]", _N = "[object Set]", wN = "[object String]", SN = "[object Symbol]", ON = "[object ArrayBuffer]", xN = "[object DataView]", Wy = Uy ? Uy.prototype : void 0, Nl = Wy ? Wy.valueOf : void 0;
function AN(e7, t, r, n, i, a, o) {
  switch (r) {
    case xN:
    ...
    case _N:
      var c = n & hN;
      if (s || (s = fN), e7.size != t.size && !c) return false;
      var u = o.get(e7);
      if (u) return u == t;
      n |= dN, o.set(e7, t);
      var l = uN(s(e7), s(t), n, i, a, o);
      return o.delete(e7), l;
    case SN:
      if (Nl) return Nl.call(e7) == Nl.call(t);
  }
  return false;
}
var PN = AN;
...
var fw = TN, IN = fw, EN = $e;
function $N(e7, t, r) {
  var n = t(e7);
  return EN(e7) ? n : IN(n, r(e7));
}
var MN = $N;
function DN(e7, t) {
...
var jN = CN, BN = NN, RN = jN, kN = Object.prototype, LN = kN.propertyIsEnumerable, Vy = Object.getOwnPropertySymbols, FN = Vy ? function(e7) {
  return e7 == null ? [] : (e7 = Object(e7), BN(Vy(e7), function(t) {
    return LN.call(e7, t);
  }));
} : RN, UN = FN;
function zN(e7, t) {
...
var WN = zN, VN = Jr, qN = Qr, GN = "[object Arguments]";
function HN(e7) {
  return qN(e7) && VN(e7) == GN;
}
var KN = HN, qy = KN, YN = Qr, hw = Object.prototype, XN = hw.hasOwnProperty, JN = hw.propertyIsEnumerable, QN = qy(/* @__PURE__ */ function() {
  return arguments;
}()) ? qy : function(e7) {
  return YN(e7) && XN.call(e7, "callee") && !JN.call(e7, "callee");
}, Wd = QN, xc = { exports: {} };
function ZN() {
  return false;
}
...
xc.exports;
(function(e7, t) {
  var r = $r, n = tC, i = t && !t.nodeType && t, a = i && true && e7 && !e7.nodeType && e7, o = a && a.exports === i, s = o ? r.Buffer : void 0, c = s ? s.isBuffer : void 0, u = c || n;
  e7.exports = u;
})(xc, xc.exports);
var dw = xc.exports, eC = 9007199254740991, rC = /^(?:0|[1-9]\d*)$/;
function nC(e7, t) {
  var r = typeof e7;
  return t = t ?? eC, !!t && (r == "number" || r != "symbol" && rC.test(e7)) && e7 > -1 && e7 % 1 == 0 && e7 < t;
}
var Vd = nC, iC = 9007199254740991;
function aC(e7) {
  return typeof e7 == "number" && e7 > -1 && e7 % 1 == 0 && e7 <= iC;
}
var qd = aC, oC = Jr, sC = qd, cC = Qr, uC = "[object Arguments]", lC = "[object Array]", fC = "[object Boolean]", hC = "[object Date]", dC = "[object Error]", pC = "[object Function]", yC = "[object Map]", mC = "[object Number]", vC = "[object Object]", gC = "[object RegExp]", bC = "[object Set]", _C = "[object String]", wC = "[object WeakMap]", SC = "[object ArrayBuffer]", OC = "[object DataView]", xC = "[object Float32Array]", AC = "[object Float64Array]", PC = "[object Int8Array]", TC = "[object Int16Array]", IC = "[object Int32Array]", EC = "[object Uint8Array]", $C = "[object Uint8ClampedArray]", MC = "[object Uint16Array]", DC = "[object Uint32Array]", kt = {};
kt[xC] = kt[AC] = kt[PC] = kt[TC] = kt[IC] = kt[EC] = kt[$C] = kt[MC] = kt[DC] = true;
kt[uC] = kt[lC] = kt[SC] = kt[fC] = kt[OC] = kt[hC] = kt[dC] = kt[pC] = kt[yC] = kt[mC] = kt[vC] = kt[gC] = kt[bC] = kt[_C] = kt[wC] = false;
function NC(e7) {
  return cC(e7) && sC(e7.length) && !!kt[oC(e7)];
}
var CC = NC;
function jC(e7) {
  return function(t) {
...
var BC = Ac.exports, RC = CC, kC = pw, Gy = BC, Hy = Gy && Gy.isTypedArray, LC = Hy ? kC(Hy) : RC, yw = LC, FC = WN, UC = Wd, zC = $e, WC = dw, VC = Vd, qC = yw, GC = Object.prototype, HC = GC.hasOwnProperty;
function KC(e7, t) {
  var r = zC(e7), n = !r && UC(e7), i = !r && !n && WC(e7), a = !r && !n && !i && qC(e7), o = r || n || i || a, s = o ? FC(e7.length, String) : [], c = s.length;
  for (var u in e7) (t || HC.call(e7, u)) && !(o && (u == "length" || i && (u == "offset" || u == "parent") || a && (u == "buffer" || u == "byteLength" || u == "byteOffset") || VC(u, c))) && s.push(u);
  return s;
}
var YC = KC, XC = Object.prototype;
function JC(e7) {
  var t = e7 && e7.constructor, r = typeof t == "function" && t.prototype || XC;
  return e7 === r;
}
var QC = JC;
function ZC(e7, t) {
...
var mw = ZC, tj = mw, ej = tj(Object.keys, Object), rj = ej, nj = QC, ij = rj, aj = Object.prototype, oj = aj.hasOwnProperty;
function sj(e7) {
  if (!nj(e7)) return ij(e7);
  var t = [];
  for (var r in Object(e7)) oj.call(e7, r) && r != "constructor" && t.push(r);
  return t;
}
var cj = sj, uj = Td, lj = qd;
function fj(e7) {
  return e7 != null && lj(e7.length) && !uj(e7);
}
var ts = fj, hj = YC, dj = cj, pj = ts;
function yj(e7) {
  return pj(e7) ? hj(e7) : dj(e7);
}
var Vu = yj, mj = MN, vj = UN, gj = Vu;
function bj(e7) {
  return mj(e7, gj, vj);
}
var _j = bj, Ky = _j, wj = 1, Sj = Object.prototype, Oj = Sj.hasOwnProperty;
function xj(e7, t, r, n, i, a) {
  var o = r & wj, s = Ky(e7), c = s.length, u = Ky(t), l = u.length;
  if (c != l && !o) return false;
  for (var f = c; f--; ) {
    var h = s[f];
    if (!(o ? h in t : Oj.call(t, h))) return false;
  }
...
var Aj = xj, Pj = ti, Tj = $r, Ij = Pj(Tj, "DataView"), Ej = Ij, $j = ti, Mj = $r, Dj = $j(Mj, "Promise"), Nj = Dj, Cj = ti, jj = $r, Bj = Cj(jj, "Set"), vw = Bj, Rj = ti, kj = $r, Lj = Rj(kj, "WeakMap"), Fj = Lj, Bf = Ej, Rf = Ed, kf = Nj, Lf = vw, Ff = Fj, gw = Jr, _a = O_, Yy = "[object Map]", Uj = "[object Object]", Xy = "[object Promise]", Jy = "[object Set]", Qy = "[object WeakMap]", Zy = "[object DataView]", zj = _a(Bf), Wj = _a(Rf), Vj = _a(kf), qj = _a(Lf), Gj = _a(Ff), Dn = gw;
(Bf && Dn(new Bf(new ArrayBuffer(1))) != Zy || Rf && Dn(new Rf()) != Yy || kf && Dn(kf.resolve()) != Xy || Lf && Dn(new Lf()) != Jy || Ff && Dn(new Ff()) != Qy) && (Dn = function(e7) {
  var t = gw(e7), r = t == Uj ? e7.constructor : void 0, n = r ? _a(r) : "";
  if (n) switch (n) {
    case zj:
      return Zy;
    case Wj:
...
var Hj = Dn, Cl = ow, Kj = lw, Yj = PN, Xj = Aj, tm = Hj, em = $e, rm = dw, Jj = yw, Qj = 1, nm = "[object Arguments]", im = "[object Array]", fs = "[object Object]", Zj = Object.prototype, am = Zj.hasOwnProperty;
function tB(e7, t, r, n, i, a) {
  ...
  if (h && !l) return a || (a = new Cl()), o || Jj(e7) ? Kj(e7, t, r, n, i, a) : Yj(e7, t, c, r, n, i, a);
  if (!(r & Qj)) {
    var d = l && am.call(e7, "__wrapped__"), y = f && am.call(t, "__wrapped__");
    if (d || y) {
      var m = d ? e7.value() : e7, p = y ? t.value() : t;
      return a || (a = new Cl()), i(m, p, r, n, a);
    }
  }
  return h ? (a || (a = new Cl()), Xj(e7, t, r, n, i, a)) : false;
}
var eB = tB, rB = eB, om = Qr;
function bw(e7, t, r, n, i) {
  return e7 === t ? true : e7 == null || t == null || !om(e7) && !om(t) ? e7 !== e7 && t !== t : rB(e7, t, r, n, bw, i);
}
var Gd = bw, nB = ow, iB = Gd, aB = 1, oB = 2;
function sB(e7, t, r, n) {
  ...
  for (; ++i < a; ) {
    ...
    if (o && s[2]) {
      ...
      if (!(h === void 0 ? iB(l, u, aB | oB, n, f) : h)) return false;
    }
  }
  return true;
}
...
var _w = lB, fB = _w, hB = Vu;
function dB(e7) {
  for (var t = hB(e7), r = t.length; r--; ) {
    var n = t[r], i = e7[n];
    t[r] = [n, i, fB(i)];
  }
  return t;
...
var ww = yB, mB = cB, vB = pB, gB = ww;
function bB(e7) {
  var t = vB(e7);
  return t.length == 1 && t[0][2] ? gB(t[0][0], t[0][1]) : function(r) {
    return r === e7 || mB(r, e7, t);
  };
}
var _B = bB;
function wB(e7, t) {
...
var SB = wB, OB = I_, xB = Wd, AB = $e, PB = Vd, TB = qd, IB = Iu;
function EB(e7, t, r) {
  t = OB(t, e7);
  ...
  return a || ++n != i ? a : (i = e7 == null ? 0 : e7.length, !!i && TB(i) && PB(o, i) && (AB(e7) || xB(e7)));
}
var $B = EB, MB = SB, DB = $B;
function NB(e7, t) {
  return e7 != null && DB(e7, t, MB);
}
var CB = NB, jB = Gd, BB = E_, RB = CB, kB = Pd, LB = _w, FB = ww, UB = Iu, zB = 1, WB = 2;
function VB(e7, t) {
  return kB(e7) && LB(t) ? FB(UB(e7), t) : function(r) {
    var n = BB(r, e7);
    return n === void 0 && n === t ? RB(r, e7) : jB(t, n, zB | WB);
  };
}
var qB = VB;
function GB(e7) {
...
var JB = XB, QB = KB, ZB = JB, t2 = Pd, e22 = Iu;
function r2(e7) {
  return t2(e7) ? QB(e22(e7)) : ZB(e7);
}
var n2 = r2, i2 = _B, a2 = qB, o2 = wa, s2 = $e, c2 = n2;
function u2(e7) {
  return typeof e7 == "function" ? e7 : e7 == null ? o2 : typeof e7 == "object" ? s2(e7) ? a2(e7[0], e7[1]) : i2(e7) : c2(e7);
}
var wn = u2;
function l2(e7, t, r, n) {
...
var p2 = d2, y2 = Sw, m2 = h2, v2 = p2;
function g2(e7, t, r) {
  return t === t ? v2(e7, t, r) : y2(e7, m2, r);
}
var b2 = g2, _2 = b2;
function w2(e7, t) {
  var r = e7 == null ? 0 : e7.length;
  return !!r && _2(e7, t, 0) > -1;
}
var S2 = w2;
function O2(e7, t, r) {
...
var P2 = A2, jl = vw, T2 = P2, I2 = zd, E2 = 1 / 0, $2 = jl && 1 / I2(new jl([, -0]))[1] == E2 ? function(e7) {
  return new jl(e7);
} : T2, M2 = $2, D2 = sw, N2 = S2, C2 = x2, j2 = uw, B2 = M2, R2 = zd, k2 = 200;
function L2(e7, t, r) {
  var n = -1, i = N2, a = e7.length, o = true, s = [], c = s;
  if (r) o = false, i = C2;
  else if (a >= k2) {
    var u = t ? null : B2(e7);
    if (u) return R2(u);
    o = false, i = j2, c = new D2();
  } else c = t ? [] : s;
  t: for (; ++n < a; ) {
...
var F2 = L2, U2 = wn, z2 = F2;
function W2(e7, t) {
  return e7 && e7.length ? z2(e7, U2(t)) : [];
}
var V2 = W2;
const sm = Bt(V2);
function Ow(e7, t, r) {
...
function K2(e7, t, r) {
  return t = Pc(t), Y2(e7, xw() ? Reflect.construct(t, r || [], Pc(e7).constructor) : t.apply(e7, r));
}
function Y2(e7, t) {
...
function J2(e7, t) {
  if (typeof t != "function" && t !== null) throw new TypeError("Super expression must either be null or a function");
  e7.prototype = Object.create(t && t.prototype, { constructor: { value: e7, writable: true, configurable: true } }), Object.defineProperty(e7, "prototype", { writable: false }), t && Uf(e7, t);
}
function Uf(e7, t) {
...
var lm = 1, hn = function(e7) {
  function t() {
    ...
    return r = K2(this, t, [].concat(i)), qu(r, "lastBoundingBox", { width: -1, height: -1 }), r;
  }
  return J2(t, e7), H2(t, [{ key: "componentDidMount", value: function() {
    this.updateBBox();
    ...
    return A.createElement("div", { className: "recharts-legend-wrapper", style: f, ref: function(d) {
      n.wrapperNode = d;
    } }, rR(a, Mr(Mr({}, this.props), {}, { payload: Ow(l, u, eR) })));
...
qu(hn, "displayName", "Legend");
qu(hn, "defaultProps", { iconSize: 14, layout: "horizontal", align: "center", verticalAlign: "bottom" });
var fm = Zo, nR = Wd, iR = $e, hm = fm ? fm.isConcatSpreadable : void 0;
function aR(e7) {
  return iR(e7) || nR(e7) || !!(hm && e7 && e7[hm]);
}
var oR = aR, sR = fw, cR = oR;
function Pw(e7, t, r, n, i) {
  var a = -1, o = e7.length;
  for (r || (r = cR), i || (i = []); ++a < o; ) {
    var s = e7[a];
    t > 0 && r(s) ? t > 1 ? Pw(s, t - 1, r, n, i) : sR(i, s) : n || (i[i.length] = s);
  }
  return i;
}
var Tw = Pw;
...
var lR = uR, fR = lR, hR = fR(), dR = hR, pR = dR, yR = Vu;
function mR(e7, t) {
  return e7 && pR(e7, t, yR);
}
var Iw = mR, vR = ts;
function gR(e7, t) {
  return function(r, n) {
    if (r == null) return r;
    if (!vR(r)) return e7(r, n);
    for (var i = r.length, a = t ? i : -1, o = Object(r); (t ? a-- : ++a < i) && n(o[a], a, o) !== false; ) ;
    return r;
  };
}
var bR = gR, _R = Iw, wR = bR, SR = wR(_R), Hd = SR, OR = Hd, xR = ts;
function AR(e7, t) {
  var r = -1, n = xR(e7) ? Array(e7.length) : [];
  return OR(e7, function(i, a, o) {
    n[++r] = t(i, a, o);
  }), n;
}
var Ew = AR;
...
var DR = MR, Bl = Dd, NR = Nd, CR = wn, jR = Ew, BR = TR, RR = pw, kR = DR, LR = wa, FR = $e;
function UR(e7, t, r) {
  t.length ? t = Bl(t, function(a) {
    return FR(a) ? function(o) {
      return NR(o, a.length === 1 ? a[0] : a);
    } : a;
  }) : t = [LR];
  var n = -1;
  t = Bl(t, RR(CR));
  var i = jR(e7, function(a, o, s) {
    var c = Bl(t, function(u) {
      return u(a);
    });
...
var YR = KR, XR = ti, JR = function() {
  try {
    var e7 = XR(Object, "defineProperty");
    return e7({}, "", {}), e7;
  } catch {
  }
}(), $w = JR, QR = YR, ym = $w, ZR = wa, tk = ym ? function(e7, t) {
  return ym(e7, "toString", { configurable: true, enumerable: false, value: QR(t), writable: true });
} : ZR, ek = tk, rk = 800, nk = 16, ik = Date.now;
function ak(e7) {
  var t = 0, r = 0;
  return function() {
    var n = ik(), i = nk - (n - r);
...
var ok = ak, sk = ek, ck = ok, uk = ck(sk), lk = uk, fk = wa, hk = HR, dk = lk;
function pk(e7, t) {
  return dk(hk(e7, t, fk), e7 + "");
}
var yk = pk, mk = Id, vk = ts, gk = Vd, bk = _n;
function _k(e7, t, r) {
  if (!bk(r)) return false;
  var n = typeof t;
  return (n == "number" ? vk(r) && gk(t, r.length) : n == "string" && t in r) ? mk(r[t], e7) : false;
}
var Gu = _k, wk = Tw, Sk = zR, Ok = yk, mm = Gu, xk = Ok(function(e7, t) {
  if (e7 == null) return [];
  var r = t.length;
  return r > 1 && mm(e7, t[0], t[1]) ? t = [] : r > 2 && mm(t[0], t[1], t[2]) && (t = [t[0]]), Sk(e7, wk(t, 1), []);
}), Ak = xk;
const Kd = Bt(Ak);
function ho(e7) {
  "@babel/helpers - typeof";
...
function Pk(e7, t) {
  return $k(e7) || Ek(e7, t) || Ik(e7, t) || Tk();
}
function Tk() {
...
function Mk(e7, t, r) {
  return t = Dk(t), t in e7 ? Object.defineProperty(e7, t, { value: r, enumerable: true, configurable: true, writable: true }) : e7[t] = r, e7;
}
function Dk(e7) {
  var t = Nk(e7, "string");
  ...
  var r = t.separator, n = r === void 0 ? " : " : r, i = t.contentStyle, a = i === void 0 ? {} : i, o = t.itemStyle, s = o === void 0 ? {} : o, c = t.labelStyle, u = c === void 0 ? {} : c, l = t.payload, f = t.formatter, h = t.itemSorter, d = t.wrapperClassName, y = t.labelClassName, m = t.label, p = t.labelFormatter, b = t.accessibilityLayer, _ = b === void 0 ? false : b, S = function() {
    if (l && l.length) {
      var I = { padding: 0, margin: 0 }, j = (h ? Kd(l, h) : l).map(function(N, M) {
        ...
        var C = Rl({ display: "block", paddingTop: 4, paddingBottom: 4, color: N.color || "#000" }, s), R = N.formatter || f || Ck, F = N.value, U = N.name, q = F, rt = U;
        if (R && q != null && rt != null) {
          var W = R(F, U, N, M, l);
          if (Array.isArray(W)) {
            var it = Pk(W, 2);
    ...
    return null;
  }, w = Rl({ margin: 0, padding: 10, backgroundColor: "#fff", border: "1px solid #ccc", whiteSpace: "nowrap" }, a), v = Rl({ margin: 0 }, u), g = !st(m), O = g ? m : "", P = mt("recharts-default-tooltip", d), T = mt("recharts-tooltip-label", y);
  g && p && l !== void 0 && l !== null && (O = p(m, l));
  var $ = _ ? { role: "status", "aria-live": "assertive" } : {};
  return A.createElement("div", zf({ className: P, style: w }, $), A.createElement("p", { className: T, style: v }, A.isValidElement(O) ? O : "".concat(O)), S());
};
function po(e7) {
  "@babel/helpers - typeof";
...
var $a = "recharts-tooltip-wrapper", kk = { visibility: "hidden" };
function Lk(e7) {
...
function Uk(e7) {
  ...
  return o.height > 0 && o.width > 0 && r ? (l = bm({ allowEscapeViewBox: t, coordinate: r, key: "x", offsetTopLeft: n, position: i, reverseDirection: a, tooltipDimension: o.width, viewBox: c, viewBoxDimension: c.width }), f = bm({ allowEscapeViewBox: t, coordinate: r, key: "y", offsetTopLeft: n, position: i, reverseDirection: a, tooltipDimension: o.height, viewBox: c, viewBoxDimension: c.height }), u = Fk({ translateX: l, translateY: f, useTranslate3d: s })) : u = kk, { cssProperties: u, cssClasses: Lk({ translateX: l, translateY: f, coordinate: r }) };
}
function zi(e7) {
  "@babel/helpers - typeof";
...
function qk(e7, t, r) {
  return t = Tc(t), Gk(e7, Mw() ? Reflect.construct(t, r || [], Tc(e7).constructor) : t.apply(e7, r));
}
function Gk(e7, t) {
...
var Sm = 1, Xk = function(e7) {
  function t() {
    var r;
    zk(this, t);
    for (var n = arguments.length, i = new Array(n), a = 0; a < n; a++) i[a] = arguments[a];
    return r = qk(this, t, [].concat(i)), Vf(r, "state", { dismissed: false, dismissedAtCoordinate: { x: 0, y: 0 }, lastBoundingBox: { width: -1, height: -1 } }), Vf(r, "handleKeyDown", function(o) {
      if (o.key === "Escape") {
        var s, c, u, l;
  ...
  return Kk(t, e7), Vk(t, [{ key: "updateBBox", value: function() {
    if (this.wrapperNode && this.wrapperNode.getBoundingClientRect) {
      var n = this.wrapperNode.getBoundingClientRect();
    ...
    var n = this, i = this.props, a = i.active, o = i.allowEscapeViewBox, s = i.animationDuration, c = i.animationEasing, u = i.children, l = i.coordinate, f = i.hasPayload, h = i.isAnimationActive, d = i.offset, y = i.position, m = i.reverseDirection, p = i.useTranslate3d, b = i.viewBox, _ = i.wrapperStyle, S = Uk({ allowEscapeViewBox: o, coordinate: l, offsetTopLeft: d, position: y, reverseDirection: m, tooltipBox: this.state.lastBoundingBox, useTranslate3d: p, viewBox: b }), w = S.cssClasses, v = S.cssProperties, g = wm(wm({ transition: h && a ? "transform ".concat(s, "ms ").concat(c) : void 0 }, v), {}, { pointerEvents: "none", visibility: !this.state.dismissed && a && f ? "visible" : "hidden", position: "absolute", top: 0, left: 0 }, _);
    return A.createElement("div", { tabIndex: -1, className: w, style: g, ref: function(P) {
      n.wrapperNode = P;
    } }, u);
  } }]);
}(B.PureComponent), Jk = function() {
...
function eL(e7, t, r) {
  return t = Ic(t), rL(e7, Nw() ? Reflect.construct(t, r || [], Ic(e7).constructor) : t.apply(e7, r));
}
function rL(e7, t) {
...
function sL(e7, t) {
  return A.isValidElement(e7) ? A.cloneElement(e7, t) : typeof e7 == "function" ? A.createElement(e7, t) : A.createElement(jk, t);
}
var nr = function(e7) {
  function t() {
    return Qk(this, t), eL(this, t, arguments);
  }
  return iL(t, e7), tL(t, [{ key: "render", value: function() {
    ...
    var g = v.length > 0;
    return A.createElement(Xk, { allowEscapeViewBox: o, animationDuration: s, animationEasing: c, isAnimationActive: h, active: a, coordinate: l, hasPayload: g, offset: d, position: p, reverseDirection: b, useTranslate3d: _, viewBox: S, wrapperStyle: w }, sL(u, xm(xm({}, this.props), {}, { payload: v })));
  } }]);
}(B.PureComponent);
...
var cL = $r, uL = function() {
  return cL.Date.now();
}, lL = uL, fL = /\s/;
function hL(e7) {
  for (var t = e7.length; t-- && fL.test(e7.charAt(t)); ) ;
  return t;
}
var dL = hL, pL = dL, yL = /^\s+/;
function mL(e7) {
  return e7 && e7.slice(0, pL(e7) + 1).replace(yL, "");
}
var vL = mL, gL = vL, Am = _n, bL = da, Pm = NaN, _L = /^[-+]0x[0-9a-f]+$/i, wL = /^0b[01]+$/i, SL = /^0o[0-7]+$/i, OL = parseInt;
function xL(e7) {
  ...
  e7 = gL(e7);
  var r = wL.test(e7);
  return r || SL.test(e7) ? OL(e7.slice(2), r ? 2 : 8) : _L.test(e7) ? Pm : +e7;
}
var jw = xL, AL = _n, kl = lL, Tm = jw, PL = "Expected a function", TL = Math.max, IL = Math.min;
function EL(e7, t, r) {
  var n, i, a, o, s, c, u = 0, l = false, f = false, h = true;
  if (typeof e7 != "function") throw new TypeError(PL);
  t = Tm(t) || 0, AL(r) && (l = !!r.leading, f = "maxWait" in r, a = f ? TL(Tm(r.maxWait) || 0, t) : a, h = "trailing" in r ? !!r.trailing : h);
  function d(g) {
    var O = n, P = i;
...
var $L = EL, ML = $L, DL = _n, NL = "Expected a function";
function CL(e7, t, r) {
  var n = true, i = true;
  if (typeof e7 != "function") throw new TypeError(NL);
  return DL(r) && (n = "leading" in r ? !!r.leading : n, i = "trailing" in r ? !!r.trailing : i), ML(e7, t, { leading: n, maxWait: t, trailing: i });
}
var jL = CL;
const Bw = Bt(jL);
function yo(e7) {
...
function BL(e7, t, r) {
  return t = RL(t), t in e7 ? Object.defineProperty(e7, t, { value: r, enumerable: true, configurable: true, writable: true }) : e7[t] = r, e7;
}
function RL(e7) {
  var t = kL(e7, "string");
...
function LL(e7, t) {
  return WL(e7) || zL(e7, t) || UL(e7, t) || FL();
}
function FL() {
  throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
var $m = B.forwardRef(function(e7, t) {
  ...
  var O = B.useState({ containerWidth: i.width, containerHeight: i.height }), P = LL(O, 2), T = P[0], $ = P[1], E = B.useCallback(function(j, N) {
    $(function(M) {
...
function VL(e7, t, r) {
  return t = qL(t), t in e7 ? Object.defineProperty(e7, t, { value: r, enumerable: true, configurable: true, writable: true }) : e7[t] = r, e7;
}
function qL(e7) {
  var t = GL(e7, "string");
...
var si = { widthCache: {}, cacheCount: 0 }, HL = 2e3, KL = { position: "absolute", top: "-20000px", left: 0, padding: 0, margin: 0, border: "none", whiteSpace: "pre" }, Dm = "recharts_measurement_span";
function YL(e7) {
  var t = Gf({}, e7);
...
var Xa = function(t) {
  ...
  var n = YL(r), i = JSON.stringify({ text: t, copyStyle: n });
  ...
  try {
    ...
    return si.widthCache[i] = c, ++si.cacheCount > HL && (si.cacheCount = 0, si.widthCache = {}), c;
  } catch {
...
function Ec(e7, t) {
  return tF(e7) || ZL(e7, t) || QL(e7, t) || JL();
}
function JL() {
  throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
function Cm(e7, t) {
  for (var r = 0; r < t.length; r++) {
    var n = t[r];
    n.enumerable = n.enumerable || false, n.configurable = true, "value" in n && (n.writable = true), Object.defineProperty(e7, nF(n.key), n);
  }
}
function rF(e7, t, r) {
...
var jm = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([*/])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, Bm = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([+-])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, aF = /^px|cm|vh|vw|em|rem|%|mm|in|pt|pc|ex|ch|vmin|vmax|Q$/, oF = /(-?\d+(?:\.\d+)?)([a-zA-Z%]+)?/, Rw = { cm: 96 / 2.54, mm: 96 / 25.4, pt: 96 / 72, pc: 96 / 6, in: 96, Q: 96 / (2.54 * 40), px: 1 }, sF = Object.keys(Rw), Oi = "NaN";
function cF(e7, t) {
  return e7 * Rw[t];
}
var ps = function() {
  function e7(t, r) {
    eF(this, e7), this.num = t, this.unit = r, this.num = t, this.unit = r, Number.isNaN(t) && (this.unit = ""), r !== "" && !aF.test(r) && (this.num = NaN, this.unit = ""), sF.includes(r) && (this.num = cF(t, r), this.unit = "px");
  }
  return rF(e7, [{ key: "add", value: function(r) {
    ...
    var n, i = (n = oF.exec(r)) !== null && n !== void 0 ? n : [], a = Ec(i, 3), o = a[1], s = a[2];
...
function kw(e7) {
  ...
  for (; t.includes("+") || /.-\d+(?:\.\d+)?/.test(t); ) {
    var f, h = (f = Bm.exec(t)) !== null && f !== void 0 ? f : [], d = Ec(h, 4), y = d[1], m = d[2], p = d[3], b = ps.parse(y ?? ""), _ = ps.parse(p ?? ""), S = m === "+" ? b.add(_) : b.subtract(_);
    if (S.isNaN()) return Oi;
    t = t.replace(Bm, S.toString());
  }
  return t;
}
var Rm = /\(([^()]*)\)/;
...
function Ll(e7) {
  var t = fF(e7.slice(5, -1));
  return t === Oi ? "" : t;
}
var hF = ["x", "y", "lineHeight", "capHeight", "scaleToFit", "textAnchor", "verticalAnchor", "fill"], dF = ["dx", "dy", "angle", "className", "breakAll"];
function Hf() {
  return Hf = Object.assign ? Object.assign.bind() : function(e7) {
    for (var t = 1; t < arguments.length; t++) {
      var r = arguments[t];
      for (var n in r) Object.prototype.hasOwnProperty.call(r, n) && (e7[n] = r[n]);
    }
...
function Lm(e7, t) {
  return gF(e7) || vF(e7, t) || mF(e7, t) || yF();
}
function yF() {
  throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
var Lw = /[ \f\n\r\t\v\u2028\u2029]+/, Fw = function(t) {
  ...
  for (var m = "\u2026", p = function(M) {
    ...
    var v = Math.floor((b + _) / 2), g = v - 1, O = p(g), P = Lm(O, 2), T = P[0], $ = P[1], E = p(v), I = Lm(E, 1), j = I[0];
  ...
  if ((r || n) && !Sn.isSsr) {
    ...
    return bF({ breakAll: o, children: i, maxLines: s, style: a }, c, u, r, n);
  }
  return Um(i);
}, zm = "#808080", $c = function(t) {
  var r = t.x, n = r === void 0 ? 0 : r, i = t.y, a = i === void 0 ? 0 : i, o = t.lineHeight, s = o === void 0 ? "1em" : o, c = t.capHeight, u = c === void 0 ? "0.71em" : c, l = t.scaleToFit, f = l === void 0 ? false : l, h = t.textAnchor, d = h === void 0 ? "start" : h, y = t.verticalAnchor, m = y === void 0 ? "end" : y, p = t.fill, b = p === void 0 ? zm : p, _ = km(t, hF), S = B.useMemo(function() {
    return _F({ breakAll: _.breakAll, children: _.children, maxLines: _.maxLines, scaleToFit: f, style: _.style, width: _.width });
  }, [_.breakAll, _.children, _.maxLines, f, _.style, _.width]), w = _.dx, v = _.dy, g = _.angle, O = _.className, P = _.breakAll, T = km(_, dF);
  ...
  switch (m) {
    case "start":
      ...
      break;
    case "middle":
      I = Ll("calc(".concat((S.length - 1) / 2, " * -").concat(s, " + (").concat(u, " / 2))"));
      break;
    default:
      I = Ll("calc(".concat(S.length - 1, " * -").concat(s, ")"));
      break;
  }
  var j = [];
  if (f) {
  ...
  return g && j.push("rotate(".concat(g, ", ").concat($, ", ").concat(E, ")")), j.length && (T.transform = j.join(" ")), A.createElement("text", Hf({}, ct(T, true), { x: $, y: E, className: mt("recharts-text", O), textAnchor: d, fill: b.includes("url") ? zm : b }), S.map(function(C, R) {
...
function Jd(e7) {
  let t, r, n;
  e7.length !== 2 ? (t = dn, r = (s, c) => dn(e7(s), c), n = (s, c) => e7(s) - c) : (t = e7 === dn || e7 === wF ? e7 : SF, r = e7, n = e7);
...
class Wm extends Map {
  ...
  set(t, r) {
    return super.set(AF(this, t), r);
  }
  delete(t) {
    return super.delete(PF(this, t));
  }
}
...
function PF({ _intern: e7, _key: t }, r) {
  const n = t(r);
...
const EF = Math.sqrt(50), $F = Math.sqrt(10), MF = Math.sqrt(2);
function Mc(e7, t, r) {
  const n = (t - e7) / Math.max(0, r), i = Math.floor(Math.log10(n)), a = n / Math.pow(10, i), o = a >= EF ? 10 : a >= $F ? 5 : a >= MF ? 2 : 1;
  let s, c, u;
...
function Xf(e7, t, r) {
  t = +t, e7 = +e7, r = +r;
  const n = t < e7, i = n ? Yf(t, e7, r) : Yf(e7, t, r);
...
function DF(e7, t, r) {
  if (e7 = Float64Array.from(OF(e7)), !(!(n = e7.length) || isNaN(t = +t))) {
...
const Jf = Symbol("implicit");
function Qd() {
  var e7 = new Wm(), t = [], r = [], n = Jf;
  function i(a) {
    let o = e7.get(a);
    if (o === void 0) {
      if (n !== Jf) return n;
...
var bo = 0.7, Dc = 1 / bo, Mi = "\\s*([+-]?\\d+)\\s*", _o = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", Or = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", jF = /^#([0-9a-f]{3,8})$/, BF = new RegExp(`^rgb\\(${Mi},${Mi},${Mi}\\)$`), RF = new RegExp(`^rgb\\(${Or},${Or},${Or}\\)$`), kF = new RegExp(`^rgba\\(${Mi},${Mi},${Mi},${_o}\\)$`), LF = new RegExp(`^rgba\\(${Or},${Or},${Or},${_o}\\)$`), FF = new RegExp(`^hsl\\(${_o},${Or},${Or}\\)$`), UF = new RegExp(`^hsla\\(${_o},${Or},${Or},${_o}\\)$`), Hm = { aliceblue: 15792383, antiquewhite: 16444375, aqua: 65535, aquamarine: 8388564, azure: 15794175, beige: 16119260, bisque: 16770244, black: 0, blanchedalmond: 16772045, blue: 255, blueviolet: 9055202, brown: 10824234, burlywood: 14596231, cadetblue: 6266528, chartreuse: 8388352, chocolate: 13789470, coral: 16744272, cornflowerblue: 6591981, cornsilk: 16775388, crimson: 14423100, cyan: 65535, darkblue: 139, darkcyan: 35723, darkgoldenrod: 12092939, darkgray: 11119017, darkgreen: 25600, darkgrey: 11119017, darkkhaki: 12433259, darkmagenta: 9109643, darkolivegreen: 5597999, darkorange: 16747520, darkorchid: 10040012, darkred: 9109504, darksalmon: 15308410, darkseagreen: 9419919, darkslateblue: 4734347, darkslategray: 3100495, darkslategrey: 3100495, darkturquoise: 52945, darkviolet: 9699539, deeppink: 16716947, deepskyblue: 49151, dimgray: 6908265, dimgrey: 6908265, dodgerblue: 2003199, firebrick: 11674146, floralwhite: 16775920, forestgreen: 2263842, fuchsia: 16711935, gainsboro: 14474460, ghostwhite: 16316671, gold: 16766720, goldenrod: 14329120, gray: 8421504, green: 32768, greenyellow: 11403055, grey: 8421504, honeydew: 15794160, hotpink: 16738740, indianred: 13458524, indigo: 4915330, ivory: 16777200, khaki: 15787660, lavender: 15132410, lavenderblush: 16773365, lawngreen: 8190976, lemonchiffon: 16775885, lightblue: 11393254, lightcoral: 15761536, lightcyan: 14745599, lightgoldenrodyellow: 16448210, lightgray: 13882323, lightgreen: 9498256, lightgrey: 13882323, lightpink: 16758465, lightsalmon: 16752762, lightseagreen: 2142890, lightskyblue: 8900346, lightslategray: 7833753, lightslategrey: 7833753, lightsteelblue: 11584734, lightyellow: 16777184, lime: 65280, limegreen: 3329330, linen: 16445670, magenta: 16711935, maroon: 8388608, mediumaquamarine: 6737322, mediumblue: 205, mediumorchid: 12211667, mediumpurple: 9662683, mediumseagreen: 3978097, mediumslateblue: 8087790, mediumspringgreen: 64154, mediumturquoise: 4772300, mediumvioletred: 13047173, midnightblue: 1644912, mintcream: 16121850, mistyrose: 16770273, moccasin: 16770229, navajowhite: 16768685, navy: 128, oldlace: 16643558, olive: 8421376, olivedrab: 7048739, orange: 16753920, orangered: 16729344, orchid: 14315734, palegoldenrod: 15657130, palegreen: 10025880, paleturquoise: 11529966, palevioletred: 14381203, papayawhip: 16773077, peachpuff: 16767673, peru: 13468991, pink: 16761035, plum: 14524637, powderblue: 11591910, purple: 8388736, rebeccapurple: 6697881, red: 16711680, rosybrown: 12357519, royalblue: 4286945, saddlebrown: 9127187, salmon: 16416882, sandybrown: 16032864, seagreen: 3050327, seashell: 16774638, sienna: 10506797, silver: 12632256, skyblue: 8900331, slateblue: 6970061, slategray: 7372944, slategrey: 7372944, snow: 16775930, springgreen: 65407, steelblue: 4620980, tan: 13808780, teal: 32896, thistle: 14204888, tomato: 16737095, turquoise: 4251856, violet: 15631086, wheat: 16113331, white: 16777215, whitesmoke: 16119285, yellow: 16776960, yellowgreen: 10145074 };
Zd(rs, wo, { copy(e7) {
  return Object.assign(new this.constructor(), this, e7);
}, displayable() {
  return this.rgb().displayable();
}, hex: Km, formatHex: Km, formatHex8: zF, formatHsl: WF, formatRgb: Ym, toString: Ym });
function Km() {
...
function wo(e7) {
  var t, r;
  return e7 = (e7 + "").trim().toLowerCase(), (t = jF.exec(e7)) ? (r = t[1].length, t = parseInt(t[1], 16), r === 6 ? Xm(t) : r === 3 ? new Pe(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, (t & 15) << 4 | t & 15, 1) : r === 8 ? ys(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (t & 255) / 255) : r === 4 ? ys(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, ((t & 15) << 4 | t & 15) / 255) : null) : (t = BF.exec(e7)) ? new Pe(t[1], t[2], t[3], 1) : (t = RF.exec(e7)) ? new Pe(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, 1) : (t = kF.exec(e7)) ? ys(t[1], t[2], t[3], t[4]) : (t = LF.exec(e7)) ? ys(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, t[4]) : (t = FF.exec(e7)) ? Zm(t[1], t[2] / 100, t[3] / 100, 1) : (t = UF.exec(e7)) ? Zm(t[1], t[2] / 100, t[3] / 100, t[4]) : Hm.hasOwnProperty(e7) ? Xm(Hm[e7]) : e7 === "transparent" ? new Pe(NaN, NaN, NaN, 0) : null;
}
function Xm(e7) {
...
function Qf(e7, t, r, n) {
  return arguments.length === 1 ? VF(e7) : new Pe(e7, t, r, n ?? 1);
}
function Pe(e7, t, r, n) {
  this.r = +e7, this.g = +t, this.b = +r, this.opacity = +n;
}
Zd(Pe, Qf, qw(rs, { brighter(e7) {
...
}, hex: Jm, formatHex: Jm, formatHex8: qF, formatRgb: Qm, toString: Qm }));
function Jm() {
...
Zd(or, GF, qw(rs, { brighter(e7) {
  ...
  return new Pe(Fl(e7 >= 240 ? e7 - 240 : e7 + 120, i, n), Fl(e7, i, n), Fl(e7 < 120 ? e7 + 240 : e7 - 120, i, n), this.opacity);
}, clamp() {
...
function YF(e7) {
  return (e7 = +e7) == 1 ? Hw : function(t, r) {
    return r - t ? KF(t, r, e7) : tp(isNaN(t) ? r : t);
  };
}
function Hw(e7, t) {
  var r = t - e7;
  return r ? HF(e7, r) : tp(isNaN(e7) ? t : e7);
}
const ev = function e3(t) {
  var r = YF(t);
  function n(i, a) {
    var o = r((i = Qf(i)).r, (a = Qf(a)).r), s = r(i.g, a.g), c = r(i.b, a.b), u = Hw(i.opacity, a.opacity);
    return function(l) {
...
var Zf = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, Ul = new RegExp(Zf.source, "g");
function eU(e7) {
  return function() {
    return e7;
  };
...
function nU(e7, t) {
  var r = Zf.lastIndex = Ul.lastIndex = 0, n, i, a, o = -1, s = [], c = [];
  for (e7 = e7 + "", t = t + ""; (n = Zf.exec(e7)) && (i = Ul.exec(t)); ) (a = i.index) > r && (a = t.slice(r, a), s[o] ? s[o] += a : s[++o] = a), (n = n[0]) === (i = i[0]) ? s[o] ? s[o] += i : s[++o] = i : (s[++o] = null, c.push({ i: o, x: Cc(n, i) })), r = Ul.lastIndex;
  return r < t.length && (a = t.slice(r), s[o] ? s[o] += a : s[++o] = a), s.length < 2 ? c[0] ? rU(c[0].x) : eU(t) : (t = c.length, function(u) {
...
function Sa(e7, t) {
  var r = typeof t, n;
  return t == null || r === "boolean" ? tp(t) : (r === "number" ? Cc : r === "string" ? (n = wo(t)) ? (t = n, ev) : nU : t instanceof wo ? ev : t instanceof Date ? ZF : JF(t) ? XF : Array.isArray(t) ? QF : typeof t.valueOf != "function" && typeof t.toString != "function" || isNaN(t) ? tU : Cc)(e7, t);
}
function ep(e7, t) {
  return e7 = +e7, t = +t, function(r) {
...
function sU(e7, t, r) {
  ...
  return i < n ? (n = th(i, n), a = r(o, a)) : (n = th(n, i), a = r(a, o)), function(s) {
    return a(n(s));
  };
}
function cU(e7, t, r) {
  var n = Math.min(e7.length, t.length) - 1, i = new Array(n), a = new Array(n), o = -1;
  for (e7[n] < e7[0] && (e7 = e7.slice().reverse(), t = t.slice().reverse()); ++o < n; ) i[o] = th(e7[o], e7[o + 1]), a[o] = r(t[o], t[o + 1]);
  return function(s) {
    var c = es(e7, s, 1, n) - 1;
    return a[c](i[c](s));
  };
...
function Hu() {
  ...
  function l() {
    ...
    return o !== be && (o = oU(e7[0], e7[h - 1])), s = h > 2 ? cU : sU, c = u = null, f;
  }
  function f(h) {
...
var hU = /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
function So(e7) {
  if (!(t = hU.exec(e7))) throw new Error("invalid format: " + e7);
  var t;
...
const iv = { "%": (e7, t) => (e7 * 100).toFixed(t), b: (e7) => Math.round(e7).toString(2), c: (e7) => e7 + "", d: uU, e: (e7, t) => e7.toExponential(t), f: (e7, t) => e7.toFixed(t), g: (e7, t) => e7.toPrecision(t), o: (e7) => Math.round(e7).toString(8), p: (e7, t) => nv(e7 * 100, t), r: nv, s: pU, X: (e7) => Math.round(e7).toString(16).toUpperCase(), x: (e7) => Math.round(e7).toString(16) };
function av(e7) {
  return e7;
}
var ov = Array.prototype.map, sv = ["y", "z", "a", "f", "p", "n", "\xB5", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
function yU(e7) {
  var t = e7.grouping === void 0 || e7.thousands === void 0 ? av : lU(ov.call(e7.grouping, Number), e7.thousands + ""), r = e7.currency === void 0 ? "" : e7.currency[0] + "", n = e7.currency === void 0 ? "" : e7.currency[1] + "", i = e7.decimal === void 0 ? "." : e7.decimal + "", a = e7.numerals === void 0 ? av : fU(ov.call(e7.numerals, String)), o = e7.percent === void 0 ? "%" : e7.percent + "", s = e7.minus === void 0 ? "\u2212" : e7.minus + "", c = e7.nan === void 0 ? "NaN" : e7.nan + "";
  function u(f, h) {
    f = So(f);
    var d = f.fill, y = f.align, m = f.sign, p = f.symbol, b = f.zero, _ = f.width, S = f.comma, w = f.precision, v = f.trim, g = f.type;
    g === "n" ? (S = true, g = "g") : iv[g] || (w === void 0 && (w = 12), v = true, g = "g"), (b || d === "0" && y === "=") && (b = true, d = "0", y = "=");
    var O = (h && h.prefix !== void 0 ? h.prefix : "") + (p === "$" ? r : p === "#" && /[boxX]/.test(g) ? "0" + g.toLowerCase() : ""), P = (p === "$" ? n : /[%p]/.test(g) ? o : "") + (h && h.suffix !== void 0 ? h.suffix : ""), T = iv[g], $ = /[defgprs%]/.test(g);
    ...
    function E(I) {
      ...
      if (g === "c") N = T(I) + N, I = "";
        ...
        I = +I;
        var F = I < 0 || 1 / I < 0;
        if (I = isNaN(I) ? c : T(Math.abs(I), w), v && (I = dU(I)), F && +I == 0 && m !== "+" && (F = false), j = (F ? m === "(" ? m : s : m === "-" || m === "(" ? "" : m) + j, N = (g === "s" && !isNaN(I) && Rc !== void 0 ? sv[8 + Rc / 3] : "") + N + (F && m === "(" ? ")" : ""), $) {
...
var vs, ip, Kw;
mU({ thousands: ",", grouping: [3], currency: ["$", ""] });
function mU(e7) {
  return vs = yU(e7), ip = vs.format, Kw = vs.formatPrefix, vs;
}
function vU(e7) {
...
function Yw(e7, t, r, n) {
  ...
  switch (n = So(n ?? ",f"), n.type) {
    case "s": {
      ...
      return n.precision == null && !isNaN(a = gU(i, o)) && (n.precision = a), Kw(n, o);
    }
    case "":
    case "e":
    case "g":
    case "p":
    case "r": {
      n.precision == null && !isNaN(a = bU(i, Math.max(Math.abs(e7), Math.abs(t)))) && (n.precision = a - (n.type === "e"));
      break;
    }
    case "f":
    case "%": {
      n.precision == null && !isNaN(a = vU(i)) && (n.precision = a - (n.type === "%") * 2);
      break;
    }
  }
  return ip(n);
...
function On(e7) {
  ...
  return e7.ticks = function(r) {
    var n = t();
    return Kf(n[0], n[n.length - 1], r ?? 10);
    ...
    for (s < o && (u = o, o = s, s = u, u = i, i = a, a = u); l-- > 0; ) {
      if (u = Yf(o, s, r), u === c) return n[i] = o, n[a] = s, t(n);
...
function ap(e7) {
  ...
  let n = 10, i, a;
  function o() {
    return i = xU(n), a = OU(n), r()[0] < 0 ? (i = lv(i), a = lv(a), e7(_U, wU)) : e7(cv, uv), t;
  }
  return t.base = function(s) {
    ...
    if (!(n % 1) && d - h < p) {
      ...
      b.length * 2 < p && (b = Kf(u, l, p));
    } else b = Kf(h, d, Math.min(d - h, p)).map(a);
...
function sp(e7) {
  var t = e7(be, be), r = 1;
  function n() {
    return r === 1 ? e7(be, be) : r === 0.5 ? e7(AU, PU) : e7(dv(r), dv(1 / r));
  }
...
function eS() {
  ...
  function i() {
    ...
    for (r = new Array(s - 1); ++o < s; ) r[o - 1] = NF(e7, o / s);
    return a;
  }
  function a(o) {
...
const zl = /* @__PURE__ */ new Date(), Wl = /* @__PURE__ */ new Date();
function oe(e7, t, r, n) {
  ...
  }), r && (i.count = (a, o) => (zl.setTime(+a), Wl.setTime(+o), e7(zl), e7(Wl), Math.floor(r(zl, Wl))), i.every = (a) => (a = Math.floor(a), !isFinite(a) || !(a > 0) ? null : a > 1 ? i.filter(n ? (o) => n(o) % a === 0 : (o) => i.count(0, o) % a === 0) : i)), i;
}
const Lc = oe(() => {
}, (e7, t) => {
  e7.setTime(+e7 + t);
...
Lc.range;
const kr = 1e3, He = kr * 60, Lr = He * 60, Vr = Lr * 24, up = Vr * 7, yv = Vr * 30, Vl = Vr * 365, Rn = oe((e7) => {
...
const Yu = ri(0), Fc = ri(1), EU = ri(2), $U = ri(3), qi = ri(4), MU = ri(5), DU = ri(6);
Yu.range;
Fc.range;
EU.range;
$U.range;
...
const Xu = ni(0), Uc = ni(1), NU = ni(2), CU = ni(3), Gi = ni(4), jU = ni(5), BU = ni(6);
Xu.range;
Uc.range;
NU.range;
CU.range;
...
function aS(e7, t, r, n, i, a) {
  const o = [[Rn, 1, kr], [Rn, 5, 5 * kr], [Rn, 15, 15 * kr], [Rn, 30, 30 * kr], [a, 1, He], [a, 5, 5 * He], [a, 15, 15 * He], [a, 30, 30 * He], [i, 1, Lr], [i, 3, 3 * Lr], [i, 6, 6 * Lr], [i, 12, 12 * Lr], [n, 1, Vr], [n, 2, 2 * Vr], [r, 1, up], [t, 1, yv], [t, 3, 3 * yv], [e7, 1, Vl]];
  function s(u, l, f) {
    const h = l < u;
    h && ([u, l] = [l, u]);
  ...
  function c(u, l, f) {
    ...
    if (d === o.length) return e7.every(Xf(u / Vl, l / Vl, f));
    if (d === 0) return Lc.every(Math.max(Xf(u, l, f), 1));
    const [y, m] = o[h / o[d - 1][2] < o[d][2] / h ? d - 1 : d];
    return y.every(m);
  }
  return [s, c];
}
const [RU, kU] = aS(Gr, yp, Xu, iS, dp, fp), [LU, FU] = aS(qr, pp, Yu, is, hp, lp);
function ql(e7) {
  if (0 <= e7.y && e7.y < 100) {
...
function UU(e7) {
  var t = e7.dateTime, r = e7.date, n = e7.time, i = e7.periods, a = e7.days, o = e7.shortDays, s = e7.months, c = e7.shortMonths, u = Na(i), l = Ca(i), f = Na(a), h = Ca(a), d = Na(o), y = Ca(o), m = Na(s), p = Ca(s), b = Na(c), _ = Ca(c), S = { a: R, A: F, b: U, B: q, c: null, d: wv, e: wv, f: l3, g: _3, G: S3, H: s3, I: c3, j: u3, L: oS, m: f3, M: h3, p: rt, q: W, Q: xv, s: Av, S: d3, u: p3, U: y3, V: m3, w: v3, W: g3, x: null, X: null, y: b3, Y: w3, Z: O3, "%": Ov }, w = { a: it, A: Rt, b: Yt, B: Me, c: null, d: Sv, e: Sv, f: T3, g: R3, G: L3, H: x3, I: A3, j: P3, L: cS, m: I3, M: E3, p: Pn, q: we, Q: xv, s: Av, S: $3, u: M3, U: D3, V: N3, w: C3, W: j3, x: null, X: null, y: B3, Y: k3, Z: F3, "%": Ov }, v = { a: $, A: E, b: I, B: j, c: N, d: bv, e: bv, f: n3, g: gv, G: vv, H: _v, I: _v, j: ZU, L: r3, m: QU, M: t3, p: T, q: JU, Q: a3, s: o3, S: e32, u: GU, U: HU, V: KU, w: qU, W: YU, x: M, X: C, y: gv, Y: vv, Z: XU, "%": i3 };
  ...
  function O(z, ft) {
    return function(ht) {
      ...
      if (ft && !("Z" in k) && (k.Z = 0), "p" in k && (k.H = k.H % 12 + k.p * 12), k.m === void 0 && (k.m = "q" in k ? k.q : 0), "V" in k) {
        ...
        "w" in k || (k.w = 1), "Z" in k ? (bt = Gl(Da(k.y, 0, 1)), Qt = bt.getUTCDay(), bt = Qt > 4 || Qt === 0 ? Uc.ceil(bt) : Uc(bt), bt = Ku.offset(bt, (k.V - 1) * 7), k.y = bt.getUTCFullYear(), k.m = bt.getUTCMonth(), k.d = bt.getUTCDate() + (k.w + 6) % 7) : (bt = ql(Da(k.y, 0, 1)), Qt = bt.getDay(), bt = Qt > 4 || Qt === 0 ? Fc.ceil(bt) : Fc(bt), bt = is.offset(bt, (k.V - 1) * 7), k.y = bt.getFullYear(), k.m = bt.getMonth(), k.d = bt.getDate() + (k.w + 6) % 7);
      } else ("W" in k || "U" in k) && ("w" in k || (k.w = "u" in k ? k.u % 7 : "W" in k ? 1 : 0), Qt = "Z" in k ? Gl(Da(k.y, 0, 1)).getUTCDay() : ql(Da(k.y, 0, 1)).getDay(), k.m = 0, k.d = "W" in k ? (k.w + 6) % 7 + k.W * 7 - (Qt + 5) % 7 : k.w + k.U * 7 - (Qt + 6) % 7);
      return "Z" in k ? (k.H += k.Z / 100 | 0, k.M += k.Z % 100, Gl(k)) : ql(k);
    };
  }
...
function Na(e7) {
  return new RegExp("^(?:" + e7.map(VU).join("|") + ")", "i");
}
function Ca(e7) {
...
function y3(e7, t) {
  return wt(Yu.count(qr(e7) - 1, e7), t, 2);
}
function sS(e7) {
  var t = e7.getDay();
...
function P3(e7, t) {
  return wt(1 + Ku.count(Gr(e7), e7), t, 3);
}
function cS(e7, t) {
...
function D3(e7, t) {
  return wt(Xu.count(Gr(e7) - 1, e7), t, 2);
}
function uS(e7) {
  var t = e7.getUTCDay();
...
var ci, lS, fS;
U3({ dateTime: "%x, %X", date: "%-m/%-d/%Y", time: "%-I:%M:%S %p", periods: ["AM", "PM"], days: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], shortDays: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], months: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], shortMonths: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"] });
function U3(e7) {
  return ci = UU(e7), lS = ci.format, ci.parse, fS = ci.utcFormat, ci.utcParse, ci;
}
function z3(e7) {
  return new Date(e7);
}
...
function mp(e7, t, r, n, i, a, o, s, c, u) {
  var l = rp(), f = l.invert, h = l.domain, d = u(".%L"), y = u(":%S"), m = u("%I:%M"), p = u("%I %p"), b = u("%a %d"), _ = u("%b %d"), S = u("%B"), w = u("%Y");
  function v(g) {
  ...
  return l.invert = function(g) {
    ...
    return arguments.length ? h(Array.from(g, W3)) : h().map(z3);
  }, l.ticks = function(g) {
    var O = h();
    ...
    var O = h();
    return (!g || typeof g.range != "function") && (g = t(O[0], O[O.length - 1], g ?? 10)), g ? h(Jw(O, g)) : l;
  }, l.copy = function() {
    return ns(l, mp(e7, t, r, n, i, a, o, s, c, u));
  }, l;
}
function V3() {
  return tr.apply(mp(LU, FU, qr, pp, Yu, is, hp, lp, Rn, lS).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments);
}
function q3() {
  return tr.apply(mp(RU, kU, Gr, yp, Xu, Ku, dp, fp, Rn, fS).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]), arguments);
}
function Ju() {
...
function yS() {
  ...
  return r.domain = function(n) {
    ...
    return Array.from({ length: n + 1 }, (i, a) => DF(e7, a / n));
  }, r.copy = function() {
...
function Qu() {
  ...
  function y(m) {
    return function(p) {
      var b, _, S;
      return arguments.length ? ([b, _, S] = p, u = iU(m, [b, _, S]), d) : [u(0), u(0.5), u(1)];
    };
  }
...
const Pv = Object.freeze(Object.defineProperty({ __proto__: null, scaleBand: go, scaleDiverging: mS, scaleDivergingLog: vS, scaleDivergingPow: gp, scaleDivergingSqrt: H3, scaleDivergingSymlog: gS, scaleIdentity: Xw, scaleImplicit: Jf, scaleLinear: kc, scaleLog: Qw, scaleOrdinal: Qd, scalePoint: Ja, scalePow: cp, scaleQuantile: eS, scaleQuantize: rS, scaleRadial: tS, scaleSequential: hS, scaleSequentialLog: dS, scaleSequentialPow: vp, scaleSequentialQuantile: yS, scaleSequentialSqrt: G3, scaleSequentialSymlog: pS, scaleSqrt: TU, scaleSymlog: Zw, scaleThreshold: nS, scaleTime: V3, scaleUtc: q3, tickFormat: Yw }, Symbol.toStringTag, { value: "Module" }));
var K3 = da;
function Y3(e7, t, r) {
  for (var n = -1, i = e7.length; ++n < i; ) {
    var a = e7[n], o = t(a);
    if (o != null && (s === void 0 ? o === o && !K3(o) : r(o, s))) var s = o, c = a;
  }
  return c;
}
var bS = Y3;
...
var J3 = X3, Q3 = bS, Z3 = J3, t8 = wa;
function e8(e7) {
  return e7 && e7.length ? Q3(e7, t8, Z3) : void 0;
}
var r8 = e8;
const un = Bt(r8);
function n8(e7, t) {
...
var i8 = n8, a8 = bS, o8 = i8, s8 = wa;
function c8(e7) {
  return e7 && e7.length ? a8(e7, s8, o8) : void 0;
}
var u8 = c8;
const Zu = Bt(u8);
var l8 = Dd, f8 = wn, h8 = Ew, d8 = $e;
function p8(e7, t) {
  var r = d8(e7) ? l8 : h8;
  return r(e7, f8(t));
}
var y8 = p8, m8 = Tw, v8 = y8;
function g8(e7, t) {
  return m8(v8(e7, t), 1);
}
var b8 = g8;
...
var O8 = S8;
const Yn = Bt(O8);
var Oa = 1e9, x8 = { precision: 20, rounding: 4, toExpNeg: -7, toExpPos: 21, LN10: "2.302585092994045684017991454684364207601101488628772976033327900967572609677352480235997205089598298341967784042286" }, _p, Ut = true, Qe = "[DecimalError] ", zn = Qe + "Invalid argument: ", bp = Qe + "Exponent out of range: ", xa = Math.floor, Nn = Math.pow, A8 = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i, Re, se = 1e7, Lt = 7, _S = 9007199254740991, zc = xa(_S / Lt), V = {};
...
V.toExponential = function(e7, t) {
  ...
  return e7 === void 0 ? r = Xn(n, true) : (Er(e7, 0, Oa), t === void 0 ? t = i.rounding : Er(t, 0, 8), n = Nt(new i(n), e7 + 1, t), r = Xn(n, true, e7 + 1)), r;
};
V.toFixed = function(e7, t) {
  var r, n, i = this, a = i.constructor;
  return e7 === void 0 ? Xn(i) : (Er(e7, 0, Oa), t === void 0 ? t = a.rounding : Er(t, 0, 8), n = Nt(new a(i), e7 + Jt(i) + 1, t), r = Xn(n.abs(), false, e7 + Jt(n) + 1), i.isneg() && !i.isZero() ? "-" + r : r);
};
...
V.toPrecision = function(e7, t) {
  var r, n, i = this, a = i.constructor;
  return e7 === void 0 ? (r = Jt(i), n = Xn(i, r <= a.toExpNeg || r >= a.toExpPos)) : (Er(e7, 1, Oa), t === void 0 ? t = a.rounding : Er(t, 0, 8), i = Nt(new a(i), e7, t), r = Jt(i), n = Xn(i, e7 <= r || r <= a.toExpNeg, e7)), n;
};
...
function Oo(e7, t) {
  ...
  if (t == null ? (Ut = false, u = p) : u = t, d.eq(10)) return t == null && (Ut = true), Hl(m, u);
  ...
  } else return c = Hl(m, u + 2, p).times(a + ""), d = Oo(new m(n + "." + r.slice(1)), u - h).plus(c), m.precision = p, t == null ? (Ut = true, Nt(d, p)) : d;
  for (s = o = d = Wr(d.minus(Re), d.plus(Re), u), l = Nt(d.times(d), u), i = 3; ; ) {
    if (o = Nt(o.times(l), u), c = s.plus(Wr(o, new m(i), u)), wr(c.d).slice(0, u) === wr(s.d).slice(0, u)) return s = s.times(2), a !== 0 && (s = s.plus(Hl(m, u + 2, p).times(a + ""))), s = Wr(s, new m(f), u), m.precision = p, t == null ? (Ut = true, Nt(s, p)) : s;
    s = c, i += 2;
  }
}
function Tv(e7, t) {
...
function xS(e7) {
  ...
  function i(a) {
    ...
    if (a.charCodeAt(0) === 45 ? (a = a.slice(1), o.s = -1) : o.s = 1, A8.test(a)) Tv(o, a);
    else throw Error(zn + a);
  }
  if (i.prototype = V, i.ROUND_UP = 0, i.ROUND_DOWN = 1, i.ROUND_CEIL = 2, i.ROUND_FLOOR = 3, i.ROUND_HALF_UP = 4, i.ROUND_HALF_DOWN = 5, i.ROUND_HALF_EVEN = 6, i.ROUND_HALF_CEIL = 7, i.ROUND_HALF_FLOOR = 8, i.clone = xS, i.config = i.set = P8, e7 === void 0 && (e7 = {}), e7) for (n = ["precision", "rounding", "toExpNeg", "toExpPos", "LN10"], t = 0; t < n.length; ) e7.hasOwnProperty(r = n[t++]) || (e7[r] = this[r]);
...
function E8(e7, t) {
  if (e7) {
    if (typeof e7 == "string") return eh(e7, t);
    var r = Object.prototype.toString.call(e7).slice(8, -1);
    if (r === "Object" && e7.constructor && (r = e7.constructor.name), r === "Map" || r === "Set") return Array.from(e7);
    if (r === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)) return eh(e7, t);
  }
}
function $8(e7) {
...
function M8(e7) {
  if (Array.isArray(e7)) return eh(e7);
}
function eh(e7, t) {
  (t == null || t > e7.length) && (t = e7.length);
  for (var r = 0, n = new Array(t); r < t; r++) n[r] = e7[r];
...
var D8 = function(t) {
  ...
  return t === 1 ? r : Ev(function() {
    ...
    return o >= t ? r.apply(void 0, i) : e4(t - o, Ev(function() {
      ...
      return r.apply(void 0, T8(l).concat(c));
    }));
  });
}, tl = function(t) {
  return N8(t.length, t);
}, rh = function(t, r) {
...
var k8 = tl(function(e7, t, r) {
  var n = +e7, i = +t;
  return n + r * (i - n);
}), L8 = tl(function(e7, t, r) {
  var n = t - +e7;
  return n = n || 1 / 0, (r - e7) / n;
}), F8 = tl(function(e7, t, r) {
  var n = t - +e7;
  return n = n || 1 / 0, Math.max(0, Math.min(1, (r - e7) / n));
});
const el = { rangeStep: R8, getDigitCount: B8, interpolateNumber: k8, uninterpolateNumber: L8, uninterpolateTruncation: F8 };
function ih(e7) {
  return W8(e7) || z8(e7) || IS(e7) || U8();
}
function U8() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
function xo(e7, t) {
  return G8(e7) || q8(e7, t) || IS(e7, t) || V8();
}
function V8() {
  throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
function $S(e7, t, r) {
  ...
  var n = el.getDigitCount(e7.toNumber()), i = new Mt(10).pow(n), a = e7.div(i), o = n !== 1 ? 0.05 : 0.1, s = new Mt(Math.ceil(a.div(o).toNumber())).add(r).mul(o), c = s.mul(i);
...
function H8(e7, t, r) {
  ...
  if (!i.isint() && r) {
    var a = Math.abs(e7);
    a < 1 ? (n = new Mt(10).pow(el.getDigitCount(e7) - 1), i = new Mt(Math.floor(i.div(n).toNumber())).mul(n)) : a > 1 && (i = new Mt(Math.floor(e7)));
  } else e7 === 0 ? i = new Mt(Math.floor((t - 1) / 2)) : r || (i = new Mt(Math.floor(e7)));
  var o = Math.floor((t - 1) / 2), s = j8(C8(function(c) {
...
function K8(e7) {
  ...
  if (u === -1 / 0 || l === 1 / 0) {
    var f = l === 1 / 0 ? [u].concat(ih(rh(0, i - 1).map(function() {
      return 1 / 0;
    }))) : [].concat(ih(rh(0, i - 1).map(function() {
      return -1 / 0;
    })), [l]);
    return r > n ? nh(f) : f;
  }
  if (u === l) return H8(u, i, a);
  var h = MS(u, l, o, a), d = h.step, y = h.tickMin, m = h.tickMax, p = el.rangeStep(y, m.add(new Mt(0.1).mul(d)), d);
  return r > n ? nh(p) : p;
}
function Y8(e7, t) {
  ...
  if (c === u) return [c];
  var l = Math.max(t, 2), f = $S(new Mt(u).sub(c).div(l - 1), a, 0), h = [].concat(ih(el.rangeStep(new Mt(c), new Mt(u).sub(new Mt(0.99).mul(f)), f)), [u]);
  return n > i ? nh(h) : h;
}
var X8 = TS(K8), J8 = TS(Y8), Q8 = "Invariant failed";
function Jn(e7, t) {
  throw new Error(Q8);
}
var Z8 = ["offset", "layout", "width", "dataKey", "data", "dataPointFormatter", "xAxis", "yAxis"];
function Hi(e7) {
  "@babel/helpers - typeof";
...
function t6(e7, t) {
  return i6(e7) || n6(e7, t) || r6(e7, t) || e6();
}
function e6() {
  throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
function u6(e7, t, r) {
  return t && c6(e7.prototype, t), Object.defineProperty(e7, "prototype", { writable: false }), e7;
}
function l6(e7, t, r) {
  return t = Vc(t), f6(e7, DS() ? Reflect.construct(t, r || [], Vc(e7).constructor) : t.apply(e7, r));
}
function f6(e7, t) {
...
var Aa = function(e7) {
  function t() {
    return s6(this, t), l6(this, t, arguments);
  }
  return d6(t, e7), u6(t, [{ key: "render", value: function() {
    var n = this.props, i = n.offset, a = n.layout, o = n.width, s = n.dataKey, c = n.data, u = n.dataPointFormatter, l = n.xAxis, f = n.yAxis, h = a6(n, Z8), d = ct(h, false);
...
function y6(e7, t, r) {
  return t = m6(t), t in e7 ? Object.defineProperty(e7, t, { value: r, enumerable: true, configurable: true, writable: true }) : e7[t] = r, e7;
}
function m6(e7) {
  var t = v6(e7, "string");
...
var jS = function(t) {
  ...
  return o.props && o.props.payload ? u = o.props && o.props.payload : a === "children" ? u = (n || []).reduce(function(l, f) {
    ...
    return { inactive: b, dataKey: y, type: c.iconType || p || "square", color: wp(f), value: m || y, payload: d };
...
function Qa(e7, t, r, n) {
  ...
  if (r === "number") {
    ...
    return a.length ? [Zu(a), un(a)] : [1 / 0, -1 / 0];
  }
...
var x6 = function(t) {
  ...
  for (var o = {}, s = Object.keys(a), c = 0, u = s.length; c < u; c++) for (var l = a[s[c]].stackGroups, f = Object.keys(l), h = 0, d = f.length; h < d; h++) {
    ...
    if (b && b.length) {
      ...
      o[v] || (o[v] = []);
      var g = st(w) ? r : w;
      o[v].push({ item: b[0], stackList: b.slice(1), barSize: st(g) ? void 0 : Kn(g, n, 0) });
    }
  }
  return o;
}, P6 = function(t) {
  ...
  if (o[0].barSize === +o[0].barSize) {
    ...
    l = o.reduce(function(w, v) {
      var g = { item: v.item, position: { offset: p.offset + p.size + u, size: h ? d : v.barSize } }, O = [].concat(Dv(w), [g]);
    ...
    l = o.reduce(function(w, v, g) {
      var O = [].concat(Dv(w), [{ item: v.item, position: { offset: b + (_ + u) * g + (_ - S) / 2, size: S } }]);
  ...
  var o = r.props.children, s = Te(o, Aa).filter(function(u) {
    return I6(i, a, u.props.direction);
  });
  if (s && s.length) {
    ...
    return t.reduce(function(u, l) {
      var f = ae(l, n);
      if (st(f)) return u;
      var h = Array.isArray(f) ? [Zu(f), un(f)] : [f, f], d = c.reduce(function(y, m) {
...
}, Kl = /* @__PURE__ */ new WeakMap(), gs = function(t, r) {
  if (typeof r != "function") return t;
  Kl.has(t) || Kl.set(t, /* @__PURE__ */ new WeakMap());
  var n = Kl.get(t);
...
}, B6 = { sign: C6, expand: JM, none: Li, silhouette: QM, wiggle: ZM, positive: j6 }, R6 = function(t, r, n) {
  var i = r.map(function(s) {
    return s.props.dataKey;
  }), a = B6[n], o = XM().keys(i).value(function(s, c) {
    return +ae(s, c, 0);
  }).order(Df).offset(a);
  return o(t);
}, k6 = function(t, r, n, i, a, o) {
  if (!t) return null;
  var s = o ? r.reverse() : r, c = {}, u = s.reduce(function(f, h) {
    ...
    } else _.stackGroups[ei("_stackId_")] = { numericAxisId: n, cateAxisId: i, items: [h] };
  ...
  return Object.keys(u).reduce(function(f, h) {
    ...
    if (d.hasStack) {
      ...
      d.stackGroups = Object.keys(d.stackGroups).reduce(function(m, p) {
        ...
        return qt(qt({}, m), {}, Di({}, p, { numericAxisId: n, cateAxisId: i, items: b.items, stackedData: R6(t, b.items, a) }));
      }, y);
    }
  ...
  if (a && i === "number" && o && (o[0] === "auto" || o[1] === "auto")) {
    ...
    var l = X8(u, a, s);
    return t.domain([Zu(l), un(l)]), { niceTicks: l };
  }
  if (a && i === "number") {
    var f = t.domain(), h = J8(f, a, s);
    return { niceTicks: h };
  }
  return null;
};
...
var jv = function(t) {
  ...
  return t.reduce(function(r, n) {
    return [Zu(n.concat([r[0]]).filter(L)), un(n.concat([r[1]]).filter(L))];
  }, [1 / 0, -1 / 0]);
}, FS = function(t, r, n) {
  return Object.keys(t).reduce(function(i, a) {
    var o = t[a], s = o.stackedData, c = s.reduce(function(u, l) {
      var f = z6(l.slice(r, n + 1));
...
}, Bv = /^dataMin[\s]*-[\s]*([0-9]+([.]{1}[0-9]+){0,1})$/, Rv = /^dataMax[\s]*\+[\s]*([0-9]+([.]{1}[0-9]+){0,1})$/, ch = function(t, r, n) {
...
function W6(e7, t, r) {
  return t = V6(t), t in e7 ? Object.defineProperty(e7, t, { value: r, enumerable: true, configurable: true, writable: true }) : e7[t] = r, e7;
}
function V6(e7) {
  var t = q6(e7, "string");
...
var Gc = Math.PI / 180, G6 = function(t) {
  ...
  var n = t.x, i = t.y, a = r.cx, o = r.cy, s = H6({ x: n, y: i }, { x: a, y: o });
  if (s <= 0) return { radius: s };
  var c = (n - a) / s, u = Math.acos(c);
  return i > o && (u = 2 * Math.PI - u), { radius: s, angle: G6(u), angleInRadian: u };
}, Y6 = function(t) {
  ...
  var n = t.x, i = t.y, a = K6({ x: n, y: i }, r), o = a.radius, s = a.angle, c = r.innerRadius, u = r.outerRadius;
  if (o < c || o > u) return false;
  if (o === 0) return true;
  var l = Y6(r), f = l.startAngle, h = l.endAngle, d = s, y;
  if (f <= h) {
    for (; d > h; ) d -= 360;
    for (; d < f; ) d += 360;
    y = d >= f && d <= h;
  ...
  return y ? Fv(Fv({}, r), {}, { radius: o, angle: X6(d, r) }) : null;
};
function Io(e7) {
  "@babel/helpers - typeof";
...
function az(e7, t, r) {
  return t = oz(t), t in e7 ? Object.defineProperty(e7, t, { value: r, enumerable: true, configurable: true, writable: true }) : e7[t] = r, e7;
}
function oz(e7) {
  var t = sz(e7, "string");
...
var cz = function(t) {
  ...
  var i = t.position, a = t.viewBox, o = t.offset, s = t.className, c = a, u = c.cx, l = c.cy, f = c.innerRadius, h = c.outerRadius, d = c.startAngle, y = c.endAngle, m = c.clockWise, p = (f + h) / 2, b = uz(d, y), _ = b >= 0 ? 1 : -1, S, w;
  ...
  var v = le(u, l, p, S), g = le(u, l, p, S + (w ? 1 : -1) * 359), O = "M".concat(v.x, ",").concat(v.y, `
    ...
    `).concat(g.x, ",").concat(g.y), P = st(t.id) ? ei("recharts-radial-line-") : t.id;
  ...
  return a === "insideLeft" ? ee({ x: s + p, y: c + l / 2, textAnchor: _, verticalAnchor: "middle" }, O) : a === "insideRight" ? ee({ x: s + u - p, y: c + l / 2, textAnchor: b, verticalAnchor: "middle" }, O) : a === "insideTop" ? ee({ x: s + u / 2, y: c + h, textAnchor: "middle", verticalAnchor: y }, O) : a === "insideBottom" ? ee({ x: s + u / 2, y: c + l - h, textAnchor: "middle", verticalAnchor: d }, O) : a === "insideTopLeft" ? ee({ x: s + p, y: c + h, textAnchor: _, verticalAnchor: y }, O) : a === "insideTopRight" ? ee({ x: s + u - p, y: c + h, textAnchor: b, verticalAnchor: y }, O) : a === "insideBottomLeft" ? ee({ x: s + p, y: c + l - h, textAnchor: _, verticalAnchor: d }, O) : a === "insideBottomRight" ? ee({ x: s + u - p, y: c + l - h, textAnchor: b, verticalAnchor: d }, O) : pa(a) && (L(a.x) || jn(a.x)) && (L(a.y) || jn(a.y)) ? ee({ x: s + Kn(a.x, u), y: c + Kn(a.y, l), textAnchor: "end", verticalAnchor: "end" }, O) : ee({ x: s + u / 2, y: c + l / 2, textAnchor: "middle", verticalAnchor: "middle" }, O);
}, dz = function(t) {
  return "cx" in t && L(t.cx);
};
function he(e7) {
  var t = e7.offset, r = t === void 0 ? 5 : t, n = nz(e7, J6), i = ee({ offset: r }, n), a = i.viewBox, o = i.position, s = i.value, c = i.children, u = i.content, l = i.className, f = l === void 0 ? "" : l, h = i.textBreakAll;
  ...
  var y = dz(a), m = ct(i, true);
  if (y && (o === "insideStart" || o === "insideEnd" || o === "end")) return lz(i, d, m);
  var p = y ? fz(i) : hz(i);
...
var zS = function(t) {
  ...
  if (!n) return o;
  var s = pz(t.label, r || a);
  return [s].concat(Q6(o));
};
he.parseViewBox = zS;
he.renderCallByParent = yz;
function mz(e7) {
...
var bz = ["valueAccessor"], _z = ["data", "dataKey", "clockWise", "id", "textBreakAll"];
function wz(e7) {
  return Az(e7) || xz(e7) || Oz(e7) || Sz();
}
function Sz() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
function Oz(e7, t) {
  if (e7) {
    if (typeof e7 == "string") return lh(e7, t);
    var r = Object.prototype.toString.call(e7).slice(8, -1);
    if (r === "Object" && e7.constructor && (r = e7.constructor.name), r === "Map" || r === "Set") return Array.from(e7);
    if (r === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)) return lh(e7, t);
  }
}
function xz(e7) {
  if (typeof Symbol < "u" && e7[Symbol.iterator] != null || e7["@@iterator"] != null) return Array.from(e7);
...
function Az(e7) {
  if (Array.isArray(e7)) return lh(e7);
}
function lh(e7, t) {
  (t == null || t > e7.length) && (t = e7.length);
  for (var r = 0, n = new Array(t); r < t; r++) n[r] = e7[r];
...
function Pz(e7, t, r) {
  return t = Tz(t), t in e7 ? Object.defineProperty(e7, t, { value: r, enumerable: true, configurable: true, writable: true }) : e7[t] = r, e7;
}
function Tz(e7) {
  var t = Iz(e7, "string");
...
var $z = function(t) {
  return Array.isArray(t.value) ? gz(t.value) : t.value;
};
function xr(e7) {
  var t = e7.valueAccessor, r = t === void 0 ? $z : t, n = qv(e7, bz), i = n.data, a = n.dataKey, o = n.clockWise, s = n.id, c = n.textBreakAll, u = qv(n, _z);
...
function Mz(e7, t) {
  return e7 ? e7 === true ? A.createElement(xr, { key: "labelList-implicit", data: t }) : A.isValidElement(e7) || lt(e7) ? A.createElement(xr, { key: "labelList-implicit", data: t, content: e7 }) : pa(e7) ? A.createElement(xr, Hc({ data: t }, e7, { key: "labelList-implicit" })) : null : null;
}
function Dz(e7, t) {
  ...
  if (!r) return i;
  var a = Mz(e7.label, t);
  return [a].concat(wz(i));
}
xr.renderCallByParent = Dz;
function Mo(e7) {
  "@babel/helpers - typeof";
  return Mo = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(t) {
    return typeof t;
...
function Nz(e7, t, r) {
  return t = Cz(t), t in e7 ? Object.defineProperty(e7, t, { value: r, enumerable: true, configurable: true, writable: true }) : e7[t] = r, e7;
}
function Cz(e7) {
  var t = jz(e7, "string");
  return Mo(t) == "symbol" ? t : t + "";
...
var Bz = function(t, r) {
  ...
  var r = t.cx, n = t.cy, i = t.innerRadius, a = t.outerRadius, o = t.startAngle, s = t.endAngle, c = Bz(o, s), u = o + c, l = le(r, n, a, o), f = le(r, n, a, u), h = "M ".concat(l.x, ",").concat(l.y, `
  ...
  return v;
}, kz = { cx: 0, cy: 0, innerRadius: 0, outerRadius: 0, startAngle: 0, endAngle: 0, cornerRadius: 0, forceCornerRadius: false, cornerIsExternal: false }, VS = function(t) {
  var r = Hv(Hv({}, kz), t), n = r.cx, i = r.cy, a = r.innerRadius, o = r.outerRadius, s = r.cornerRadius, c = r.forceCornerRadius, u = r.cornerIsExternal, l = r.startAngle, f = r.endAngle, h = r.className;
  if (o < a || l === f) return null;
  var d = mt("recharts-sector", h), y = o - a, m = Kn(s, y, 0, true), p;
  return m > 0 && Math.abs(l - f) < 360 ? p = Rz({ cx: n, cy: i, innerRadius: a, outerRadius: o, cornerRadius: Math.min(m, y / 2), forceCornerRadius: c, cornerIsExternal: u, startAngle: l, endAngle: f }) : p = WS({ cx: n, cy: i, innerRadius: a, outerRadius: o, startAngle: l, endAngle: f }), A.createElement("path", fh({}, ct(r, true), { className: d, d: p, role: "img" }));
};
function Do(e7) {
  "@babel/helpers - typeof";
...
function hh() {
  return hh = Object.assign ? Object.assign.bind() : function(e7) {
    for (var t = 1; t < arguments.length; t++) {
      var r = arguments[t];
      for (var n in r) Object.prototype.hasOwnProperty.call(r, n) && (e7[n] = r[n]);
    }
...
function Lz(e7, t, r) {
  return t = Fz(t), t in e7 ? Object.defineProperty(e7, t, { value: r, enumerable: true, configurable: true, writable: true }) : e7[t] = r, e7;
}
function Fz(e7) {
  var t = Uz(e7, "string");
...
var Xv = { curveBasisClosed: LM, curveBasisOpen: FM, curveBasis: kM, curveBumpX: xM, curveBumpY: AM, curveLinearClosed: UM, curveLinear: Uu, curveMonotoneX: zM, curveMonotoneY: WM, curveNatural: VM, curveStep: qM, curveStepAfter: HM, curveStepBefore: GM }, _s = function(t) {
  ...
  if (lt(t)) return t;
  var n = "curve".concat(Lu(t));
  return (n === "curveMonotone" || n === "curveBump") && r ? Xv["".concat(n).concat(r === "vertical" ? "Y" : "X")] : Xv[n] || Uu;
}, Wz = function(t) {
  var r = t.type, n = r === void 0 ? "linear" : r, i = t.points, a = i === void 0 ? [] : i, o = t.baseLine, s = t.layout, c = t.connectNulls, u = c === void 0 ? false : c, l = zz(n, s), f = u ? a.filter(function(m) {
    return _s(m);
  }) : a, h;
  if (Array.isArray(o)) {
  ...
  return B.createElement("path", hh({}, ct(t, false), mc(t), { className: mt("recharts-curve", r), d: o, ref: a }));
}, qS = { exports: {} }, Vz = "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED", qz = Vz, Gz = qz;
function GS() {
}
function HS() {
}
...
qS.exports = Hz();
var Kz = qS.exports;
const Ot = Bt(Kz), { getOwnPropertyNames: Yz, getOwnPropertySymbols: Xz } = Object, { hasOwnProperty: Jz } = Object.prototype;
function Yl(e7, t) {
...
function Jv(e7) {
  return Yz(e7).concat(Xz(e7));
}
const Zz = Object.hasOwn || ((e7, t) => Jz.call(e7, t));
function ii(e7, t) {
  return e7 === t || !e7 && !t && e7 !== e7 && t !== t;
}
const t4 = "__v", e42 = "__o", r4 = "_owner", { getOwnPropertyDescriptor: Qv, keys: Zv } = Object;
function n4(e7, t) {
...
function KS(e7, t, r, n) {
  return (n === r4 || n === e42 || n === t4) && (e7.$$typeof || t.$$typeof) ? true : Zz(t, n) && r.equals(e7[n], t[n], n, n, e7, t, r);
}
const p4 = "[object ArrayBuffer]", y4 = "[object Arguments]", m4 = "[object Boolean]", v4 = "[object DataView]", g4 = "[object Date]", b4 = "[object Error]", _4 = "[object Map]", w4 = "[object Number]", S4 = "[object Object]", O4 = "[object RegExp]", x4 = "[object Set]", A4 = "[object String]", P4 = { "[object Int8Array]": true, "[object Uint8Array]": true, "[object Uint8ClampedArray]": true, "[object Int16Array]": true, "[object Uint16Array]": true, "[object Int32Array]": true, "[object Uint32Array]": true, "[object Float16Array]": true, "[object Float32Array]": true, "[object Float64Array]": true, "[object BigInt64Array]": true, "[object BigUint64Array]": true }, T4 = "[object URL]", I4 = Object.prototype.toString;
function E4({ areArrayBuffersEqual: e7, areArraysEqual: t, areDataViewsEqual: r, areDatesEqual: n, areErrorsEqual: i, areFunctionsEqual: a, areMapsEqual: o, areNumbersEqual: s, areObjectsEqual: c, arePrimitiveWrappersEqual: u, areRegExpsEqual: l, areSetsEqual: f, areTypedArraysEqual: h, areUrlsEqual: d, unknownTagComparators: y }) {
  return function(p, b, _) {
    ...
    const v = I4.call(p);
    if (v === g4) return n(p, b, _);
    if (v === O4) return l(p, b, _);
    if (v === _4) return o(p, b, _);
    if (v === x4) return f(p, b, _);
    if (v === S4) return typeof p.then != "function" && typeof b.then != "function" && c(p, b, _);
    if (v === T4) return d(p, b, _);
    if (v === b4) return i(p, b, _);
    if (v === y4) return c(p, b, _);
    if (P4[v]) return h(p, b, _);
    if (v === p4) return e7(p, b, _);
    if (v === v4) return r(p, b, _);
    if (v === m4 || v === w4 || v === A4) return u(p, b, _);
    if (y) {
      let g = y[v];
      if (!g) {
        const O = Qz(p);
...
function $4({ circular: e7, createCustomConfig: t, strict: r }) {
  let n = { areArrayBuffersEqual: n4, areArraysEqual: r ? Ra : i4, areDataViewsEqual: a4, areDatesEqual: o4, areErrorsEqual: s4, areFunctionsEqual: c4, areMapsEqual: r ? Yl(tg, Ra) : tg, areNumbersEqual: u4, areObjectsEqual: r ? Ra : l4, arePrimitiveWrappersEqual: f4, areRegExpsEqual: h4, areSetsEqual: r ? Yl(eg, Ra) : eg, areTypedArraysEqual: r ? Yl(Kc, Ra) : Kc, areUrlsEqual: d4, unknownTagComparators: void 0 };
...
function D4({ circular: e7, comparator: t, createState: r, equals: n, strict: i }) {
...
function An(e7 = {}) {
  const { circular: t = false, createInternalComparator: r, createState: n, strict: i = false } = e7, a = $4(e7), o = E4(a), s = r ? r(o) : M4(o);
  return D4({ circular: t, comparator: o, createState: n, equals: s, strict: i });
}
function C4(e7) {
...
function F4() {
  var e7 = {}, t = function() {
    ...
    if (!r) {
      ...
      dh(a) === "object" && (e7 = a, t(e7)), typeof a == "function" && a();
    }
  };
...
var W4 = function(t, r) {
  ...
  return t.map(function(i) {
    return "".concat(q4(i), " ").concat(r, "ms ").concat(n);
  }).join(",");
};
function G4(e7, t) {
  return Y4(e7) || K4(e7, t) || XS(e7, t) || H4();
}
function H4() {
  throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
function XS(e7, t) {
  if (e7) {
    if (typeof e7 == "string") return ph(e7, t);
    var r = Object.prototype.toString.call(e7).slice(8, -1);
    if (r === "Object" && e7.constructor && (r = e7.constructor.name), r === "Map" || r === "Set") return Array.from(e7);
    if (r === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)) return ph(e7, t);
  }
}
function Q4(e7) {
  if (typeof Symbol < "u" && e7[Symbol.iterator] != null || e7["@@iterator"] != null) return Array.from(e7);
...
function Z4(e7) {
  if (Array.isArray(e7)) return ph(e7);
}
function ph(e7, t) {
  (t == null || t > e7.length) && (t = e7.length);
  for (var r = 0, n = new Array(t); r < t; r++) n[r] = e7[r];
...
var Yc = 1e-4, JS = function(t, r) {
  ...
  return function(n) {
    var i = JS(t, r), a = [].concat(X4(i.map(function(o, s) {
      return o * s;
    }).slice(1)), [0]);
    return QS(a, n);
  };
  ...
  var f = sg(i, o), h = sg(a, s), d = tW(i, o), y = function(b) {
    return b > 1 ? 1 : b < 0 ? 0 : b;
  }, m = function(b) {
    for (var _ = b > 1 ? 1 : b, S = _, w = 0; w < 8; ++w) {
      var v = f(S) - _, g = d(S);
      if (Math.abs(v - _) < Yc || g < Yc) return h(S);
      S = y(S - v / g);
    }
    return h(S);
  };
...
function yh(e7, t, r) {
  return t = oW(t), t in e7 ? Object.defineProperty(e7, t, { value: r, enumerable: true, configurable: true, writable: true }) : e7[t] = r, e7;
}
function oW(e7) {
  var t = sW(e7, "string");
...
function cW(e7, t) {
  return fW(e7) || lW(e7, t) || ZS(e7, t) || uW();
}
function uW() {
  throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
var Xc = function(t, r, n) {
  ...
  return n < 1 ? Za(function(a, o) {
    return vh(o) ? ue(ue({}, o), {}, { velocity: Xc(o.velocity, i[a].velocity, n), from: Xc(o.from, i[a].from, n) }) : o;
  }, r) : e5(t, i, n - 1);
};
const dW = function(e7, t, r, n, i) {
  var a = W4(e7, t), o = a.reduce(function(p, b) {
    return ue(ue({}, p), {}, yh({}, b, [e7[b], t[b]]));
  }, {}), s = a.reduce(function(p, b) {
    return ue(ue({}, p), {}, yh({}, b, { from: e7[b], velocity: 0, to: t[b] }));
  }, {}), c = -1, u, l, f = function() {
    return null;
  }, h = function() {
    ...
    return !Object.values(s).filter(vh).length;
  }, y = function(b) {
    u || (u = b);
    var _ = b - u, S = _ / r.dt;
    s = hW(r, s, S), i(ue(ue(ue({}, e7), t), h())), u = b, d() || (c = requestAnimationFrame(f));
  }, m = function(b) {
    l || (l = b);
    var _ = (b - l) / n, S = Za(function(v, g) {
      return Xc.apply(void 0, ug(g).concat([r(_)]));
    }, o);
    if (i(ue(ue(ue({}, e7), t), S)), _ < 1) c = requestAnimationFrame(f);
    else {
      var w = Za(function(v, g) {
        return Xc.apply(void 0, ug(g).concat([r(1)]));
      }, o);
      i(ue(ue(ue({}, e7), t), w));
    }
  };
...
var pW = ["children", "begin", "duration", "attributeName", "easing", "isActive", "steps", "from", "to", "canBegin", "onAnimationEnd", "shouldReAnimate", "onAnimationReStart"];
function yW(e7, t) {
  if (e7 == null) return {};
  var r = mW(e7, t), n, i;
  if (Object.getOwnPropertySymbols) {
...
var lr = function(e7) {
  ...
  function r(n, i) {
    var a;
    wW(this, r), a = t.call(this, n, i);
    var o = a.props, s = o.isActive, c = o.attributeName, u = o.from, l = o.to, f = o.steps, h = o.children, d = o.duration;
    if (a.handleStyleChange = a.handleStyleChange.bind(wh(a)), a.changeStyle = a.changeStyle.bind(wh(a)), !s || d <= 0) return a.state = { style: {} }, typeof h == "function" && (a.state = { style: l }), _h(a);
    if (f && f.length) a.state = { style: f[0].style };
    else if (u) {
      if (typeof h == "function") return a.state = { style: u }, _h(a);
      a.state = { style: c ? Ka({}, c, u) : u };
    } else a.state = { style: {} };
    return a;
  }
  return OW(r, [{ key: "componentDidMount", value: function() {
    ...
    if (s) {
      ...
      if (!(N4(i.to, l) && i.canBegin && i.isActive)) {
    ...
    var a = this, o = i.from, s = i.to, c = i.duration, u = i.easing, l = i.begin, f = i.onAnimationEnd, h = i.onAnimationStart, d = dW(o, s, rW(u), c, this.changeStyle), y = function() {
      a.stopJSAnimation = d();
    };
    ...
    var a = this, o = i.steps, s = i.begin, c = i.onAnimationStart, u = o[0], l = u.style, f = u.duration, h = f === void 0 ? 0 : f, d = function(m, p, b) {
      ...
      if (typeof w == "function" || w === "spring") return [].concat(Xl(m), [a.runJSAnimation.bind(a, { from: P.style, to: v, duration: _, easing: w }), _]);
      var $ = og(T, _, w), E = er(er(er({}, P.style), v), {}, { transition: $ });
      return [].concat(Xl(m), [E, _, O]).filter(V4);
    };
    return this.manager.start([c].concat(Xl(o.reduce(d, [l, Math.max(h, s)])), [i.onAnimationEnd]));
  } }, { key: "runAnimation", value: function(i) {
    this.manager || (this.manager = F4());
    ...
    var c = yW(i, pW), u = B.Children.count(a), l = this.state.style;
...
function IW(e7, t) {
  return DW(e7) || MW(e7, t) || $W(e7, t) || EW();
}
function EW() {
  throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
var yg = function(t, r, n, i, a) {
  ...
  return false;
}, RW = { x: 0, y: 0, width: 0, height: 0, radius: 0, isAnimationActive: false, isUpdateAnimationActive: false, animationBegin: 0, animationDuration: 1500, animationEasing: "ease" }, Sp = function(t) {
  var r = pg(pg({}, RW), t), n = B.useRef(), i = B.useState(-1), a = IW(i, 2), o = a[0], s = a[1];
  B.useEffect(function() {
  ...
  return _ ? A.createElement(lr, { canBegin: o > 0, from: { width: l, height: f, x: c, y: u }, to: { width: l, height: f, x: c, y: u }, duration: m, animationEasing: y, isActive: _ }, function(w) {
    ...
    return A.createElement(lr, { canBegin: o > 0, from: "0px ".concat(o === -1 ? 1 : o, "px"), to: "".concat(o, "px 0px"), attributeName: "strokeDasharray", begin: p, duration: m, isActive: b, easing: y }, A.createElement("path", Qc({}, ct(r, true), { className: S, d: yg(O, P, v, g, h), ref: n })));
  }) : A.createElement("path", Qc({}, ct(r, true), { className: S, d: yg(c, u, l, f, h) }));
};
function Sh() {
...
var rl = function(t) {
  ...
  return r === +r && n === +n && i === +i ? B.createElement("circle", Sh({}, ct(t, false), mc(t), { className: o, cx: r, cy: n, r: i })) : null;
};
function Bo(e7) {
  "@babel/helpers - typeof";
...
var qW = function(t, r, n, i, a, o) {
  return "M".concat(t, ",").concat(a, "v").concat(i, "M").concat(o, ",").concat(r, "h").concat(n);
}, GW = function(t) {
  var r = t.x, n = r === void 0 ? 0 : r, i = t.y, a = i === void 0 ? 0 : i, o = t.top, s = o === void 0 ? 0 : o, c = t.left, u = c === void 0 ? 0 : c, l = t.width, f = l === void 0 ? 0 : l, h = t.height, d = h === void 0 ? 0 : h, y = t.className, m = WW(t, kW), p = LW({ x: n, y: a, top: s, left: u, width: f, height: d }, m);
  return !L(n) || !L(a) || !L(f) || !L(d) || !L(s) || !L(u) ? null : A.createElement("path", Oh({}, ct(p, true), { className: mt("recharts-cross", y), d: qW(n, a, f, d, s, u) }));
}, HW = mw, KW = HW(Object.getPrototypeOf, Object), YW = KW, XW = Jr, JW = YW, QW = Qr, ZW = "[object Object]", t5 = Function.prototype, e52 = Object.prototype, eO = t5.toString, r5 = e52.hasOwnProperty, n5 = eO.call(Object);
function i5(e7) {
  if (!QW(e7) || XW(e7) != ZW) return false;
  var t = JW(e7);
  if (t === null) return true;
  var r = r5.call(t, "constructor") && t.constructor;
  return typeof r == "function" && r instanceof r && eO.call(r) == n5;
}
var a5 = i5;
const o5 = Bt(a5);
var s5 = Jr, c5 = Qr, u5 = "[object Boolean]";
function l5(e7) {
  return e7 === true || e7 === false || c5(e7) && s5(e7) == u5;
}
var f5 = l5;
const h5 = Bt(f5);
function Ro(e7) {
...
function d5(e7, t) {
  return v5(e7) || m5(e7, t) || y5(e7, t) || p5();
}
function p5() {
  throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
function g5(e7, t, r) {
  return t = b5(t), t in e7 ? Object.defineProperty(e7, t, { value: r, enumerable: true, configurable: true, writable: true }) : e7[t] = r, e7;
}
function b5(e7) {
  var t = _5(e7, "string");
...
var _g = function(t, r, n, i, a) {
...
}, w5 = { x: 0, y: 0, upperWidth: 0, lowerWidth: 0, height: 0, isUpdateAnimationActive: false, animationBegin: 0, animationDuration: 1500, animationEasing: "ease" }, S5 = function(t) {
  var r = bg(bg({}, w5), t), n = B.useRef(), i = B.useState(-1), a = d5(i, 2), o = a[0], s = a[1];
  B.useEffect(function() {
    if (n.current && n.current.getTotalLength) try {
  ...
  return b ? A.createElement(lr, { canBegin: o > 0, from: { upperWidth: 0, lowerWidth: 0, height: h, x: c, y: u }, to: { upperWidth: l, lowerWidth: f, height: h, x: c, y: u }, duration: m, animationEasing: y, isActive: b }, function(S) {
    ...
    return A.createElement(lr, { canBegin: o > 0, from: "0px ".concat(o === -1 ? 1 : o, "px"), to: "".concat(o, "px 0px"), attributeName: "strokeDasharray", begin: p, duration: m, easing: y }, A.createElement("path", Zc({}, ct(r, true), { className: _, d: _g(O, P, w, v, g), ref: n })));
  }) : A.createElement("g", null, A.createElement("path", Zc({}, ct(r, true), { className: _, d: _g(c, u, l, f, h) })));
...
function P5(e7, t, r) {
  return t = T5(t), t in e7 ? Object.defineProperty(e7, t, { value: r, enumerable: true, configurable: true, writable: true }) : e7[t] = r, e7;
}
function T5(e7) {
  var t = I5(e7, "string");
...
function Sg(e7) {
  ...
  switch (t) {
    ...
    case "symbols":
      if ($5(t)) return A.createElement(Wu, r);
      break;
    default:
      return null;
  }
...
function xh(e7) {
  var t = e7.option, r = e7.shapeType, n = e7.propTransformer, i = n === void 0 ? E5 : n, a = e7.activeClassName, o = a === void 0 ? "recharts-active-shape" : a, s = e7.isActive, c = x5(e7, O5), u;
  if (B.isValidElement(t)) u = B.cloneElement(t, tu(tu({}, c), M5(t)));
  else if (lt(t)) u = t(c);
  else if (o5(t) && !h5(t)) {
    var l = i(t, c);
...
function j5(e7, t) {
  var r;
  return nl(e7, t) ? r = D5 : il(e7, t) ? r = N5 : Lo(e7, t) && (r = C5), r;
}
function B5(e7, t) {
  var r;
  return nl(e7, t) ? r = "trapezoids" : il(e7, t) ? r = "sectors" : Lo(e7, t) && (r = "points"), r;
}
function R5(e7, t) {
  if (nl(e7, t)) {
    var r;
...
function k5(e7) {
  var t = e7.activeTooltipItem, r = e7.graphicalItem, n = e7.itemData, i = B5(r, t), a = R5(r, t), o = n.filter(function(c, u) {
...
var L5 = Math.ceil, F5 = Math.max;
function U5(e7, t, r, n) {
  for (var i = -1, a = F5(L5((t - e7) / (r || 1)), 0), o = Array(a); a--; ) o[n ? a : ++i] = e7, e7 += r;
  return o;
}
var z5 = U5, W5 = jw, Og = 1 / 0, V5 = 17976931348623157e292;
function q5(e7) {
  if (!e7) return e7 === 0 ? e7 : 0;
  if (e7 = W5(e7), e7 === Og || e7 === -Og) {
    var t = e7 < 0 ? -1 : 1;
    return t * V5;
  }
  return e7 === e7 ? e7 : 0;
}
var rO = q5, G5 = z5, H5 = Gu, Jl = rO;
function K5(e7) {
  return function(t, r, n) {
    return n && typeof n != "number" && H5(t, r, n) && (r = n = void 0), t = Jl(t), r === void 0 ? (r = t, t = 0) : r = Jl(r), n = n === void 0 ? t < r ? 1 : -1 : Jl(n), G5(t, r, n, e7);
  };
}
var Y5 = K5, X5 = Y5, J5 = X5(), Q5 = J5;
const eu = Bt(Q5);
function Fo(e7) {
  "@babel/helpers - typeof";
...
function nO(e7, t, r) {
  return t = Z5(t), t in e7 ? Object.defineProperty(e7, t, { value: r, enumerable: true, configurable: true, writable: true }) : e7[t] = r, e7;
}
function Z5(e7) {
  var t = tV(e7, "string");
...
var eV = ["Webkit", "Moz", "O", "ms"], rV = function(t, r) {
  var n = t.replace(/(\w)/, function(a) {
    return a.toUpperCase();
  }), i = eV.reduce(function(a, o) {
...
function aV(e7, t, r) {
  return t = nu(t), oV(e7, iO() ? Reflect.construct(t, r || [], nu(e7).constructor) : t.apply(e7, r));
}
function oV(e7, t) {
...
var lV = function(t) {
  ...
  function t(r) {
    var n;
    return nV(this, t), n = aV(this, t, [r]), Ce(n, "handleDrag", function(i) {
  ...
  return cV(t, e7), iV(t, [{ key: "componentWillUnmount", value: function() {
    ...
    var a, o, s = this, c = this.props, u = c.y, l = c.travellerWidth, f = c.height, h = c.traveller, d = c.ariaLabel, y = c.data, m = c.startIndex, p = c.endIndex, b = Math.max(n, this.props.x), _ = Ql(Ql({}, ct(this.props, false)), {}, { x: b, y: u, width: l, height: f }), S = d || "Min value: ".concat((a = y[m]) === null || a === void 0 ? void 0 : a.name, ", Max value: ").concat((o = y[p]) === null || o === void 0 ? void 0 : o.name);
    ...
    var S = mt("recharts-brush", a), w = A.Children.count(o) === 1, v = rV("userSelect", "none");
    ...
    if (a !== i.prevData || u !== i.prevUpdateId) return Ql({ prevData: a, prevTravellerWidth: c, prevUpdateId: u, prevX: s, prevWidth: o }, a && a.length ? lV({ data: a, width: o, x: s, travellerWidth: c, startIndex: l, endIndex: f }) : { scale: null, scaleValues: null });
...
function hV(e7, t) {
  var r;
  return fV(e7, function(n, i, a) {
    return r = t(n, i, a), !r;
  }), !!r;
}
var dV = hV, pV = cw, yV = wn, mV = dV, vV = $e, gV = Gu;
function bV(e7, t, r) {
  var n = vV(e7) ? pV : mV;
  return r && gV(e7, t, r) && (t = void 0), n(e7, yV(t));
}
var _V = bV;
const wV = Bt(_V);
var Ar = function(t, r) {
...
var OV = SV, xV = OV, AV = Iw, PV = wn;
function TV(e7, t) {
  var r = {};
  return t = PV(t), AV(e7, function(n, i, a) {
    xV(r, i, t(n, i, a));
  }), r;
}
var IV = TV;
...
function NV(e7, t) {
  var r = true;
  return DV(e7, function(n, i, a) {
    return r = !!t(n, i, a), r;
  }), r;
}
var CV = NV, jV = MV, BV = CV, RV = wn, kV = $e, LV = Gu;
function FV(e7, t, r) {
  var n = kV(e7) ? jV : BV;
  return r && LV(e7, t, r) && (t = void 0), n(e7, RV(t));
}
var UV = FV;
const oO = Bt(UV);
var zV = ["x", "y"];
...
function WV(e7, t, r) {
  return t = VV(t), t in e7 ? Object.defineProperty(e7, t, { value: r, enumerable: true, configurable: true, writable: true }) : e7[t] = r, e7;
}
function VV(e7) {
  var t = qV(e7, "string");
...
function KV(e7, t) {
  var r = e7.x, n = e7.y, i = GV(e7, zV), a = "".concat(r), o = parseInt(a, 10), s = "".concat(n), c = parseInt(s, 10), u = "".concat(t.height || i.height), l = parseInt(u, 10), f = "".concat(t.width || i.width), h = parseInt(f, 10);
  return ka(ka(ka(ka(ka({}, t), i), o ? { x: o } : {}), c ? { y: c } : {}), {}, { height: l, width: h, name: t.name, radius: t.radius });
}
function Mg(e7) {
  return A.createElement(xh, Ph({ shapeType: "rectangle", propTransformer: KV, activeClassName: "recharts-active-bar" }, e7));
}
var YV = function(t) {
...
function eq(e7, t, r) {
  return t = au(t), rq(e7, cO() ? Reflect.construct(t, r || [], au(e7).constructor) : t.apply(e7, r));
}
function rq(e7, t) {
...
var Pa = function(e7) {
  function t() {
    ...
    ZV(this, t);
    for (var n = arguments.length, i = new Array(n), a = 0; a < n; a++) i[a] = arguments[a];
    return r = eq(this, t, [].concat(i)), ln(r, "state", { isAnimationFinished: false }), ln(r, "id", ei("recharts-bar-")), ln(r, "handleAnimationEnd", function() {
  ...
  return iq(t, e7), tq(t, [{ key: "renderRectanglesStatically", value: function(n) {
    ...
    var p = this.state.isAnimationFinished, b = mt("recharts-bar", o), _ = s && s.allowDataOverflow, S = c && c.allowDataOverflow, w = _ || S, v = st(m) ? this.id : m;
...
ln(Pa, "getComposedData", function(e7) {
  var t = e7.props, r = e7.item, n = e7.barPosition, i = e7.bandSize, a = e7.xAxis, o = e7.yAxis, s = e7.xAxisTicks, c = e7.yAxisTicks, u = e7.stackedData, l = e7.dataStartIndex, f = e7.displayedData, h = e7.offset, d = D6(n, r);
  if (!d) return null;
  var y = t.layout, m = r.type.defaultProps, p = m !== void 0 ? Xt(Xt({}, m), r.props) : r.props, b = p.dataKey, _ = p.children, S = p.minPointSize, w = y === "horizontal" ? o : a, v = u ? w.scale.domain() : null, g = F6({ numericAxis: w }), O = Te(_, Xd), P = f.map(function(T, $) {
    var E, I, j, N, M, C;
    u ? E = N6(u[l + $], v) : (E = ae(T, b), Array.isArray(E) || (E = [g, E]));
    var R = YV(S, sO.defaultProps.minPointSize)(E[1], $);
    if (y === "horizontal") {
...
var uq = function(t, r, n, i, a) {
  ...
  return l.reduce(function(d, y) {
    ...
    if (m.type === "number" && (m.padding === "gap" || m.padding === "no-gap")) {
      var I = b[1] - b[0], j = 1 / 0, N = m.categoricalDomain.sort(d$);
    ...
    var U = $6(m, a, h), q = U.scale, rt = U.realScaleType;
    q.domain(b).range(P), M6(q);
    var W = L6(q, ir(ir({}, m), {}, { realScaleType: rt }));
    ...
    return it.bandSize = qc(it, W), !m.hide && i === "xAxis" ? f[g] += (E ? -1 : 1) * it.height : m.hide || (f[g] += (E ? -1 : 1) * it.width), ir(ir({}, d), {}, al({}, y, it));
  }, {});
}, fO = function(t, r) {
  var n = t.x, i = t.y, a = r.x, o = r.y;
  ...
  function e7(t) {
    oq(this, e7), this.scale = t;
  }
  return sq(e7, [{ key: "domain", get: function() {
...
var hq = function(t) {
  var r = t.width, n = t.height, i = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, a = fq(i), o = a * Math.PI / 180, s = Math.atan(n / r), c = o > s && o < Math.PI - s ? n / Math.sin(o) : r / Math.cos(o);
  return Math.abs(c);
}, dq = wn, pq = ts, yq = Vu;
function mq(e7) {
  return function(t, r, n) {
...
var _q = bq, wq = Sw, Sq = wn, Oq = _q, xq = Math.max;
function Aq(e7, t, r) {
  var n = e7 == null ? 0 : e7.length;
  if (!n) return -1;
  var i = r == null ? 0 : Oq(r);
  return i < 0 && (i = xq(n + i, 0)), wq(e7, Sq(t), i);
}
var Pq = Aq, Tq = vq, Iq = Pq, Eq = Tq(Iq), $q = Eq;
const Mq = Bt($q);
var Dq = yE(function(e7) {
  ...
  var r = t.state, n = r.xAxisMap, i = r.yAxisMap, a = r.offset, o = t.clipPathId, s = t.children, c = t.width, u = t.height, l = Dq(a);
  ...
  var t = B.useContext(Ap), r = Mq(t, function(n) {
...
function Fq(e7, t, r) {
  return t && Lq(e7.prototype, t), Object.defineProperty(e7, "prototype", { writable: false }), e7;
}
function Uq(e7, t, r) {
  return t = ou(t), zq(e7, _O() ? Reflect.construct(t, r || [], ou(e7).constructor) : t.apply(e7, r));
}
function zq(e7, t) {
  if (t && (Zi(t) === "object" || typeof t == "function")) return t;
  if (t !== void 0) throw new TypeError("Derived constructors may only return object or undefined");
...
function Gq(e7, t) {
  return Xq(e7) || Yq(e7, t) || Kq(e7, t) || Hq();
}
function Hq() {
  throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
var Jq = function(t, r) {
  var n;
  return A.isValidElement(t) ? n = A.cloneElement(t, r) : lt(t) ? n = t(r) : n = A.createElement("line", Eh({}, r, { className: "recharts-reference-line-line" })), n;
}, Qq = function(t, r, n, i, a, o, s, c, u) {
  ...
  if (i) {
    ...
    return Ar(u, "discard") && wV(v, function(g) {
...
function Zq(e7) {
  var t = e7.x, r = e7.y, n = e7.segment, i = e7.xAxisId, a = e7.yAxisId, o = e7.shape, s = e7.className, c = e7.alwaysShow, u = Nq(), l = gO(i), f = bO(a), h = Bq();
  if (!u || !h) return null;
  zr(c === void 0, 'The alwaysShow prop is deprecated. Please use ifOverflow="extendDomain" instead.');
  var d = Op({ x: l.scale, y: f.scale }), y = ie(t), m = ie(r), p = n && n.length === 2, b = Qq(d, y, m, p, h, e7.position, l.orientation, f.orientation, e7);
  if (!b) return null;
  var _ = Gq(b, 2), S = _[0], w = S.x, v = S.y, g = _[1], O = g.x, P = g.y, T = Ar(e7, "hidden") ? "url(#".concat(u, ")") : void 0, $ = kg(kg({ clipPath: T }, ct(e7, true)), {}, { x1: w, y1: v, x2: O, y2: P });
  return A.createElement(St, { className: mt("recharts-reference-line", s) }, Jq(o, $), he.renderCallByParent(e7, lq({ x1: w, y1: v, x2: O, y2: P })));
}
var Ep = function(e7) {
  function t() {
    return kq(this, t), Uq(this, t, arguments);
  }
  return Vq(t, e7), Fq(t, [{ key: "render", value: function() {
    return A.createElement(Zq, this.props);
  } }]);
}(A.Component);
...
function $h() {
  return $h = Object.assign ? Object.assign.bind() : function(e7) {
    for (var t = 1; t < arguments.length; t++) {
      var r = arguments[t];
      for (var n in r) Object.prototype.hasOwnProperty.call(r, n) && (e7[n] = r[n]);
    }
...
function rG(e7, t, r) {
  return t && eG(e7.prototype, t), Object.defineProperty(e7, "prototype", { writable: false }), e7;
}
function nG(e7, t, r) {
  return t = su(t), iG(e7, SO() ? Reflect.construct(t, r || [], su(e7).constructor) : t.apply(e7, r));
}
function iG(e7, t) {
...
var cG = function(t) {
  ...
  return oG(t, e7), rG(t, [{ key: "render", value: function() {
    ...
    var f = cG(this.props);
    if (!f) return null;
    var h = f.x, d = f.y, y = this.props, m = y.shape, p = y.className, b = Ar(this.props, "hidden") ? "url(#".concat(c, ")") : void 0, _ = Ug(Ug({ clipPath: b }, ct(this.props, true)), {}, { cx: h, cy: d });
...
ol(sl, "displayName", "ReferenceDot");
ol(sl, "defaultProps", { isFront: false, ifOverflow: "discard", xAxisId: 0, yAxisId: 0, r: 10, fill: "#fff", stroke: "#ccc", fillOpacity: 1, strokeWidth: 1 });
ol(sl, "renderDot", function(e7, t) {
  var r;
  return A.isValidElement(e7) ? r = A.cloneElement(e7, t) : lt(e7) ? r = e7(t) : r = A.createElement(rl, $h({}, t, { cx: t.cx, cy: t.cy, className: "recharts-reference-dot-dot" })), r;
});
function Dh() {
...
function fG(e7, t, r) {
  return t && lG(e7.prototype, t), Object.defineProperty(e7, "prototype", { writable: false }), e7;
}
function hG(e7, t, r) {
  return t = cu(t), dG(e7, xO() ? Reflect.construct(t, r || [], cu(e7).constructor) : t.apply(e7, r));
}
function dG(e7, t) {
...
var vG = function(t, r, n, i, a) {
  ...
  return Ar(a, "discard") && (!h.isInRange(d) || !h.isInRange(y)) ? null : fO(d, y);
}, ul = function(e7) {
  function t() {
    return uG(this, t), hG(this, t, arguments);
  }
  return yG(t, e7), fG(t, [{ key: "render", value: function() {
    ...
    var p = vG(f, h, d, y, this.props);
    if (!p && !m) return null;
    var b = Ar(this.props, "hidden") ? "url(#".concat(l, ")") : void 0;
    return A.createElement(St, { className: mt("recharts-reference-area", c) }, t.renderRect(m, Wg(Wg({ clipPath: b }, ct(this.props, true)), p)), he.renderCallByParent(this.props, p));
  } }]);
}(A.Component);
cl(ul, "displayName", "ReferenceArea");
cl(ul, "defaultProps", { isFront: false, ifOverflow: "discard", xAxisId: 0, yAxisId: 0, r: 10, fill: "#ccc", fillOpacity: 0.5, stroke: "none", strokeWidth: 1 });
cl(ul, "renderRect", function(e7, t) {
  var r;
  return A.isValidElement(e7) ? r = A.cloneElement(e7, t) : lt(e7) ? r = e7(t) : r = A.createElement(Sp, Dh({}, t, { className: "recharts-reference-area-rect" })), r;
});
function PO(e7, t, r) {
  if (t < 1) return [];
...
function wG(e7, t, r, n, i) {
  for (var a = (n || []).slice(), o = t.start, s = t.end, c = 0, u = 1, l = o, f = function() {
    ...
    }, _ = y.coordinate, S = c === 0 || uu(e7, _, b, l, s);
...
function SG(e7, t, r) {
  return t = OG(t), t in e7 ? Object.defineProperty(e7, t, { value: r, enumerable: true, configurable: true, writable: true }) : e7[t] = r, e7;
}
function OG(e7) {
  var t = xG(e7, "string");
...
function AG(e7, t, r, n, i) {
  for (var a = (n || []).slice(), o = a.length, s = t.start, c = t.end, u = function(h) {
    ...
    var b = uu(e7, d.tickCoord, m, s, c);
    b && (c = d.tickCoord - e7 * (m() / 2 + i), a[h] = fe(fe({}, d), {}, { isShow: true }));
  }, l = o - 1; l >= 0; l--) u(l);
  return a;
}
function PG(e7, t, r, n, i, a) {
...
function $p(e7, t, r) {
  ...
  if (L(c) || Sn.isSsr) return _G(i, typeof c == "number" && L(c) ? c : 0);
  var h = [], d = s === "top" || s === "bottom" ? "width" : "height", y = l && d === "width" ? Xa(l, { fontSize: t, letterSpacing: r }) : { width: 0, height: 0 }, m = function(S, w) {
    ...
    return d === "width" ? gG(Xa(v, { fontSize: t, letterSpacing: r }), y, f) : Xa(v, { fontSize: t, letterSpacing: r })[d];
  }, p = i.length >= 2 ? sr(i[1].coordinate - i[0].coordinate) : 1, b = bG(a, p, d);
  return c === "equidistantPreserveStart" ? wG(p, b, m, i, o) : (c === "preserveStart" || c === "preserveStartEnd" ? h = PG(p, b, m, i, o, c === "preserveStartEnd") : h = AG(p, b, m, i, o), h.filter(function(_) {
    return _.isShow;
  }));
}
var TG = ["viewBox"], IG = ["viewBox"], EG = ["ticks"];
function ra(e7) {
  "@babel/helpers - typeof";
...
function NG(e7, t, r) {
  return t = lu(t), CG(e7, TO() ? Reflect.construct(t, r || [], lu(e7).constructor) : t.apply(e7, r));
}
function CG(e7, t) {
...
var Ta = function(e7) {
  function t(r) {
    var n;
    return MG(this, t), n = NG(this, t, [r]), n.state = { fontSize: "", letterSpacing: "" }, n;
  }
  return BG(t, e7), DG(t, [{ key: "shouldComponentUpdate", value: function(n, i) {
    var a = n.viewBox, o = Zl(n, TG), s = this.props, c = s.viewBox, u = Zl(s, IG);
    ...
    var o = this, s = this.props, c = s.tickLine, u = s.stroke, l = s.tick, f = s.tickFormatter, h = s.unit, d = $p(te(te({}, this.props), {}, { ticks: n }), i, a), y = this.getTickTextAnchor(), m = this.getTickVerticalAnchor(), p = ct(this.props, false), b = ct(l, false), _ = te(te({}, p), {}, { fill: "none" }, ct(c, false)), S = d.map(function(w, v) {
    ...
    if (l) return null;
    var f = this.props, h = f.ticks, d = Zl(f, EG), y = h;
...
var kG = ["x1", "y1", "x2", "y2", "key"], LG = ["offset"];
function Qn(e7) {
  "@babel/helpers - typeof";
...
function FG(e7, t, r) {
  return t = UG(t), t in e7 ? Object.defineProperty(e7, t, { value: r, enumerable: true, configurable: true, writable: true }) : e7[t] = r, e7;
}
function UG(e7) {
  var t = zG(e7, "string");
...
function EO(e7, t) {
  ...
  if (A.isValidElement(e7)) r = A.cloneElement(e7, t);
    ...
    var n = t.x1, i = t.y1, a = t.x2, o = t.y2, s = t.key, c = Kg(t, kG), u = ct(c, false);
    u.offset;
    var l = Kg(u, LG);
...
function jh(e7) {
  ...
  return A.createElement("g", { className: "recharts-cartesian-grid" }, A.createElement(VG, { fill: l.fill, fillOpacity: l.fillOpacity, x: l.x, y: l.y, width: l.width, height: l.height, ry: l.ry }), A.createElement(qG, kn({}, l, { offset: u, horizontalPoints: g, xAxis: _, yAxis: S })), A.createElement(GG, kn({}, l, { offset: u, verticalPoints: O, xAxis: _, yAxis: S })), A.createElement(HG, kn({}, l, { horizontalPoints: g })), A.createElement(KG, kn({}, l, { verticalPoints: O })));
}
jh.displayName = "CartesianGrid";
var JG = ["type", "layout", "connectNulls", "ref"], QG = ["key"];
function na(e7) {
  "@babel/helpers - typeof";
...
function eH(e7, t) {
  if (e7) {
    if (typeof e7 == "string") return Bh(e7, t);
    var r = Object.prototype.toString.call(e7).slice(8, -1);
    if (r === "Object" && e7.constructor && (r = e7.constructor.name), r === "Map" || r === "Set") return Array.from(e7);
    if (r === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)) return Bh(e7, t);
  }
}
function rH(e7) {
  if (typeof Symbol < "u" && e7[Symbol.iterator] != null || e7["@@iterator"] != null) return Array.from(e7);
...
function nH(e7) {
  if (Array.isArray(e7)) return Bh(e7);
}
function Bh(e7, t) {
  (t == null || t > e7.length) && (t = e7.length);
  for (var r = 0, n = new Array(t); r < t; r++) n[r] = e7[r];
...
function oH(e7, t, r) {
  return t = fu(t), sH(e7, $O() ? Reflect.construct(t, r || [], fu(e7).constructor) : t.apply(e7, r));
}
function sH(e7, t) {
...
var Vn = function(e7) {
  function t() {
    ...
    iH(this, t);
    for (var n = arguments.length, i = new Array(n), a = 0; a < n; a++) i[a] = arguments[a];
    return r = oH(this, t, [].concat(i)), ar(r, "state", { isAnimationFinished: true, totalLength: 0 }), ar(r, "generateSimpleStrokeDasharray", function(o, s) {
      ...
      return [].concat(li(t.repeat(c, l)), li(d), p).map(function(b) {
        return "".concat(b, "px");
      }).join(", ");
  ...
  return uH(t, e7), aH(t, [{ key: "componentDidMount", value: function() {
    ...
    s.ref;
    var f = Yg(s, JG), h = De(De(De({}, ct(f, true)), {}, { fill: "none", className: "recharts-line-curve", clipPath: i ? "url(#clipPath-".concat(a, ")") : null, points: n }, o), {}, { type: c, layout: u, connectNulls: l });
    ...
    var b = this.state.isAnimationFinished, _ = s.length === 1, S = mt("recharts-line", c), w = u && u.allowDataOverflow, v = l && l.allowDataOverflow, g = w || v, O = st(p) ? this.id : p, P = (n = ct(o, false)) !== null && n !== void 0 ? n : { r: 3, strokeWidth: 2 }, T = P.r, $ = T === void 0 ? 3 : T, E = P.strokeWidth, I = E === void 0 ? 2 : E, j = N_(o) ? o : {}, N = j.clipDot, M = N === void 0 ? true : N, C = $ * 2 + I;
    ...
    if (A.isValidElement(n)) a = A.cloneElement(n, i);
      ...
      var o = i.key, s = Yg(i, QG), c = mt("recharts-line-dot", typeof n != "boolean" ? n.className : "");
      a = A.createElement(rl, to({ key: o }, s, { className: c }));
    }
    return a;
  } }]);
}(B.PureComponent);
...
var fH = ["layout", "type", "stroke", "connectNulls", "isRange", "ref"], hH = ["key"], DO;
function ia(e7) {
  "@babel/helpers - typeof";
...
function mH(e7, t, r) {
  return t = hu(t), vH(e7, CO() ? Reflect.construct(t, r || [], hu(e7).constructor) : t.apply(e7, r));
}
function vH(e7, t) {
...
var Hr = function(e7) {
  function t() {
    ...
    pH(this, t);
    for (var n = arguments.length, i = new Array(n), a = 0; a < n; a++) i[a] = arguments[a];
    return r = mH(this, t, [].concat(i)), Sr(r, "state", { isAnimationFinished: true }), Sr(r, "id", ei("recharts-area-")), Sr(r, "handleAnimationEnd", function() {
      var o = r.props.onAnimationEnd;
  ...
  return bH(t, e7), yH(t, [{ key: "renderDots", value: function(n, i, a) {
    var o = this.props.isAnimationActive, s = this.state.isAnimationFinished;
    if (o && !s) return null;
    var c = this.props, u = c.dot, l = c.points, f = c.dataKey, h = ct(this.props, false), d = ct(u, true), y = l.map(function(p, b) {
    ...
    if (a || !s || !s.length) return null;
    var b = this.state.isAnimationFinished, _ = s.length === 1, S = mt("recharts-area", c), w = f && f.allowDataOverflow, v = h && h.allowDataOverflow, g = w || v, O = st(p) ? this.id : p, P = (n = ct(o, false)) !== null && n !== void 0 ? n : { r: 3, strokeWidth: 2 }, T = P.r, $ = T === void 0 ? 3 : T, E = P.strokeWidth, I = E === void 0 ? 2 : E, j = N_(o) ? o : {}, N = j.clipDot, M = N === void 0 ? true : N, C = $ * 2 + I;
...
Sr(Hr, "getComposedData", function(e7) {
  var t = e7.props, r = e7.item, n = e7.xAxis, i = e7.yAxis, a = e7.xAxisTicks, o = e7.yAxisTicks, s = e7.bandSize, c = e7.dataKey, u = e7.stackedData, l = e7.dataStartIndex, f = e7.displayedData, h = e7.offset, d = t.layout, y = u && u.length, m = DO.getBaseValue(t, r, n, i), p = d === "horizontal", b = false, _ = f.map(function(w, v) {
    var g;
...
Sr(Hr, "renderDotItem", function(e7, t) {
  ...
  if (A.isValidElement(e7)) r = A.cloneElement(e7, t);
    ...
    var n = mt("recharts-area-dot", typeof e7 != "boolean" ? e7.className : ""), i = t.key, a = NO(t, hH);
    r = A.createElement(rl, Ln({}, a, { key: i, className: n }));
  }
  return r;
});
function aa(e7) {
...
function xH(e7, t, r) {
  return t = du(t), AH(e7, BO() ? Reflect.construct(t, r || [], du(e7).constructor) : t.apply(e7, r));
}
function AH(e7, t) {
...
var ll = function(e7) {
  function t() {
    return wH(this, t), xH(this, t, arguments);
  }
  return TH(t, e7), OH(t, [{ key: "render", value: function() {
    return null;
  } }]);
}(B.Component);
RO(ll, "displayName", "ZAxis");
RO(ll, "defaultProps", { zAxisId: 0, range: [64, 64], scale: "auto", type: "number" });
var EH = ["option", "isActive"];
function eo() {
  return eo = Object.assign ? Object.assign.bind() : function(e7) {
    for (var t = 1; t < arguments.length; t++) {
      var r = arguments[t];
...
function DH(e7) {
  var t = e7.option, r = e7.isActive, n = $H(e7, EH);
  return typeof t == "string" ? B.createElement(xh, eo({ option: B.createElement(Wu, eo({ type: t }, n)), isActive: r, shapeType: "symbols" }, n)) : B.createElement(xh, eo({ option: t, isActive: r, shapeType: "symbols" }, n));
}
function oa(e7) {
  "@babel/helpers - typeof";
...
function jH(e7, t, r) {
  return t = pu(t), BH(e7, LO() ? Reflect.construct(t, r || [], pu(e7).constructor) : t.apply(e7, r));
}
function BH(e7, t) {
...
var fl = function(e7) {
  function t() {
    ...
    NH(this, t);
    for (var n = arguments.length, i = new Array(n), a = 0; a < n; a++) i[a] = arguments[a];
    return r = jH(this, t, [].concat(i)), fn(r, "state", { isAnimationFinished: false }), fn(r, "handleAnimationEnd", function() {
  ...
  return kH(t, e7), CH(t, [{ key: "renderSymbolsStatically", value: function(n) {
    ...
    return n.map(function(l, f) {
      ...
      return A.createElement(St, ro({ className: "recharts-scatter-symbol", key: "symbol-".concat(l == null ? void 0 : l.cx, "-").concat(l == null ? void 0 : l.cy, "-").concat(l == null ? void 0 : l.size, "-").concat(f) }, uo(i.props, l, f), { role: "img" }), A.createElement(DH, ro({ option: d, isActive: h, key: "symbol-".concat(f) }, y)));
    });
    ...
    if (o === "joint") l = i.map(function(S) {
      ...
      var h = h$(i), d = h.xmin, y = h.xmax, m = h.a, p = h.b, b = function(w) {
        return m * w + p;
      };
      l = [{ x: d, y: b(d) }, { x: y, y: b(y) }];
    }
    var _ = We(We(We({}, c), {}, { fill: "none", stroke: c && c.fill }, u), {}, { points: l });
    return A.isValidElement(a) ? f = A.cloneElement(a, _) : lt(a) ? f = a(_) : f = A.createElement(Wn, ro({}, _, { type: s })), A.createElement(St, { className: "recharts-scatter-line", key: "recharts-scatter-line" }, f);
  } }, { key: "render", value: function() {
    ...
    if (i || !a || !a.length) return null;
    var p = this.state.isAnimationFinished, b = mt("recharts-scatter", s), _ = c && c.allowDataOverflow, S = u && u.allowDataOverflow, w = _ || S, v = st(y) ? this.id : y;
...
fn(fl, "displayName", "Scatter");
fn(fl, "defaultProps", { xAxisId: 0, yAxisId: 0, zAxisId: 0, legendType: "circle", lineType: "joint", lineJointType: "linear", data: [], shape: "circle", hide: false, isAnimationActive: !Sn.isSsr, animationBegin: 0, animationDuration: 400, animationEasing: "linear" });
fn(fl, "getComposedData", function(e7) {
  var t = e7.xAxis, r = e7.yAxis, n = e7.zAxis, i = e7.item, a = e7.displayedData, o = e7.xAxisTicks, s = e7.yAxisTicks, c = e7.offset, u = i.props.tooltipType, l = Te(i.props.children, Xd), f = st(t.dataKey) ? i.props.dataKey : t.dataKey, h = st(r.dataKey) ? i.props.dataKey : r.dataKey, d = n && n.dataKey, y = n ? n.range : ll.defaultProps.range, m = y && y[0], p = t.scale.bandwidth ? t.scale.bandwidth() : 0, b = r.scale.bandwidth ? r.scale.bandwidth() : 0, _ = a.map(function(S, w) {
    var v = ae(S, f), g = ae(S, h), O = !st(d) && ae(S, d) || "-", P = [{ name: st(t.dataKey) ? i.props.name : t.name || t.dataKey, unit: t.unit || "", value: v, payload: S, dataKey: f, type: u }, { name: st(r.dataKey) ? i.props.name : r.name || r.dataKey, unit: r.unit || "", value: g, payload: S, dataKey: h, type: u }];
...
function zH(e7, t, r) {
  return t && UH(e7.prototype, t), Object.defineProperty(e7, "prototype", { writable: false }), e7;
}
function WH(e7, t, r) {
  return t = yu(t), VH(e7, UO() ? Reflect.construct(t, r || [], yu(e7).constructor) : t.apply(e7, r));
}
function VH(e7, t) {
...
function zh() {
  return zh = Object.assign ? Object.assign.bind() : function(e7) {
    for (var t = 1; t < arguments.length; t++) {
      var r = arguments[t];
      for (var n in r) Object.prototype.hasOwnProperty.call(r, n) && (e7[n] = r[n]);
    }
...
function KH(e7) {
  ...
  return i == null ? null : B.createElement(Ta, zh({}, i, { className: mt("recharts-".concat(i.axisType, " ").concat(i.axisType), i.className), viewBox: { x: 0, y: 0, width: r, height: n }, ticksGenerator: function(o) {
    return Fr(o, true);
  } }));
}
var Vo = function(e7) {
  function t() {
    return FH(this, t), WH(this, t, arguments);
  }
  return GH(t, e7), zH(t, [{ key: "render", value: function() {
    return B.createElement(KH, this.props);
  } }]);
}(B.Component);
...
function QH(e7, t, r) {
  return t = mu(t), ZH(e7, VO() ? Reflect.construct(t, r || [], mu(e7).constructor) : t.apply(e7, r));
}
function ZH(e7, t) {
...
var nK = function(t) {
  ...
  return a == null ? null : B.createElement(Ta, Vh({}, a, { className: mt("recharts-".concat(a.axisType, " ").concat(a.axisType), a.className), viewBox: { x: 0, y: 0, width: n, height: i }, ticksGenerator: function(s) {
    return Fr(s, true);
  } }));
}, Ni = function(e7) {
  function t() {
    return YH(this, t), QH(this, t, arguments);
  }
  return eK(t, e7), JH(t, [{ key: "render", value: function() {
    return B.createElement(nK, this.props);
  } }]);
}(B.Component);
...
var Gh = function(t, r, n, i, a) {
  var o = Te(t, Ep), s = Te(t, sl), c = [].concat(rb(o), rb(s)), u = Te(t, ul), l = "".concat(i, "Id"), f = i[0], h = r;
...
var cK = HO.exports;
const uK = Bt(cK);
var tf = new uK(), ef = "recharts.syncMouseEvents";
function qo(e7) {
  "@babel/helpers - typeof";
...
function hK(e7, t, r) {
  return t && fK(e7.prototype, t), Object.defineProperty(e7, "prototype", { writable: false }), e7;
}
function rf(e7, t, r) {
  return t = KO(t), t in e7 ? Object.defineProperty(e7, t, { value: r, enumerable: true, configurable: true, writable: true }) : e7[t] = r, e7;
}
...
var pK = function() {
  function e7() {
    lK(this, e7), rf(this, "activeIndex", 0), rf(this, "coordinateList", []), rf(this, "layout", "horizontal");
  }
  return hK(e7, [{ key: "setDetails", value: function(r) {
...
function wK(e7) {
  ...
  var y, m = Wn;
  if (h === "ScatterChart") y = o, m = GW;
  else if (h === "BarChart") y = mK(f, o, c, l), m = Sp;
  else if (f === "radial") {
    var p = YO(o), b = p.cx, _ = p.cy, S = p.radius, w = p.startAngle, v = p.endAngle;
    y = { cx: b, cy: _, startAngle: w, endAngle: v, innerRadius: S, outerRadius: S }, m = VS;
  } else y = { points: vK(f, o, c) }, m = Wn;
  var g = Ss(Ss(Ss(Ss({ stroke: "#ccc", pointerEvents: "none" }, c), y), ct(d, false)), {}, { payload: s, payloadIndex: u, className: mt("recharts-tooltip-cursor", d.className) });
  return B.isValidElement(d) ? B.cloneElement(d, g) : B.createElement(m, g);
}
var SK = ["item"], OK = ["children", "className", "width", "height", "style", "compact", "title", "desc"];
function ua(e7) {
  "@babel/helpers - typeof";
...
function ib(e7, t) {
  return PK(e7) || AK(e7, t) || JO(e7, t) || xK();
}
function xK() {
  throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
function $K(e7, t, r) {
  return t && EK(e7.prototype, t), Object.defineProperty(e7, "prototype", { writable: false }), e7;
}
function MK(e7, t, r) {
  return t = vu(t), DK(e7, XO() ? Reflect.construct(t, r || [], vu(e7).constructor) : t.apply(e7, r));
}
function DK(e7, t) {
...
function CK(e7, t) {
  if (typeof t != "function" && t !== null) throw new TypeError("Super expression must either be null or a function");
  e7.prototype = Object.create(t && t.prototype, { constructor: { value: e7, writable: true, configurable: true } }), Object.defineProperty(e7, "prototype", { writable: false }), t && Hh(e7, t);
}
function Hh(e7, t) {
...
var LK = { xAxis: ["bottom", "top"], yAxis: ["left", "right"] }, FK = { width: "100%", height: "100%" }, ZO = { x: 0, y: 0 };
function Os(e7) {
  return e7;
}
var UK = function(t, r) {
...
var Yh = function(t, r, n, i) {
  var a = t.graphicalItems, o = t.tooltipAxis, s = hl(r, t);
  ...
  var a = i || { x: t.chartX, y: t.chartY }, o = UK(a, n), s = t.orderedTooltipTicks, c = t.tooltipAxis, u = t.tooltipTicks, l = x6(o, s, u, c);
  if (l >= 0 && u) {
    var f = u[l] && u[l].value, h = Yh(t, r, l, f), d = zK(n, s, l, a);
  ...
  return n.reduce(function(y, m) {
    ...
    if (y[T]) return y;
    var $ = hl(t.data, { graphicalItems: i.filter(function(W) {
    ...
    yK(b.domain, w, _) && (I = ch(b.domain, null, w), d && (_ === "number" || g !== "auto") && (N = Qa($, S, "category")));
    var M = t1(_);
    if (!I || I.length === 0) {
      ...
      } else d ? I = eu(0, E) : s && s[T] && s[T].hasStack && _ === "number" ? I = h === "expand" ? [0, 1] : FS(s[T].stackGroups, c, u) : I = RS($, i.filter(function(W) {
        var it = o in W.props ? W.props[o] : W.type.defaultProps[o], Rt = "hide" in W.props ? W.props.hide : W.type.defaultProps.hide;
        return it === T && (P || !Rt);
      }), _, l, true);
      if (_ === "number") I = Gh(f, I, T, a, O), R && (I = ch(R, I, w));
  ...
  var n = r.graphicalItems, i = r.Axis, a = r.axisType, o = r.axisIdKey, s = r.stackGroups, c = r.dataStartIndex, u = r.dataEndIndex, l = t.layout, f = t.children, h = hl(t.data, { graphicalItems: n, dataStartIndex: c, dataEndIndex: u }), d = h.length, y = kS(l, a), m = -1;
  return n.reduce(function(p, b) {
    var _ = b.type.defaultProps !== void 0 ? D(D({}, b.type.defaultProps), b.props) : b.props, S = _[o], w = t1("number");
    if (!p[S]) {
      m++;
      var v;
      return y ? v = eu(0, d) : s && s[S] && s[S].hasStack ? (v = FS(s[S].stackGroups, c, u), v = Gh(f, v, S, a)) : (v = ch(w, RS(h, n.filter(function(g) {
        ...
        return T === S && !$;
      }), "number", l), i.defaultProps.allowDataOverflow), v = Gh(f, v, S, a)), D(D({}, p), {}, J({}, S, D(D({ axisType: a }, i.defaultProps), {}, { hide: true, orientation: Ye(LK, "".concat(a, ".").concat(m % 2), null), domain: v, originalDomain: w, isCategorical: y, layout: l })));
    }
    return p;
  }, {});
}, qK = function(t, r) {
  ...
  return h && h.length ? d = WK(t, { axes: h, graphicalItems: o, axisType: i, axisIdKey: f, stackGroups: s, dataStartIndex: c, dataEndIndex: u }) : o && o.length && (d = VK(t, { Axis: a, graphicalItems: o, axisType: i, axisIdKey: f, stackGroups: s, dataStartIndex: c, dataEndIndex: u })), d;
}, GK = function(t) {
  ...
  d && (b.bottom += d.props.height || Ji.defaultProps.height), y && r && (b = T6(b, i, n, r));
  ...
  var r = t.chartName, n = t.GraphicalChild, i = t.defaultTooltipEventType, a = i === void 0 ? "axis" : i, o = t.validateTooltipEventTypes, s = o === void 0 ? ["axis"] : o, c = t.axisComponents, u = t.legendContent, l = t.formatAxisMap, f = t.defaultProps, h = function(b, _) {
    var S = _.graphicalItems, w = _.stackGroups, v = _.offset, g = _.updateId, O = _.dataStartIndex, P = _.dataEndIndex, T = b.barSize, $ = b.layout, E = b.barGap, I = b.barCategoryGap, j = b.maxBarSize, N = ub($), M = N.numericAxisName, C = N.cateAxisName, R = HK(S), F = [];
    return S.forEach(function(U, q) {
      var rt = hl(b.data, { graphicalItems: [U], dataStartIndex: O, dataEndIndex: P }), W = U.type.defaultProps !== void 0 ? D(D({}, U.type.defaultProps), U.props) : U.props, it = W.dataKey, Rt = W.maxBarSize, Yt = W["".concat(M, "Id")], Me = W["".concat(C, "Id")], Pn = {}, we = c.reduce(function(Tn, In) {
        var dl = _["".concat(In.axisType, "Map")], Dp = W["".concat(In.axisType, "Id")];
        dl && dl[Dp] || In.axisType === "zAxis" || Jn();
        var Np = dl[Dp];
        return D(D({}, Tn), {}, J(J({}, In.axisType, Np), "".concat(In.axisType, "Ticks"), Fr(Np)));
      }, Pn), z = we[C], ft = we["".concat(C, "Ticks")], ht = w && w[Yt] && w[Yt].hasStack && U6(U, w[Yt].stackGroups), k = Ur(U.type).indexOf("Bar") >= 0, Vt = qc(z, ft), bt = [], Qt = R && A6({ barSize: T, stackGroups: w, totalSize: YK(we, C) });
      if (k) {
        var Zt, Se, tn = st(Rt) ? j : Rt, ai = (Zt = (Se = qc(z, ft, true)) !== null && Se !== void 0 ? Se : tn) !== null && Zt !== void 0 ? Zt : 0;
        bt = P6({ barGap: E, barCategoryGap: I, bandSize: ai !== Vt ? ai : Vt, sizeList: Qt[Me], maxBarSize: tn }), ai !== Vt && (bt = bt.map(function(Tn) {
          return D(D({}, Tn), {}, { position: D(D({}, Tn.position), {}, { offset: Tn.position.offset - ai / 2 }) });
        }));
      }
      var as = U && U.type && U.type.getComposedData;
      as && F.push({ props: D(D({}, as(D(D({}, we), {}, { displayedData: rt, props: b, dataKey: it, item: U, bandSize: Vt, barPosition: bt, offset: v, stackedData: ht, layout: $, dataStartIndex: O, dataEndIndex: P }))), {}, J(J(J({ key: U.key || "item-".concat(q) }, M, we[M]), C, we[C]), "animationId", g)), childIndex: x$(U, b.children), item: U });
    }), F;
  }, d = function(b, _) {
    var S = b.props, w = b.dataStartIndex, v = b.dataEndIndex, g = b.updateId;
    if (!My({ props: S })) return null;
    var O = S.children, P = S.layout, T = S.stackOffset, $ = S.data, E = S.reverseStackOrder, I = ub(P), j = I.numericAxisName, N = I.cateAxisName, M = Te(O, n), C = k6($, M, "".concat(j, "Id"), "".concat(N, "Id"), T, E), R = c.reduce(function(W, it) {
      var Rt = "".concat(it.axisType, "Map");
      return D(D({}, W), {}, J({}, Rt, qK(S, D(D({}, it), {}, { graphicalItems: M, stackGroups: it.axisType === j && C, dataStartIndex: w, dataEndIndex: v }))));
    }, {}), F = KK(D(D({}, R), {}, { props: S, graphicalItems: M }), _ == null ? void 0 : _.legendBBox);
    Object.keys(R).forEach(function(W) {
      R[W] = l(S, R[W], F, W.replace("Map", ""), r);
    });
    var U = R["".concat(N, "Map")], q = GK(U), rt = h(S, D(D({}, R), {}, { dataStartIndex: w, dataEndIndex: v, updateId: g, graphicalItems: M, stackGroups: C, offset: F }));
    return D(D({ formattedGraphicalItems: rt, graphicalItems: M, offset: F, stackGroups: C }, q), R);
  }, y = function(p) {
    function b(_) {
      var S, w, v;
      return IK(this, b), v = MK(this, b, [_]), J(v, "eventEmitterSymbol", Symbol("rechartsEventEmitter")), J(v, "accessibilityManager", new pK()), J(v, "handleLegendBBoxUpdate", function(g) {
        if (g) {
        ...
        var O = O$(g), P = Ye(v.props, "".concat(O));
        if (O && lt(P)) {
          var T, $;
        ...
        v.props.syncId !== void 0 && tf.emit(ef, v.props.syncId, g, v.eventEmitterSymbol);
        ...
        if (g.dataStartIndex !== void 0 || g.dataEndIndex !== void 0) v.setState(D({ dataStartIndex: E, dataEndIndex: I }, d({ props: v.props, dataStartIndex: E, dataEndIndex: I, updateId: $ }, v.state)));
          ...
          var q = D(D({}, R), {}, { x: R.left, y: R.top }), rt = Math.min(j, q.x + q.width), W = Math.min(N, q.y + q.height), it = F[M] && F[M].value, Rt = Yh(v.state, v.props.data, M), Yt = F[M] ? { x: P === "horizontal" ? F[M].coordinate : rt, y: P === "horizontal" ? W : F[M].coordinate } : ZO;
        ...
        return A.createElement(wK, { key: F, activeCoordinate: $, activePayload: E, activeTooltipIndex: j, chartName: r, element: g, isActive: C, layout: R, offset: I, tooltipAxisBandSize: N, tooltipEventType: M });
        ...
        var g = v.state.formattedGraphicalItems, O = v.props, P = O.children, T = O.width, $ = O.height, E = v.props.margin || {}, I = T - (E.left || 0) - (E.right || 0), j = jS({ children: P, formattedGraphicalItems: g, legendWidth: I, legendContent: u });
        if (!j) return null;
        var N = j.item, M = ab(j, SK);
        ...
        if (Pn) if (N >= 0) {
          ...
          var Qt, Zt = (Qt = v.getItemByXY(v.state.activeCoordinate)) !== null && Qt !== void 0 ? Qt : { graphicalItem: z }, Se = Zt.graphicalItem, tn = Se.item, ai = tn === void 0 ? g : tn, as = Se.childIndex, Tn = D(D(D({}, T.props), we), {}, { activeIndex: as });
    ...
    return CK(b, p), $K(b, [{ key: "componentDidMount", value: function() {
      ...
      if (P) {
        ...
        if (!(typeof T != "number" || T < 0 || T > this.state.tooltipTicks.length - 1)) {
          var $ = this.state.tooltipTicks[T] && this.state.tooltipTicks[T].value, E = Yh(this.state, v, T, $), I = this.state.tooltipTicks[T].coordinate, j = (this.state.offset.top + g) / 2, N = O === "horizontal", M = N ? { x: I, y: j } : { y: I, x: j }, C = this.state.formattedGraphicalItems.find(function(F) {
            var U = F.item;
      ...
      Of([je(S.children, nr)], [je(this.props.children, nr)]) || this.displayDefaultTooltip();
    } }, { key: "componentWillUnmount", value: function() {
      ...
      var w = this.container, v = w.getBoundingClientRect(), g = XL(v), O = { chartX: Math.round(S.pageX - g.left), chartY: Math.round(S.pageY - g.top) }, P = v.width / w.offsetWidth || 1, T = this.inRange(O.chartX, O.chartY, P);
      if (!T) return null;
      ...
      tf.on(ef, this.handleReceiveSyncEvent);
    } }, { key: "removeListener", value: function() {
      tf.removeListener(ef, this.handleReceiveSyncEvent);
      ...
      if (v && v.length) for (var O = 0, P = v.length; O < P; O++) {
        ...
        } else if (nl(T, g) || il(T, g) || Lo(T, g)) {
          var C = k5({ graphicalItem: T, activeTooltipItem: g, itemData: I.data }), R = I.activeIndex === void 0 ? C : I.activeIndex;
      ...
      var w = this.props, v = w.children, g = w.className, O = w.width, P = w.height, T = w.style, $ = w.compact, E = w.title, I = w.desc, j = ab(w, OK), N = ct(j, false);
      if ($) return A.createElement(Bg, { state: this.state, width: this.props.width, height: this.props.height, clipPathId: this.clipPathId }, A.createElement(Af, Ai({}, N, { width: O, height: P, title: E, desc: I }), this.renderClipPath(), Ny(v, this.renderMap)));
      ...
      return A.createElement(Bg, { state: this.state, width: this.props.width, height: this.props.height, clipPathId: this.clipPathId }, A.createElement("div", Ai({ className: mt("recharts-wrapper", g), style: D({ position: "relative", cursor: "default", width: O, height: P }, T) }, R, { ref: function(U) {
        S.container = U;
      } }), A.createElement(Af, Ai({}, N, { width: O, height: P, title: E, desc: I, style: FK }), this.renderClipPath(), Ny(v, this.renderMap)), this.renderLegend(), this.renderTooltip()));
    } }]);
  }(B.Component);
  J(y, "displayName", r), J(y, "defaultProps", D({ layout: "horizontal", stackOffset: "none", barCategoryGap: "10%", barGap: 4, margin: { top: 5, right: 5, bottom: 5, left: 5 }, reverseStackOrder: false, syncMethod: "index" }, f)), J(y, "getDerivedStateFromProps", function(p, b) {
    ...
    if (_ !== b.prevDataKey || S !== b.prevData || v !== b.prevWidth || g !== b.prevHeight || O !== b.prevLayout || P !== b.prevStackOffset || !$i(T, b.prevMargin)) {
      var j = cb(p), N = { chartX: b.chartX, chartY: b.chartY, isTooltipActive: b.isTooltipActive }, M = D(D({}, sb(b, S, O)), {}, { updateId: b.updateId + 1 }), C = D(D(D({}, j), N), M);
    ...
    if (!Of(w, b.prevChildren)) {
      var R, F, U, q, rt = je(w, Ji), W = rt && (R = (F = rt.props) === null || F === void 0 ? void 0 : F.startIndex) !== null && R !== void 0 ? R : $, it = rt && (U = (q = rt.props) === null || q === void 0 ? void 0 : q.endIndex) !== null && U !== void 0 ? U : E, Rt = W !== $ || it !== E, Yt = !st(S), Me = Yt && !Rt ? b.updateId : b.updateId + 1;
    ...
    var S;
    return B.isValidElement(p) ? S = B.cloneElement(p, b) : lt(p) ? S = p(b) : S = A.createElement(rl, b), A.createElement(St, { className: "recharts-active-dot", key: _ }, S);
  });
  var m = B.forwardRef(function(b, _) {
    return A.createElement(y, Ai({}, b, { ref: _ }));
  });
  return m.displayName = y.displayName, m;
}, lb = XK({ chartName: "ComposedChart", GraphicalChild: [Vn, Hr, Pa, fl], axisComponents: [{ axisType: "xAxis", AxisComp: Vo }, { axisType: "yAxis", AxisComp: Ni }, { axisType: "zAxis", AxisComp: ll }], formatAxisMap: uq });
const Gt = { grid: "#d0d7de", axis: "#57606a", legendText: "#1f2328", bandP75: "#dbeafe", bandP75Stroke: "#388bfd", bandP25: "#eff6ff", bandP25Stroke: "#54aeff", medianLine: "#0969da", volumeLine: "#bf8700", tooltip: { background: "#ffffff", border: "#d0d7de", text: "#1f2328" }, colors: ["#0969da", "#8250df", "#1a7f37", "#cf222e", "#bf8700", "#57606a"], otherSeries: "#57606a" }, La = { fill: Gt.axis, fontSize: 11 }, fb = { shared: false, contentStyle: { background: Gt.tooltip.background, border: `1px solid ${Gt.tooltip.border}`, borderRadius: "0.35rem", color: Gt.tooltip.text }, labelStyle: { color: Gt.tooltip.text } }, hb = { top: 8, right: 12, left: 4, bottom: 8 }, db = { verticalAlign: "bottom", align: "center", layout: "horizontal", wrapperStyle: { color: Gt.legendText, width: "100%", left: 0, paddingTop: "10px" } }, JK = ["day", "week", "month", "quarter", "year"], QK = [];
function PY({ mode: e7, methodId: t, methodName: r, topMethods: n = QK, topN: i = 10 }) {
  ...
  B.useEffect(() => {
    ...
    async function v() {
      ...
      try {
        if (e7 === "single" && t) {
          const g = await PP(t, a);
          w || c(g);
        } else if (e7 === "topN") {
          const g = n.slice(0, i).map((P) => P.method_id), O = await TP(g, a);
          w || l(O);
        }
      } finally {
        w || y(false);
...
async function rY(e7) {
  const t = await fetch(e7, { cache: "no-cache" });
  if (!t.ok) throw new Error(`Failed to download DuckDB (${t.status})`);
  return t.arrayBuffer();
}
function IY() {
  const [e7, t] = B.useState({ ready: false, loading: fi() || af(), error: null, manifest: null, fromCache: false, localMode: fi() }), [r, n] = B.useState(0), i = B.useCallback(() => {
    n((a) => a + 1);
  }, []);
  return B.useEffect(() => {
    if (!fi() && !af()) {
    ...
    let a = false;
    async function o() {
      const u = await fetch(nf, { cache: "no-cache" });
      if (!u.ok) throw new Error(`Failed to load local DuckDB (${u.status}). Run: make import-osrs-db`);
      const l = await u.arrayBuffer(), f = u.headers.get("etag") ?? u.headers.get("last-modified") ?? `${nf}:${l.byteLength}`;
      let h = null;
      await py(l, f), a || t({ ready: true, loading: false, error: null, manifest: h, fromCache: false, localMode: true });
    }
    async function s() {
      const u = await $P(), l = await tY(), f = MP(u, (l == null ? void 0 : l.sha256) ?? null);
      let h, d = false;
      !f && l ? (h = l.bytes, d = true) : (h = await rY(i1(u)), await eY({ sha256: u.artifacts.database.sha256, bytes: h, fetchedAt: (/* @__PURE__ */ new Date()).toISOString() })), await py(h, u.artifacts.database.sha256), a || t({ ready: true, loading: false, error: null, manifest: u, fromCache: d, localMode: false });
    }
    async function c() {
