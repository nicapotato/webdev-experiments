import { u as v, r as l, j as s, L as j } from "./index-CYwztDbo.js";
import { u as k, a as o, S as x, d as y, g as E, h as S, O as K, b as d, c as L, s as g, j as O } from "./useOsrsData-QV_MIW1W.js";
import "./clsx-B-dksMZM.js";
import "./tslib.es6-Xujj8YQZ.js";
function f({ title: n, lines: t }) {
  return s.jsxs("section", { className: "osrs-mmg__panel osrs-mmg__panel--lines", children: [s.jsx("h3", { children: n }), s.jsxs("table", { className: "osrs-mmg__table", children: [s.jsx("thead", { children: s.jsxs("tr", { children: [s.jsx("th", { children: "Qty/h" }), s.jsx("th", { children: "Item" }), s.jsx("th", { children: "GP/h" })] }) }), s.jsx("tbody", { children: t.map((a) => s.jsxs("tr", { children: [s.jsxs("td", { children: [O(a.qtyPerHour), " \xD7"] }), s.jsx("td", { children: a.itemName }), s.jsx("td", { children: d(a.gpPerHour) })] }, a.wikiSlug)) })] })] });
}
function R() {
